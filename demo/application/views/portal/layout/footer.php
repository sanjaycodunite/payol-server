    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary btn-sm" href="{site_url}portal/dashboard/logout">Logout</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="{site_url}skin/admin/js/portal-custom.js"></script>
  <script src="{site_url}skin/admin/js/portal-datatable.js"></script>
