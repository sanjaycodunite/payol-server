...
<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <?php echo form_open('portal/wallet/downloadUpiExcel',array('id'=>'leadFilterForm')); ?>
              <div class="row">
                <div class="col-sm-12">
                <h4><b>My UPI Wallet</b></h4>
                </div>
                ...
                <div class="col-sm-2">
                <button type="button" class="btn btn-success" id="myUpiWalletSearchBtn">Search</button>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="myUpiWalletDataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>MemberID</th>
