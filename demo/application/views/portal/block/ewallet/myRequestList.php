<?php echo form_open_multipart('portal/token/requestTokenAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
...
{system_message}               
            ...
            <div class="card-header py-3">
              <div class="row">
                ...
                <a href="{site_url}portal/ewallet/fundRequest" class="btn btn-primary">Add Request</a>
                </div>                  
              </div>  
