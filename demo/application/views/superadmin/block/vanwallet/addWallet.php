...
<div class="card shadow ">
            ...
            <div class="card-body">
            <?php echo form_open_multipart('superadmin/vanwallet/saveWallet', array('id' => 'admin_profile'),array('method'=>'post')); ?>
              ...
              <select class="selectpicker form-control" name="member" id="selVirtualWalletMember" data-live-search="true">
