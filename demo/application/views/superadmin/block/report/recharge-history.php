                  ...
                  <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="{site_url}superadmin/report/recharge/2">Total Success</a></div>
                ...
                <div class="col-xl-4 col-md-6 mb-2 mt-2">
                  <div class="card border-left-warning shadow h-100 py-2">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="{site_url}superadmin/report/recharge/1">Total Pending</a></div>
                ...
                <div class="col-xl-4 col-md-6 mb-2 mt-2">
                  <div class="card border-left-danger shadow h-100 py-2">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="{site_url}superadmin/report/recharge/3">Total Failed</a></div>
            ...
            <div class="card-header py-3">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 mt-3 text-center">
                  ...
                  <a href="{site_url}superadmin/report/recharge" class="btn btn-secondary">View All</a>
                 </div>
                </div>
