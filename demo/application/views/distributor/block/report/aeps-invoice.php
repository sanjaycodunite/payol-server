...
<table>
    ...
    <thead>
    <tr>
        <th colspan="2" style="text-align: left;">RECEIPT # : <?php echo $detail['invoice_no']; ?></th>
...
<a href="{site_url}distributor/aeps/transactionHistory" style="font-size: 10px; background-color: #03a9f4; padding: 8px 20px;    color: #fff;font-size: 15px; border: 0px;border-radius: 10px; margin-top: 20px;">Back</a>
