...
<div class="card shadow ">
            ...
            <div class="card-body">
            <?php echo form_open_multipart('distributor/transfer/activeAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
              ...
              <input type="text" class="form-control" value="<?php echo $memberData['user_code']; ?>" placeholder="Member ID" readonly="readonly">
              </div>
              </div>
              <div class="col-sm-2">
              <div class="form-group">
              <label><b>Mobile</b></label>
              <input type="text" class="form-control" value="<?php echo $memberData['mobile']; ?>" placeholder="Mobile" readonly="readonly">
              </div>
              </div>
              <div class="col-sm-2">
              <div class="form-group">
