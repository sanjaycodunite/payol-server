              ...
              <div class="row">
                ...
                <div class="col-sm-6  text-right">
                  <?php if($account_id == 2){ ?>
                      ...
                      <?php 
                      $user_instantpay_aeps_status = $this->User->get_member_new_aeps_status($loggedUser['id']);
                      if(!$user_instantpay_aeps_status){ ?>

                      
                   <a href="{site_url}distributor/newaeps/activeAeps" class="btn btn-dark">NSDL AEPS</a>
                 <?php } else {?>
                   <a href="{site_url}distributor/newaeps/index" class="btn btn-dark">NSDL AEPS</a>
                 <?php } ?>
                 <?php } ?>
