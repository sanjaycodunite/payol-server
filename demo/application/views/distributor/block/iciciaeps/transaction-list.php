                  ...
                  <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="{site_url}admin/report/iciciAepsHistory/2">Total Success</a></div>
                ...
                <div class="col-xl-4 col-md-6 mb-2 mt-2">
                  <div class="card border-left-danger shadow h-100 py-2">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="{site_url}admin/report/iciciAepsHistory/3">Total Failed</a></div>
...
<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <div class="row">
                <div class="col-sm-12">
                <h4><b>ICICI AEPS Transaction Report</b></h4>
                  </div>
                ...
                <a href="{site_url}distributor/iciciaeps/transactionHistory" class="btn btn-secondary">View All</a>
                </div>
               </div>  
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="iciciAepsTxnDataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>MemberID</th>
