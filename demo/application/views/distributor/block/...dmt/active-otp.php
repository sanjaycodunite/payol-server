...
<div class="card shadow ">
            ...
            <div class="card-body">
            <?php echo form_open_multipart('distributor/dmt/activeOtpAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
              ...
              <br />
              <a href="{site_url}distributor/dmt/resendOtp/{token}">Resend OTP</a>
              </div>
              </div>
