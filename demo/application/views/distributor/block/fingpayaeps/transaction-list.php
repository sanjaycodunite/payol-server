...
<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <div class="row">
                ...
                <a href="{site_url}distributor/fingpayAeps/transactionHistory" class="btn btn-secondary">View All</a>
                </div>
               </div>  
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="aepsTxnDataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>MemberID</th>
