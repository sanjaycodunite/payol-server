 ...
 <!-- Page Wrapper -->
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{site_url}distributor/dashboard">
        ...
        <div id="collapse5" <?php if($content_block == 'recharge/mobile-prepaid' || $content_block == 'recharge/mobile-postpaid' || $content_block == 'recharge/dth' || $content_block == 'recharge/electricity' || $content_block == 'recharge/datacard' || $content_block == 'recharge/landline' || $content_block == 'recharge/broadband' ) { ?> class="collapse show" <?php } else { ?> class="collapse"<?php } ?> aria-labelledby="heading5" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <?php if($isInstantPayApiAllow){ ?>
              <a class="collapse-item <?php if($content_block == 'recharge/ekyc'){ ?> active <?php } ?> " href="{site_url}distributor/recharge/ekyc">Merchant eKyc</a>
            <?php } ?>
            <a class="collapse-item <?php if($content_block == 'recharge/mobile-prepaid'){ ?> active <?php } ?> " href="{site_url}distributor/recharge/mobileprepaid">Mobile</a>
            
            <a class="collapse-item <?php if($content_block == 'recharge/dth'){ ?> active <?php } ?> " href="{site_url}distributor/recharge/dth">DTH</a>
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">AEPS1 Service:</h6>
             <?php if(!$user_aeps_status){ ?>
              ...
              <a class="collapse-item" href="{site_url}distributor/aeps/transactionHistory">Transaction History</a>
            <?php } ?>
          </div>
        </div>
      </li> 
      ...
      <li class="nav-item">
        ...
        <div id="collapse88" <?php if($content_block == 'transfer/list' || $content_block == 'transfer/transfer') { ?> class="collapse show" <?php } else { ?> class="collapse"<?php } ?> aria-labelledby="heading5" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{site_url}distributor/transfer/payoutBeneficiaryList">Beneficiary List</a>
              ...
              <a class="collapse-item" href="{site_url}distributor/transfer">Payout Report</a>
               ...
               <a class="collapse-item" href="{site_url}distributor/transfer/benificaryAccountList"> New Account Request</a>
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">AEPS2 Service:</h6>
             <?php if(!$user_new_aeps_status){ ?>
              ...
              <a class="collapse-item" href="{site_url}distributor/newaeps/transactionHistory">Transaction History</a>
            <?php } ?>
          </div>
        </div>
      </li> 
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Settlement:</h6>
             <a class="collapse-item" href="{site_url}distributor/transfer/settlement">Settlement </a>
              ...
              <a class="collapse-item" href="{site_url}distributor/transfer/newPayoutReport">Payout Report</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseMoney" class="collapse" aria-labelledby="heading5" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{site_url}distributor/transfer/openPayout">Money Transfers</a>
              <a class="collapse-item" href="{site_url}distributor/report/moneyTransferHistory">Transfer Report</a>
            </div>
        </div>
      </li>
      <?php } ?>
      ...
      <li class="nav-item">
        ...
        <div id="collapsensdlpan" class="collapse" aria-labelledby="heading5" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item" href="{site_url}distributor/pancard/utiBalanceRequest">UTI Balance Request</a>
        <?php } ?>
        ...
        <div id="collapseUpi" <?php if($content_block == '') { ?> class="collapse show" <?php } else { ?> class="collapse"<?php } ?> aria-labelledby="heading8" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">UPI Transaction:</h6>
                         ...
                         <a class="collapse-item" href="{site_url}distributor/wallet/addFund">UPI Collection</a>
                         <a class="collapse-item" href="{site_url}distributor/wallet/addCashFund">UPI Cash</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapse10" <?php if($content_block == 'report/recharge-history' || $content_block == 'payment/list' || $content_block == 'report/loan-list' || $content_block == 'report/loan-detail' || $content_block == 'report/bbps-list' || $content_block == 'report/money-transfer-list' || $content_block == 'report/recharge-commission-list' || $content_block == 'report/fund-transfer-commission-list') { ?> class="collapse show" <?php } else { ?> class="collapse"<?php } ?> aria-labelledby="heading10" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{site_url}distributor/report/moneyTransferHistory">Money Transfer Report</a>
            <?php if(in_array(17, $activeService)){ ?>
            <a class="collapse-item" href="{site_url}distributor/newaeps/transactionHistory"><?php echo $this->User->getAepsTitle(); ?> Txn History</a>

            <a class="collapse-item" href="{site_url}distributor/newaeps/transferReport"><?php echo $this->User->getAepsTitle(); ?> Payout History</a>

          <?php } ?>
          <?php if(in_array(17, $activeService)){ ?>
            <a class="collapse-item" href="{site_url}distributor/iciciaeps/transactionHistory">ICICI AEPS Txn History</a>
           <a class="collapse-item" href="{site_url}distributor/transfer/newPayoutReport"> ICICI Payout Report</a>
         <?php } ?>
           ...
           <?php } ?>
            ...
            <a class="collapse-item" href="{site_url}distributor/report/nsdlPanReport">NSDL Pan History</a>
             <?php } ?>
              ...
              <?php if(in_array(26, $activeService)){ ?>
            <a class="collapse-item" href="{site_url}distributor/report/utiBalanceReport">UTI Balance History</a>
             <?php } ?>
      ...
      <li class="nav-item">
        ...
        <div id="collapse111" <?php if($content_block == 'master/my-commission' || $content_block == 'master/my-bbpsCommission' || $content_block == 'master/my-transfer-commision' || $content_block == 'master/my-aeps-commision') { ?> class="collapse show" <?php } else { ?> class="collapse"<?php } ?> aria-labelledby="heading10" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <?php if(in_array(4, $activeService)){ ?>
              <a class="collapse-item" href="{site_url}distributor/master/myBbpsLiveCommission">BBPS Commission</a>
            <?php } ?>
            <a class="collapse-item" href="{site_url}distributor/master/myAccountVerifyCharge">Account Verify Charge</a>
            ...
            <a class="collapse-item" href="{site_url}distributor/master/myTransferCommision">AEPS Payout Charge</a>
            <a class="collapse-item" href="{site_url}distributor/master/myMoneyTransferCommision">Money Transfer Charge</a>
            <?php if(in_array(9, $activeService)){ ?>
            <a class="collapse-item" href="{site_url}distributor/master/myUtiPancardCommission">UTI Pancard Charge</a>
            <?php } ?>
            <?php if(in_array(16, $activeService)){ ?>
            <a class="collapse-item" href="{site_url}distributor/master/myNsdlPancardCharge">NSDL Pancard Charge</a>
            <?php } ?>
            
            <a class="collapse-item" href="{site_url}distributor/master/myUpiCommision">UPI Collection Charge</a>
            <a class="collapse-item" href="{site_url}distributor/master/myUpiCashCommision">UPI Cash Commission</a>
        ...
        <div id="collapse13" <?php if($content_block == 'setting/profile' || $content_block == 'setting/change-password') { ?> class="collapse show" <?php } else { ?> class="collapse"<?php } ?> aria-labelledby="heading8" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Setting:</h6>
                         ...
                         <a class="collapse-item" href="{site_url}distributor/setting/changeTranscationPassword">Change  Transcation Password</a>
...
<?php $notificationList = $this->User->getClubNotification($loggedUser['id']); ?>
        ...
        <div class="container-fluid">
          <?php foreach($notificationList as $nlist){ ?>
            ...
            <div class="alert alert-success alert-dismissable"><?php echo $nlist['msg']; ?> <a href="{site_url}distributor/saving/clubList">Accept</a></div>
          <?php } else { ?>
