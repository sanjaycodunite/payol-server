<?php echo form_open_multipart('employe/token/requestTokenAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
...
{system_message}               
            ...
            <div class="card-header py-3">
              <div class="row">
                ...
                <a href="{site_url}employe/wallet/fundRequest" class="btn btn-primary">Add Request</a>
                </div>                  
              </div>  
