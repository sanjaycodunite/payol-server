...
<div class="card shadow mb-4">
          ...
          <?php echo form_open('',array('id'=>'leadFilterForm')); ?>
              <div class="row">
                ...
                <button type="button" class="btn btn-success" id="newPayoutTransferSearchBtn">Search</button>
                <a href="{site_url}employe/report/newPayoutTransfer" class="btn btn-secondary">View All</a>
                </div>
               </div>  
              <?php echo form_close(); ?>
            </div>
...
<div id="payoutRefundModel" class="modal fade" role="dialog">
  <div class="modal-dialog assign-modal">

  <!-- Modal content-->
  <div class="modal-content">
    <?php echo form_open_multipart('#',array('method'=>'post','id'=>'refundRecordForm')); ?>
    <input type="hidden" name="recordID" id="refundRecordID" value="0">
    <div class="modal-header">
    <h4 class="modal-title">Refund Record</h4>
    ...
    <div class="modalform">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="form-group" id="refundTxnID">
            <p><b>QPAYTXNID - </b></p>
          </div>
          <div class="form-group" id="refundAmount">
            <p><b>Amount - </b></p>
          </div>
          
          <div class="form-group">
            <label>Transcation Password</label>
            <input type="text" name="refund_password" class="form-control">
          </div>
          <div class="form-group">
            <button type="button" id="newAepsPayoutRefundBtn" class="btn btn-primary">Submit</button>
          </div>
        </div>
        <div class="col-md-12" id="refundMsgBlock"></div>
      </div>
    </div>
