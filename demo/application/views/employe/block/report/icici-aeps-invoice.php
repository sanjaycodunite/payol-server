...
<html>
<head>
  <title>ICICI AEPS Receipt</title>
      ...
      <tr style="text-align: left;">
        ...
        <td colspan="2">
          ...
          <h4>
            ...
            <?php if($detail['service'] == 'balinfo'){ ?>
              Balance Info
            <?php } elseif($detail['service'] == 'ministatement'){ ?>
              Mini Statement
            <?php } elseif($detail['service'] == 'balwithdraw'){ ?>
              Account Withdrawal
            <?php } elseif($detail['service'] == 'aadharpay'){ ?>
              Aadhar Pay
            <?php } else { ?>
              &nbsp;
            <?php } ?>
