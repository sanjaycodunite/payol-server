<div class="card shadow mb-4">
              {system_message}               
              {system_info}
              <?php echo form_open_multipart('employe/master/savePanCharge', array('id' => 'admin_profile'),array('method'=>'post')); ?>
            <div class="card-header py-3">
              <div class="row">
                <div class="col-sm-8">
                <h4><b>PAN Card Charge</b></h4>
                </div>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-2">
                <button type="button" id="panSearchBtn" class="btn btn-success">Search</button>
                </div>
