        ...
        <div id="collapse5" <?php if($content_block == 'recharge/mobile-prepaid' || $content_block == 'recharge/mobile-postpaid' || $content_block == 'recharge/dth' || $content_block == 'recharge/electricity' || $content_block == 'recharge/datacard' || $content_block == 'recharge/landline' || $content_block == 'recharge/broadband' ) { ?> class="collapse show" <?php } else { ?> class="collapse"<?php } ?> aria-labelledby="heading5" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <?php if($isInstantPayApiAllow){ ?>
              <a class="collapse-item <?php if($content_block == 'recharge/ekyc'){ ?> active <?php } ?> " href="{site_url}retailer/recharge/ekyc">Merchant eKyc</a>
            <?php } ?>
            <a class="collapse-item <?php if($content_block == 'recharge/mobile-prepaid'){ ?> active <?php } ?> " href="{site_url}retailer/recharge/mobileprepaid">Mobile</a>
            
            <a class="collapse-item <?php if($content_block == 'recharge/dth'){ ?> active <?php } ?> " href="{site_url}retailer/recharge/dth">DTH</a>
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"> <?php echo $this->User->getAepsTitle(); ?>  AEPS Service:</h6>
             <?php if(!$user_new_aeps_status){ ?>
              ...
              <a class="collapse-item" href="{site_url}retailer/newaeps/transactionHistory">Transaction History</a>
            <?php } ?>
          </div>
        </div>
      </li> 
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">ICICI AEPS:</h6>
             <?php if(!$user_instantpay_aeps_status){ ?>
              ...
              <a class="collapse-item" href="{site_url}retailer/iciciaeps/transactionHistory">Transaction History</a>
            <?php } ?>
          </div>
        </div>
      </li> 
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">AEPS3 Service:</h6>
             <?php if(!$user_aeps3_status){ ?>
              ...
              <a class="collapse-item" href="{site_url}retailer/fingpayAeps/transactionHistory">Transaction History</a>
            <?php } ?>
          </div>
        </div>
      </li> 
        ...
        <div id="collapse10" <?php if($content_block == 'report/recharge-history' || $content_block == 'payment/list' || $content_block == 'report/loan-list' || $content_block == 'report/loan-detail' || $content_block == 'report/bbps-list' || $content_block == 'report/money-transfer-list' || $content_block == 'report/recharge-commission-list') { ?> class="collapse show" <?php } else { ?> class="collapse"<?php } ?> aria-labelledby="heading10" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
           ...
           <!--  <a class="collapse-item" href="{site_url}retailer/report/moneyTransfer">AEPS Payout Report</a> -->
            <a class="collapse-item" href="{site_url}retailer/report/moneyTransferHistory">Money Transfer Report</a>
            <?php if(in_array(10, $activeService)){ ?>
            ...
            <a class="collapse-item" href="{site_url}retailer/report/cashDepositeReport">Cash Deposite History</a> 
            <?php } ?>
      ...
      <li class="nav-item">
        ...
        <div id="collapse111" <?php if($content_block == 'master/my-commission' || $content_block == 'master/my-bbpsCommission' || $content_block == 'master/my-transfer-commision' || $content_block == 'master/my-aeps-commision') { ?> class="collapse show" <?php } else { ?> class="collapse"<?php } ?> aria-labelledby="heading10" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <?php } ?>
            <a class="collapse-item" href="{site_url}retailer/master/myAccountVerifyCharge">Account Verify Charge</a>
            ...
            <a class="collapse-item" href="{site_url}retailer/master/myMoneyTransferCommision">Money Transfer Charge</a>
            <?php if(in_array(9, $activeService)){ ?>
            <a class="collapse-item" href="{site_url}retailer/master/myUtiPancardCommission">UTI Pancard Charge</a>
            <?php } ?>
            <?php if(in_array(16, $activeService)){ ?>
            <a class="collapse-item" href="{site_url}retailer/master/myNsdlPancardCharge">NSDL Pancard Charge</a>
            <?php } ?>
        ...
        <div id="collapse13" <?php if($content_block == 'setting/profile' || $content_block == 'setting/change-password') { ?> class="collapse show" <?php } else { ?> class="collapse"<?php } ?> aria-labelledby="heading8" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Setting:</h6>
                         ...
                         <a class="collapse-item" href="{site_url}retailer/setting/changeTranscationPassword">Change  Transcation Password</a>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light  topbar">
          ...
          <ul class="navbar-nav ml-auto">
           ...
           <li class="nav-item dropdown" data-toggle="tooltip" data-placement="top" title="" data-original-title="">
            <a href="{site_url}retailer/dashboard/showNotification" class="dropdown-toggle" id="notifiDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-bell"></i> <span class="nav_notification_num" id="new-request"><?php echo $this->User->getTotalUnreadNotification(); ?></span></a>

            <div class="notification_drop dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="notifiDropdown">
              <div class="card_notification_list_heading"><h4>Notification</h4></div>
  ...
  <div class="flex-shrink-0">
   <div class="notify-icon">
    <img class="img-profile rounded-circle" src="{site_url}skin/admin/images/bell.png">
     ...
     <a href="{site_url}retailer/dashboard/showNotification/<?php echo $list['id'] ?>">
   <div class="flex-grow-1 text-truncate ml-2">
    <h5 class="noti-item-title fw-medium fs-14"><?php echo $list['title']  ?></h5>
  <small class="noti-item-subtitle text-muted"><?php  echo substr($list['message'], 0,25)?></small>
      </div>
    </a>
      </div>
</div>
      ...
      <?php $notificationList = $this->User->getClubNotification($loggedUser['id']); ?>
        ...
        <div class="container-fluid">
          <?php foreach($notificationList as $nlist){ ?>
            ...
            <div class="alert alert-success alert-dismissable"><?php echo $nlist['msg']; ?> <a href="{site_url}retailer/saving/clubList">Accept</a></div>
          <?php } else { ?>
