      ...
      <div class="card-header">
       <div class="row">
        ...
        <div class="col-sm-6 text-right">
          <a href="{site_url}retailer/newaeps/addBeneficiary" class="btn btn-primary">+Add Beneficiary</a>
        </div> 
          <?php } ?>
        </div>  
      </div>
          ...
          <table class="table table-bordered" id="example">
            ...
            <tr>
              ...
              <td class="align-middle">
                ...
                <?php } else{ ?>
                  <a href="{site_url}retailer/newaeps/uploadDocument/<?=$list['bene_id']?>">Verify Document</a>
                <?php } ?>
              </td>
               <td class="align-middle">
                <?php
                 if($list['is_verified'] != 1){
                ?>
                <a href="{site_url}retailer/newaeps/checkAccountStatus/<?php echo $list['id']; ?>"><button class="btn btn-primary" type="button">Check Status</button></a>
               <?php } else{ ?>
                 Not Allowed
               <?php } ?>
              </td>
              ...
              <td class="align-middle">
                <?php
                 if($list['is_verified'] == 1){
                ?>
                <a href="{site_url}retailer/newaeps/fundTransfer/<?php echo $list['id']; ?>"><button class="btn btn-primary" type="button">Transfer</button></a>
               <?php } else{ ?>
                 Not Allowed
               <?php } ?>
              </td>
