            ...
            <div class="card-header py-3">
              <?php echo form_open('',array('id'=>'leadFilterForm')); ?>
               <div class="row">
                ...
                <a href="{site_url}retailer/report/bbpsHistory" class="btn btn-secondary">View All</a>
                </div>
               </div>  
              <?php echo form_close(); ?>
            </div>
...
<div id="updateComplainModel" class="modal fade" role="dialog">
  ...
  <div class="modal-content">
    <?php echo form_open_multipart('retailer/report/complainAuth',array('method'=>'post')); ?>
