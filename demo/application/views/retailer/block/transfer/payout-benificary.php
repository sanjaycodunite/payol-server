 <div class="row">
  ...
  <div class="col-sm-12">
    ...
    <div class="card">
      ...
      <?php echo form_open_multipart('retailer/transfer/payoutBenificaryAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
      <div class="card-body">
          ...
          <table class="table table-bordered" id="example">
            ...
            <tr>
              ...
              <td class="align-middle">
                <a href="{site_url}retailer/transfer/payoutFundTransfer/<?php echo $list['id']; ?>"><button class="btn btn-primary" type="button">Transfer</button></a>
              </td>
              </tr>
            <?php $i++; }}else{  ?>  
            <tr>
