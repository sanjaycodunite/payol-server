  ...
  <div class="col-sm-6">
    ...
    <div class="card">
      ...
      <?php echo form_open_multipart('user/recharge/dthRecharge', array('id' => 'admin_profile','method'=>'post')); ?>
      <div class="card-body">
       ...
       <div class="form-group">
        ...
        <input type="text" class="form-control" data-bv-field="number" id="cardNumber" name="cardNumber" placeholder="Enter Card Number">
        <samp class="bar"></samp>
       ...
       <div class="form-group">
        ...
        <samp class="bar"></samp>
        <?php echo form_error('customerName', '<div class="error">', '</div>'); ?> 
       </div>
       ...
       <div class="row">
         ...
         <div class="col-sm-6 text-right">
          <a href="#" onclick="showDTHROfferModal(); return false;">View Plan</a>
         </div> 
         <div class="col-sm-12" id="customerInfoLoader">
