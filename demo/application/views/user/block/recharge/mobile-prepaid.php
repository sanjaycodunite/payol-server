  ...
  <div class="col-sm-6">
    ...
    <div class="card">
      ...
      <?php echo form_open_multipart('user/recharge/mobileRecharge', array('id' => 'admin_profile','method'=>'post')); ?>
      <div class="card-body">
       <div class="form-group">
        <input type="radio" name="recharge_type" value="1" checked="checked" id="rdlprepaid">
        <label for="rdlprepaid">Prepaid</label>&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="radio" name="recharge_type" value="2" id="rdlpostpaid">
        <label for="rdlpostpaid">Postpaid</label>
       </div>
       <div class="form-group">
