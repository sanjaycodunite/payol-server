<?php echo form_open_multipart('user/token/requestTokenAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
...
{system_message}               
            ...
            <div class="card-header py-3">
              <div class="row">
                <div class="col-sm-4">
                <h4><b>My E-Wallet Request List</b></h4>
                </div>
                ...
                <a href="{site_url}user/ewallet/fundRequest" class="btn btn-primary">Add Request</a>
                </div>                  
              </div>  
