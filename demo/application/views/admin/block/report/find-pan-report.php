<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <div class="row">
                ...
                <a href="{site_url}admin/report/findPanReport" class="btn btn-secondary">View All</a>
                </div>
               </div>  
              <?php echo form_close(); ?>
            </div>
          ...
          <div class="modal fade" id="findPanModal" tabindex="-1" role="dialog" aria-labelledby="updateStatusModalTitle" aria-hidden="true">
         <?php echo form_open_multipart('admin/report/updateFindPanImage',array('method'=>'post','id'=>'updateStatusForm')); ?>
