           ...
           <div class="transfer_form_tabs">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                             <div class="form_colms">
                                <?php echo form_open_multipart('master/dmt/registerAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
            ...
            <?php echo form_close(); ?>     
                            ...
                            <div class="tab-pane" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                             <?php echo form_open_multipart('master/dmt/loginAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
                                <div class="row">
