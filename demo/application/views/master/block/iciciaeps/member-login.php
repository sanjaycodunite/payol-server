...
<div class="card shadow ">
            ...
            <div class="row">
              ...
              <input type="text" class="form-control" name="aadhar_no" id="aadhar_no" placeholder="Aadhar No" maxlength="12" value="<?php echo set_value('aadhar_no') ?>">
               ...
               <div class="col-sm-3">
              <div class="form-group">
              <label><b>Outlet ID*</b></label>
              <input type="text" class="form-control" name="outlet_id" id="outlet_id" placeholder="Outlet ID" maxlength="12" value="<?php echo $get_member_data['instantpay_outlet_id'] ?>" readonly>
