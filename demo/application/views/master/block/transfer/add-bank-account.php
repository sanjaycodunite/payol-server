...
<div class="col-lg-12"> 
  {system_message}    
     {system_info} 
<div class="settlement_card_col card shadow mb-4">
<div class="card-body">
<h5 class="card-title text-center">Add Account</h5>
...
<button class="btn btn-primary btn-sm mt-2" type="button" id="add_upi_account">Add UPI Account</button>  
    ...
    <div class="card">
      ...
      <?php echo form_open_multipart('master/transfer/saveBenificaryBankAccount', array('id' => 'account_verify_form'),array('method'=>'post')); ?>
 ...
 <div class="modal fade" id="bankModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="col-sm-12" style="display: none;" id="show_upi_account">
    ...
    <div class="card">
      ...
      <?php echo form_open_multipart('master/transfer/saveBenificaryBankAccount', array('id' => 'upi_verify_form'),array('method'=>'post')); ?>
