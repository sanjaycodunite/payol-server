...
<div class="card shadow ">
            ...
            <div class="card-body">
            <?php echo form_open_multipart('master/transfer/senderOtpAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
            ...
            <div class="row">
              ...
              <br />
              <a href="{site_url}master/transfer/resendSenderOtp/{encodeTxnId}">Resend OTP</a>
              </div>
              </div>
