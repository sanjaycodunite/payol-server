...
class Commission extends CI_Controller {    
    ...
    public function __construct() 
    {
        ...
        $this->load->model('employe/Ewallet_model');		
        $this->lang->load('employe/ewallet', 'english');
	...
	public function walletList(){
		...
		if(!$this->User->admin_menu_permission(23,1) || !$this->User->admin_menu_permission(96,2)){
