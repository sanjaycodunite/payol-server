	...
	public function index($uname_prefix = '' , $username = ''){
       ...
       $today_failed_record = isset($get_today_failed_fund['totalRecord']) ? $get_today_failed_fund['totalRecord'] : 0 ;
		...
		$data = array(
            ...
            'total_success_fund' =>$total_success_fund,
            'total_success_record' =>$total_success_record,
            'total_pending_fund' =>$total_pending_fund,
            'total_pending_record' =>$total_pending_record,
            'total_failed_fund' =>$total_failed_fund,
            'total_failed_record' =>$total_failed_record,
            ...
            'today_success_fund' =>$today_success_fund,
            'today_success_record' =>$today_success_record,
            'today_pending_fund' =>$today_pending_fund,
            'today_pending_record' =>$today_pending_record,
            'today_failed_fund' =>$today_failed_fund,
            'today_failed_record' =>$today_failed_record,
