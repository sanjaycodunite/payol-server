...
class FingpayAeps extends CI_Controller {    
	...
	public function aepsConfirm(){
		...
		$data = array(
            ...
            'system_info' => $this->Az->getsystemMessageInfo(),
            'system_warning' => $this->Az->getSystemMessageWarning(),
            'content_block' => 'fingpayaeps/aeps-confirm'
        );
        $this->parser->parse('retailer/layout/column-1' , $data);
		...
		public function aepsTransaction(){
		...
		$data = array(
            ...
            'system_info' => $this->Az->getsystemMessageInfo(),
            'system_warning' => $this->Az->getSystemMessageWarning(),
            'content_block' => 'fingpayaeps/aeps-transaction'
        );
        $this->parser->parse('retailer/layout/column-1' , $data);
		...
		$data = array(
            ...
            'system_info' => $this->Az->getsystemMessageInfo(),
            'system_warning' => $this->Az->getSystemMessageWarning(),
            'content_block' => 'fingpayaeps/aeps-aadhar'
        );
        $this->parser->parse('retailer/layout/column-1' , $data);
