...
class Package extends CI_Controller {    
    ...
    public function __construct() 
    {
        ...
        $this->lang->load('distributor/package', 'english');
	...
	public function savePackage()
	{
		...
		{	
			...
			if($status == true)
			{
				$this->Az->redirect('distributor/package', 'system_message_error',lang('SAVE_SUCCESS'));
			}
			else
			{
				$this->Az->redirect('distributor/package', 'system_message_error',lang('DB_ERROR'));
			}
	...
	public function updatePackage()
	{
		...
		{	
			...
			if($status == true)
			{
				$this->Az->redirect('distributor/package', 'system_message_error',lang('UPDATE_SUCCESS'));
			}
			else
			{
				$this->Az->redirect('distributor/package', 'system_message_error',lang('DB_ERROR'));
	...
	{	
		...
		$this->Az->redirect('distributor/package', 'system_message_error',lang('DELETE_SUCCESS'));
	}
