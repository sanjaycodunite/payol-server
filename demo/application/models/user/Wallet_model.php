...
class Wallet_model extends CI_Model {
    ...
    {       
            ...
            // save system log
            $log_msg = '['.date('d-m-Y H:i:s').' - USER('.$loggedUser['user_code'].') - Credit/Debit Wallet Member #'.$member_code.' Amount '.$type_title.'.]'.PHP_EOL;
            ...
            // save system log
            $log_msg = '['.date('d-m-Y H:i:s').' - USER('.$loggedUser['user_code'].') - Wallet Amount Debited from  User Account.]'.PHP_EOL;
                $this->User->generateLog($log_msg);
    ...
    public function cibPayout($account_holder_name,$account_no,$ifsc,$amount,$transaction_id,$bankID,$txnType)
    {
        ...
        // save system log
        $log_msg = '['.date('d-m-Y H:i:s').' - U('.$loggedUser['user_code'].') - Payout API Post Data - '.$plainText.']'.PHP_EOL;
        $this->User->generateLog($log_msg);
        ...
        // save system log
        $log_msg = '['.date('d-m-Y H:i:s').' - U('.$loggedUser['user_code'].') - Payout API Encode Response - '.$result.']'.PHP_EOL;
        $this->User->generateLog($log_msg);
        ...
        // save system log
        $log_msg = '['.date('d-m-Y H:i:s').' - U('.$loggedUser['user_code'].') - Payout API Response - '.$finalResponse.']'.PHP_EOL;
        $this->User->generateLog($log_msg);
    ...
    public function cibMoneyTransfer($account_holder_name,$account_no,$ifsc,$amount,$transaction_id,$bankID,$txnType)
    {
        ...
        // save system log
        $log_msg = '['.date('d-m-Y H:i:s').' - U('.$loggedUser['user_code'].') - DMT API Post Data - '.$plainText.']'.PHP_EOL;
        $this->User->generateLog($log_msg);
        ...
        // save system log
        $log_msg = '['.date('d-m-Y H:i:s').' - U('.$loggedUser['user_code'].') - DMT API Encode Response - '.$result.']'.PHP_EOL;
        $this->User->generateLog($log_msg);
        ...
        $decodeResponse = json_decode($finalResponse,true);
        // save system log
        $log_msg = '['.date('d-m-Y H:i:s').' - U('.$loggedUser['user_code'].') - DMT API Response - '.$finalResponse.']'.PHP_EOL;
        $this->User->generateLog($log_msg);
