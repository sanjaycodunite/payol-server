...
-----END RSA PRIVATE KEY-----';
    ...
    public function upiGenerateDynamicQr($account_id,$loggedAccountID,$post)
    {
        ...
        $payload = base64_encode($this->sslEncryptCollectpay($plainText));
        ...
        $response = $this->sslDecryptComposite(base64_decode($result));

        /*$response = '{"merchantId":"6260611","terminalId":"5411","success":"true","response":"0","message":"Transaction initiated","refId":"EZV2023052918261508198546","merchantTranId":"16853649759847"}';*/
        ...
        /*{"merchantId":"6260611","terminalId":"5411","success":"true","response":"0","message":"Transaction initiated","refId":"EZV2023052918261508198546","merchantTranId":"16853649759847"}*/
        ...
        if(isset($finalResponse['message']) && $finalResponse['message'] == 'Transaction initiated')
        {
            $intent = 'upi://pay?pa=TRUSTNCARTCOLL@icici&pn=Trustncart&tr='.$finalResponse['refId'].'&am=0&cu=INR&mc=5411';
