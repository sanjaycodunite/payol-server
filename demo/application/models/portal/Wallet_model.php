...
-----END RSA PRIVATE KEY-----';
    ...
    public function upiGenerateDynamicQr($account_id,$loggedAccountID,$amount,$txnid,$memberID,$memberMobile)
    {
        //get member wallet_balance
        ...
        $xverify = hash('sha256', $request.'/pg/v1/payd5927758-e8fa-4e76-8e5c-432440220c8d').'###1';
        $header = [
