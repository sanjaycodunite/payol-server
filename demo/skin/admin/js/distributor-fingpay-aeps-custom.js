...
function CallApi(ServiceType, BiometricData) {
    ...
    jQuery.ajax({
        type: "POST",
        url: siteUrl+"distributor/fingpayAeps/apiAuth",
...
function Call2FaApi(BiometricData) {
   ...
   // var IIN = $("#bankID").val();
    ...
    jQuery.ajax({
        type: "POST",
        url: siteUrl+"distributor/fingpayAeps/api2FaAuth",
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify(jsonData),
        dataType: "json",
        success: function (Result) {
            ...
            setTimeout(function() {
                              window.location.replace(siteUrl+'distributor/fingpayAeps');
                            }, 10000);
   ...
   // var IIN = $("#bankID").val();
    ...
    jQuery.ajax({
        type: "POST",
        url: siteUrl+"distributor/fingpayAeps/api2FaAuthNew",
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify(jsonData),
        dataType: "json",
        success: function (Result) {
...
function CallKYCVerifyApi(BiometricData) {
    ...
    jQuery.ajax({
        type: "POST",
        url: siteUrl+"distributor/fingpayAeps/kycBioAuth",
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify(jsonData),
        dataType: "json",
        success: function (Result) {
            if(Result.status == 1)
            {
                ...
                window.location.href=siteUrl+"distributor/fingpayAeps";
