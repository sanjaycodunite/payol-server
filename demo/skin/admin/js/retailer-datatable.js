$(document).ready(function() {
      ...
      { 
        ...
        var axisAccountDataTable = $('#axisAccountDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"retailer/report/getAxisAccountList",
              "data": function ( d ) {
              d.extra_search = keyword+"|"+date;
            }
          },
     ...
     function nsdlListDataTable(keyword = '',date='')
      ...
      { 
        ...
        var upiCashCommisionDataTable = $('#upiCashCommisionDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"retailer/report/getUpiCashCommisionList",
              "data": function ( d ) {
     ...
     $('#upiCashCommisionSearchBtn').on('click', function() {
      ...
      { 
        ...
        var upiCommisionDataTable = $('#upiCommisionDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"retailer/report/getUpiCommisionList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
     ...
     $('#upiCommisionSearchBtn').on('click', function() {
      ...
      function myWalletDataTable(keyword = '',member_id='',fromDate='',toDate = '')
      { 
      ...
      $('#myWalletSearchBtn').on('click', function() {
        ...
        var fromDate = $("#from_date").val();
        var toDate = $("#to_date").val();
        myWalletDataTable(keyword,member_id,fromDate,toDate);
      }); 
     ...
     function rechargeDataTable(status = 0,keyword = '',fromDate = '',toDate = '')
      { 
     ...
     $('#rechargeSearchBtn').on('click', function() {
      ...
      { 
        ...
        var complainDataTable = $('#complainDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"retailer/complain/getComplainList",
              "data": function ( d ) {
              d.extra_search = keyword+"|"+member_id+'|'+date;
            }
          },
      ...
      { 
        ...
        var currentAccountDataTable = $('#currentAccountDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"retailer/current/getAccountList",
              "data": function ( d ) {
              d.extra_search = keyword+"|"+date;
            }
          },
      ...
      { 
        ...
        var bbpsHistoryDataTable = $('#bbpsHistoryDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"retailer/report/getBBPSHistoryList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate+'|'+status;
            }
          },
     ...
     function rechargeCommisionDataTable(keyword = '',fromDate = '',toDate = '')
      { 
        ...
        var rechargeCommisionDataTable = $('#rechargeCommisionDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"retailer/report/getRechargeCommisionList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
     ...
     function manualMoneyTransferDataTable(keyword = '',date='')
      ...
      function aepsTxnDataTable(keyword = '', fromDate='', toDate = '' , status = 0,service = '')
      { 
        ...
        var aepsTxnDataTable = $('#aepsTxnDataTable').DataTable({
          ...
          "lengthMenu": [ 10, 25, 50, 75, 100 ],
          "searching": false,
          "columnDefs": [{"targets": 0,"orderable": false},{"targets": 1,"orderable": false},{"targets": 2,"orderable": false},{"targets": 3,"orderable": false},{"targets": 4,"orderable": false},{"targets": 6,"orderable": false},{"targets": 7,"orderable": false},{"targets": 8,"orderable": false},{"targets": 9,"orderable": false},{"targets": 10,"orderable": false},{"targets": 11,"orderable": false}],
          "processing": false ,
          "serverSide": true,
          "order": [[ 0, "desc" ]],
          deferRender: true,
      ...
      $('#aepsTxnDataTable').DataTable().destroy();
      var keyword = $("#keyword").val();
      var fromDate = $("#from_date").val();
      var toDate = $("#to_date").val();
       var status = $("#status").val();
        ...
        var service = $("#service").val();
      aepsTxnDataTable(keyword,fromDate,toDate,status,service);
     });
     ...
     function nsdlPanDataTable(keyword = '',date='')
      { 
        ...
        var nsdlPanDataTable = $('#nsdlPanDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"retailer/report/getNsdlPanList",
              "data": function ( d ) {
              d.extra_search = keyword+"|"+date;
            }
          },
      ...
      { 
        ...
        var nsdlPanCardDataTable = $('#nsdlPanCardDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"retailer/report/getNsdlPanCardList",
              "data": function ( d ) {
              d.extra_search = keyword+"|"+date;
            }
          },
      ...
      function gstInvoiceDataTable(keyword = '')
      { 

        var siteUrl = $("#siteUrl").val();
        var gstInvoiceDataTable = $('#gstInvoiceDataTable').DataTable({
          dom: 'Bfrtip',
          buttons: [
              'copy', 'csv', 'excel', 'pdf'
          ],
      ...
      $('#gstinvoiceSearchBtn').on('click', function() {
        $('#gstInvoiceDataTable').DataTable().destroy();
        var keyword = $("#keyword").val();
       
        gstInvoiceDataTable(keyword);
      });
