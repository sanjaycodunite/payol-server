      ...
      { 
        ...
        var currentAccountDataTable = $('#currentAccountDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getCurrentAccountList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
      ...
      { 
        ...
        var axisAccountDataTable = $('#axisAccountDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getAxisAccountList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
      ...
      { 
        ...
        var downlineDataTable = $('#downlineDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/member/getDownlineMemberList",
              "data": function ( d ) {
      ...
      { 
        ...
        var uplineDataTable = $('#uplineDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/member/getUplineMemberList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+date+'|'+memberID;
            }
          },
     ...
     $('#gatewayHistorySearchBtn').on('click', function() {
      ...
      { 
        ...
        var complainDataTable = $('#complainDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/complain/getComplainList",
              "data": function ( d ) {
              d.extra_search = keyword+"|"+member_id+'|'+date;
            }
          },
     ...
     $('#searchMyRequestBtn').on('click', function() {
      ...
      { 
        ...
        var rechargeDataTable = $('#rechargeDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getRechargeList",
              "data": function ( d ) {
     ...
     $('#rechargeSearchBtn').on('click', function() {
      ...
      { 
        ...
        var bbpsHistoryDataTable = $('#bbpsHistoryDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getBbpsHistoryList",
              "data": function ( d ) {
     ...
     function balanceReportDataTable(keyword = '',user_type = '')
      { 
        ...
        var balanceReportDataTable = $('#balanceReportDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getBalanceReport",
              "data": function ( d ) {
     ...
     function commissionReportDataTable(keyword = '',user_type = '')
      { 
        ...
        var commissionReportDataTable = $('#commissionReportDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getCommissionReport",
              "data": function ( d ) {
     ...
     function rechargeCommisionDataTable(keyword = '',fromDate = '',toDate = '')
      { 
        ...
        var rechargeCommisionDataTable = $('#rechargeCommisionDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getRechargeCommisionList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
     ...
     function bbpsCommisionDataTable(keyword = '',fromDate = '',toDate = '')
      { 
        ...
        var bbpsCommisionDataTable = $('#bbpsCommisionDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getBBPSCommisionList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
     ...
     function fundTransferCommisionDataTable(keyword = '',fromDate = '',toDate = '')
      { 
        ...
        var fundTransferCommisionDataTable = $('#fundTransferCommisionDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getFundTransferCommisionList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
     ...
     function moneyTransferCommisionDataTable(keyword = '',fromDate = '',toDate = '')
      { 
        ...
        var moneyTransferCommisionDataTable = $('#moneyTransferCommisionDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getMoneyTransferCommisionList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
     ...
     function openPayoutCommisionDataTable(keyword = '',fromDate = '',toDate = '')
      { 
        ...
        var openPayoutCommisionDataTable = $('#openPayoutCommisionDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getOpenPayoutCommisionList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
     ...
     function aepsCommisionDataTable(keyword = '',fromDate = '',toDate = '')
      { 
        ...
        var aepsCommisionDataTable = $('#aepsCommisionDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getAepsCommisionList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
     ...
     function myAepsCommisionDataTable(keyword = '',fromDate = '',toDate = '')
      { 
        ...
        var myAepsCommisionDataTable = $('#myAepsCommisionDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getMyAepsCommisionList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
     ...
     function cashDepositeCommisionDataTable(keyword = '',fromDate = '',toDate = '')
      { 
        ...
        var cashDepositeCommisionDataTable = $('#cashDepositeCommisionDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getCashDepositeCommisionList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
     ...
     function upiCommisionDataTable(keyword = '',fromDate = '',toDate = '')
      { 
        ...
        var upiCommisionDataTable = $('#upiCommisionDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getUpiCommisionList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
     ...
     function referralCommisionDataTable(keyword = '',fromDate = '',toDate = '')
      { 
        ...
        var referralCommisionDataTable = $('#referralCommisionDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getReferralCommissionList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
     ...
     function upiCashCommisionDataTable(keyword = '',fromDate = '',toDate = '')
      { 
        ...
        var upiCashCommisionDataTable = $('#upiCashCommisionDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getUpiCashCommisionList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate;
            }
          },
     ...
     function moveMemberDataTable(keyword = '')
      { 
        ...
        var moveMemberDataTable = $('#moveMemberDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/report/getMoveMemberList",
              "data": function ( d ) {
              d.extra_search = keyword;
            }
          },
     ...
     function upiQrDataTable(keyword = '',date='')
      { 
     ...
     function manualMoneyTransferDataTable(keyword = '',date='')
      ...
      function checkCibStatus(recordID)
      {
          var siteUrl = $("#siteUrl").val();
          $.ajax({                
          url:siteUrl+'employe/report/checkCibStatus/'+recordID,                        
          success:function(r){
    ...
    function moneyTransferHistoryDataTable(keyword = '',fromDate='', toDate = '' ,status = 0, user = '')
      { 
       ...
       function newMoneyTransferHistoryDataTable(keyword = '',fromDate='', toDate = '' ,status = 0, user = '')
      { 
       ...
       $('#newMoneyTransferHistorySearchBtn').on('click', function() {
        ...
        var status = $("#status").val();
        var user = $("#user").val();
        newMoneyTransferHistoryDataTable(keyword,fromDate,toDate,status,user);
      });
       ...
       function upiTransferHistoryDataTable(keyword = '',fromDate='', toDate = '')
      { 
       ...
       $('#upiTransferHistorySearchBtn').on('click', function() {
        ...
        var fromDate = $("#from_date").val();
        var toDate = $("#to_date").val();
        upiTransferHistoryDataTable(keyword,fromDate,toDate);
      });
     ...
     function dynamicInvoiceDataTable(keyword = '')
      ...
      { 
        ...
        var invoiceSummeryDataTable = $('#invoiceSummeryDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/account/getDynamicInvoiceSummeryList",
              "data": function ( d ) {
     ...
     function findPanDataTable(keyword = '',fromDate='', toDate = '')
      ...
      { 
        ...
        var tdsInvoiceSummeryDataTable = $('#tdsInvoiceSummeryDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            "url": siteUrl+"employe/account/getTdsInvoiceSummeryList",
              "data": function ( d ) {
              d.extra_search = keyword+"|"+invoice_id;
            }
          },
