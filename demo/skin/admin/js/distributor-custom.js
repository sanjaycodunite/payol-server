$(document).ready(function() {	
	...
	$("#rechargeComSearchBtn").click(function(){
		...
		{
			$.ajax({                
				url:siteUrl+'distributor/master/getRechargeCommData/'+memberID,                        
				success:function(r){
	...
	$("#upi-topup-btn").click(function(){
		...
		$(".upi_loader").show();
			...
			$.ajax({
				type:'POST',                
				url:siteUrl+'distributor/wallet/upiRequestAuth',
				data:str,                        
				success:function(r){
	...
	function getUpiCallback(txnid = ''){
	    var siteUrl = $("#siteUrl").val();
	    $.ajax({                
	      url:siteUrl+'distributor/wallet/getUpiCallbackResponse/'+txnid,                        
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	          window.location.href = siteUrl+'distributor/wallet/sendRequest';
	        }
	        else
	        {
	...
	$("#upi-cash-topup-btn").click(function(){
		...
		$(".upi_loader").show();
			...
			$.ajax({
				type:'POST',                
				url:siteUrl+'distributor/wallet/upiCashRequestAuth',
				data:str,                        
				success:function(r){
	...
	function getUpiCashCallback(txnid = ''){
	    var siteUrl = $("#siteUrl").val();
	    $.ajax({                
	      url:siteUrl+'distributor/wallet/getUpiCashCallbackResponse/'+txnid,                        
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	          window.location.href = siteUrl+'distributor/wallet/sendCashRequest';
	        }
	        else
	        {
	...
	$("#qr-topup-btn").click(function(){
		...
		$(".upi_loader").show();
			...
			$.ajax({
				type:'POST',                
				url:siteUrl+'distributor/upi/qrGenerateAuth',
				data:str,                        
				success:function(r){
	...
	$("#bbpsComSearchBtn").click(function(){
		...
		{
			$.ajax({                
				url:siteUrl+'distributor/master/getBBPSCommData/'+memberID,                        
				success:function(r){
	...
	$("#dmrComSearchBtn").click(function(){
		...
		{
			$.ajax({                
				url:siteUrl+'distributor/master/getMemberDMRCommData/'+memberID,                        
				success:function(r){
	...
	$("#aepsComSearchBtn").click(function(){
		...
		$(".recharge-comm-loader").html("<img src='"+siteUrl+"skin/images/loading2.gif' alt='loading' />");
		$.ajax({                
			url:siteUrl+'distributor/master/getMemberAEPSCommData/'+memberID,                        
			success:function(r){
	...
	$("#serviceSearchBtn").click(function(){
		...
		$(".recharge-comm-loader").html("<img src='"+siteUrl+"skin/images/loading2.gif' alt='loading' />");
		$.ajax({                
			url:siteUrl+'distributor/master/getServiceData/'+memberID,                        
			success:function(r){
	...
	$("#selState").change(function(){
		...
		if(stateID){
			$.ajax({                
				url:siteUrl+'distributor/aeps/getCityList/'+stateID,                        
				success:function(r){
	...
	$("#nsdlStateId").change(function(){
		...
		if(stateID){
			$.ajax({                
				url:siteUrl+'distributor/pancard/getNsdlDistrictList/'+stateID,                        
				success:function(r){
	...
	$("#electricityOperator").change(function(){
      ...
      else
      {
        ...
        $.ajax({               
          type:'POST', 
          url:siteUrl+'distributor/recharge/fetchBiller/'+operator_id,                        
          success:function(r){
            var data = JSON.parse($.trim(r));
            if(data["status"] == 1){
              $(".ajax-loader").html('');
    ...
    $("#account_number").blur(function(){
      ...
      else
      {
        ...
        $.ajax({               
          type:'POST', 
          url:siteUrl+'distributor/recharge/fetchBillerDetail/'+operator_id,                        
          data:str,
          success:function(r){
            var data = JSON.parse($.trim(r));
            if(data["status"] == 1){
    ...
    $("#payolmobile").blur(function(){
      ...
      if(mobile != '')
      {
	        ...
	        $.ajax({               
	          type:'POST', 
	          url:siteUrl+'distributor/wallet/getMemberName/'+mobile,                        
	          success:function(r){
	            var data = JSON.parse($.trim(r));
	...
	$("#selMember").change(function(){
		...
		if(memberID){
			$.ajax({                
				url:siteUrl+'distributor/wallet/getMemberWalletBalance/'+memberID,                        
				success:function(r){
	...
	$("#selEwalletMember").change(function(){
		...
		if(memberID){
			$.ajax({                
				url:siteUrl+'distributor/ewallet/getMemberWalletBalance/'+memberID,                        
				success:function(r){
	...
	$("#viewPlanSearchBtn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/recharge/getOperatorPlanList',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#dthViewPlanSearchBtn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/recharge/getDTHOperatorPlanList',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#offermobile").blur(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/recharge/getOperatorType/'+$(this).val(),
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#rofferSearchBtn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/recharge/getRofferList',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#dthRofferSearchBtn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/recharge/getDTHRofferList',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#cardNumber").blur(function(){
		...
		if(cardNumber != '' && operator != '')
		{
		    ...
		    $.ajax({               
		      type:'POST', 
		      url:siteUrl+'distributor/recharge/getDTHCustomerInfo',
		      data:str,
		      success:function(r){
		        var data = JSON.parse($.trim(r));
		        if(data["status"] == 1){
	...
	$("#bbps-mobile-prepaid-btn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/mobilePrepaidAuth',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#mobilePostpaidOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+3,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	        if(data['is_fetch'] == 1){
	...
	$("#bbps-mobile-postpaid-btn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/mobilePostpaidAuth',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#bbpsElectricityOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+4,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbps-electricity-btn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/electricityAuth',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#bbpsDTHOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+1,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#dth-loader").html('');
	...
	$("#bbps-dth-btn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/dthAuth',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#bbpsBroadbandPostpaidOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+19,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbpsLandlinePostpaidOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+2,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbpsWaterOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+7,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#water-loader").html('');
	...
	$("#bbpsGasOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+6,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#gas-loader").html('');
	...
	$("#bbpsLPGGasOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+11,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#lpg-gas-loader").html('');
	...
	$("#bbpsLoanOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+17,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#loan-loader").html('');
	...
	$("#bbpsInsuranceOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+5,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbpsEmiPaymentOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+10,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#emi-loader").html('');
	...
	$("#bbpsFastagOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+12,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#fastag-loader").html('');
	...
	$("#bbpsCableOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+9,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#cable-loader").html('');
	...
	$("#bbpsMunicipalTaxesOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+18,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbpsMunicipalServicesOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+13,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbpsSubscriptionOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+20,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbpsCreditCardOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+22,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbpsTravelOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+21,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#travel-loader").html('');
	...
	$("#bbpsClubOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/checkOperatorFetchOption/'+billerID+'/'+24,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#club-loader").html('');
	...
	$("#selDmtBenId").change(function(){
		...
		if(stateID){
			$.ajax({                
				url:siteUrl+'distributor/dmt/getBenData/'+stateID,                        
				success:function(r){
...
function fetchMobilePostpaidBill()
{
	...
	else
	{
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/bbps/fetchMobilePostpaidBill',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
...
function fetchElectricityBill()
{
    ...
    $.ajax({               
      type:'POST', 
      url:siteUrl+'distributor/bbps/fetchElectricityBill',
      data:str,
      success:function(r){
        var data = JSON.parse($.trim(r));
        if(data["status"] == 1){
...
function fetchDTHBill()
{
    ...
    $.ajax({               
      type:'POST', 
      url:siteUrl+'distributor/bbps/fetchDTHBill',
      data:str,
      success:function(r){
        var data = JSON.parse($.trim(r));
        if(data["status"] == 1){
...
function fetchMasterBill(service_id)
{
    ...
    $.ajax({               
      type:'POST', 
      url:siteUrl+'distributor/bbps/fetchMasterBill/'+service_id,
      data:str,
      success:function(r){
        var data = JSON.parse($.trim(r));
        if(data["status"] == 1){
...
function payMasterBill(service_id)
{
    ...
    $.ajax({               
      type:'POST', 
      url:siteUrl+'distributor/bbps/payMasterBillAuth/'+service_id,
      data:str,
      success:function(r){
        var data = JSON.parse($.trim(r));
        if(data["status"] == 1){
...
function updatedmrModel(id)
{
	var siteUrl = $("#siteUrl").val();
	$.ajax({                
		url:siteUrl+'distributor/master/getDMRCommData/'+id,                        
		success:function(r){
...
function updateaepsModel(id)
{
	var siteUrl = $("#siteUrl").val();
	$.ajax({                
		url:siteUrl+'distributor/master/getAEPSCommData/'+id,                        
		success:function(r){
...
function showComplainBox(id)
{
	var siteUrl = $("#siteUrl").val();
	$.ajax({                
		url:siteUrl+'distributor/recharge/getRechargeData/'+id,                        
		success:function(r){
...
function showBBPSComplainBox(id)
{
	var siteUrl = $("#siteUrl").val();
	$.ajax({                
		url:siteUrl+'distributor/recharge/getBBPSData/'+id,                        
		success:function(r){
...
function updateBenModel(id)
{
	var siteUrl = $("#siteUrl").val();
	$.ajax({                
		url:siteUrl+'distributor/transfer/getBenData/'+id,                        
		success:function(r){
...
function showAepsModal(id)
{
	var siteUrl = $("#siteUrl").val();
	$.ajax({                
		url:siteUrl+'distributor/aeps/getAepsData/'+id,                        
		success:function(r){
...
function dmtVerifyIfsc()
{
	...
	else
	{
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/dmt/verifyIfscCode/'+ifsc,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
...
$("#accountVerifyBtn").click(function(){
      ...
      var str = $("#account_verify_form").serialize();
        $.ajax({               
          type:'POST', 
          url:siteUrl+'distributor/bank/verifyAuth',                        
          data:str,
          success:function(r){
            var data = JSON.parse($.trim(r));
            if(data["status"] == 1){
...
$("#upiVerifyBtn").click(function(){
      ...
      var str = $("#upi_verify_form").serialize();
        $.ajax({               
          type:'POST', 
          url:siteUrl+'distributor/bank/upiVerifyAuth',                        
          data:str,
          success:function(r){
            var data = JSON.parse($.trim(r));
            if(data["status"] == 1){
    ...
    $("#selDmtBankID").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/dmt/getBankDefaultIfsc/'+billerID,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	function closeClubNoti(recordID = 0)
	{
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'distributor/saving/closeClubNotification/'+recordID,
	      success:function(r){
	...
	$("#to_bank").click(function(){
		...
		$(".recharge-comm-loader").html("<img src='"+siteUrl+"skin/images/loading2.gif' alt='loading' />");
		$.ajax({                
			url:siteUrl+'distributor/transfer/getBankBeneficiary',                        
			success:function(r){
	...
	$("#to_upi").click(function(){
		...
		$(".recharge-comm-loader").html("<img src='"+siteUrl+"skin/images/loading2.gif' alt='loading' />");
		$.ajax({                
			url:siteUrl+'distributor/transfer/getUpiBankBeneficiary',                        
			success:function(r){
	...
	$("#coupon").keyup(function(){
  	...
  	if(coupon){
			$.ajax({                
				url:siteUrl+'distributor/pancard/getCouponBalance/'+coupon,                        
				success:function(r){
	...
	function payCreditCardBill(service_id)
{
    ...
    $.ajax({               
      type:'POST', 
      url:siteUrl+'distributor/bbps/payCreditCardBillAuth/'+service_id,
      data:str,
      success:function(r){
        var data = JSON.parse($.trim(r));
        if(data["status"] == 1){
    ...
    $.ajax({               
      ...
      success:function(r){
        ...
        if(data["status"] == 1){
             ...
             setTimeout(function() {
                              window.location.replace(siteUrl+'distributor/bbps');
                            }, 10000);
        }
        else
        {
