        ...
        function CaptureMorpho() {
                ...
                var PIDOPTS = '<PidOptions ver=\"1.0\">' + '<Opts fCount=\"1\" fType=\"0\" iCount=\"\" iType=\"\" pCount=\"\" pType=\"\" format=\"0\" pidVer=\"2.0\" timeout=\"10000\"  env=\"P\" otp=\"\" wadh=\"\" posh=\"\"/>' + '</PidOptions>';
                /*
                format=\"0\"     --> XML
        ...
        function CaptureMorphoScan() {
                ...
                //debugger;
                var url = "http://127.0.0.1:11100/capture";
                var PIDOPTS = '<PidOptions ver=\"1.0\">' + '<Opts fCount=\"1\" fType=\"0\" iCount=\"\" iType=\"\" pCount=\"\" pType=\"\" format=\"0\" pidVer=\"2.0\" timeout=\"10000\" wadh=\"E0jzJ/P8UopUHAieZn8CKqS4WPMi5ZSYXgfnlfkWjrc=\"  env=\"P\" otp=\"\" posh=\"\"/>' + '</PidOptions>';
                /*
                format=\"0\"     --> XML
                format=\"1\"     --> Protobuf   env=\"P\"
                */
...
function CaptureKycAvdm() {
        //$('#Dv_Loader').show();
            ...
            discoverAvdm();
            //var XML = '<?xml version="1.0"?> <PidOptions ver="1.0"> <Opts fCount="1" fType="0" iCount="0" pCount="0" format="0"   pidVer="2.0" timeout="10000" posh="UNKNOWN" env="P" /> </PidOptions>';
            var XML = '<?xml version="1.0"?> <PidOptions ver="1.0"> <Opts fCount="1" fType="0" iCount="0" pCount="0" format="0" wadh="E0jzJ/P8UopUHAieZn8CKqS4WPMi5ZSYXgfnlfkWjrc="   pidVer="2.0" timeout="15000" posh="UNKNOWN" env="P" /> </PidOptions>';
            var verb = "CAPTURE";
            var err = "";
            var res;
            $.support.cors = true;
...
function CallKYCVerifyApi(BiometricData) {
    ...
    jQuery.ajax({
        type: "POST",
        url: siteUrl+"user/aeps/kycBioAuth",
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify(jsonData),
        dataType: "json",
        success: function (Result) {
            if(Result.status == 1)
            {
                ...
                window.location.href=siteUrl+"user/aeps";
