       ...
       <div class="about_more_Btn">
        ...
        <span class="bp-text">Get Started <i class="flaticon-030-arrow"></i></span></a> 
           ...
           <div class="col-lg-4">
             ...
             <a href="{site_url}services">       
             <div class="services_icons">
             <img src="{site_url}skin/front-payol/images/service_icon/Cost.png" class="img-fluid">    
             </div>
             <div class="services_colm_content">
             <h3>Bill Payment</h3>
             <p>Bill payment system is a mechanism or service that enables individuals or organizations to pay their bills electronically. </p>  
             </div> </a>
             </div>
             </div>
