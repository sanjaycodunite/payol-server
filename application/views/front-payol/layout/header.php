...
<head>
    ...
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/x-icon" href="{site_url}skin/front-payol/img/icon.jpg">



    
    <!-- PAGE TITLE HERE -->
    <title>A Complete Banking Solution - Payol</title>
    
    <!-- MOBILE SPECIFIC -->
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">   
    
    <!-- BOOTSTRAP STYLE SHEET -->
    <link  href="{site_url}skin/front-payol/css/bootstrap.min.css" rel="stylesheet">
    <!-- FONTAWESOME STYLE SHEET -->
    <link  href="{site_url}skin/front-payol/css/font-awesome.min.css" rel="stylesheet">
    <!-- Feather STYLE SHEET -->
    <link href="{site_url}skin/front-payol/css/feather.css" rel="stylesheet">
    <!-- FLATICON STYLE SHEET -->
    <link href="{site_url}skin/front-payol/css/flaticon.min.css" rel="stylesheet">
    <!-- WOW ANIMATE STYLE SHEET -->
    <link href="{site_url}skin/front-payol/css/animate.css" rel="stylesheet">
    <!-- OWL CAROUSEL STYLE SHEET -->
    <link href="{site_url}skin/front-payol/css/owl.carousel.min.css" rel="stylesheet">
    <!-- MAGNIFIC POPUP STYLE SHEET -->
    <link href="{site_url}skin/front-payol/css/magnific-popup.min.css" rel="stylesheet">
    <!-- DATE PICKER STYLE SHEET -->
    <link href="{site_url}skin/front-payol/css/date-picker.css" rel="stylesheet">     
    <!-- LC LIGHT BOX STYLE SHEET -->
    <link href="{site_url}skin/front-payol/css/lc_lightbox.css" rel="stylesheet">  
    <!-- MAIN STYLE SHEET -->
    <link href="{site_url}skin/front-payol/css/style.css" rel="stylesheet">
        ...
        <header class="site-header header-style-2 mobile-sider-drawer-menu">
            ...
            <div class="col-lg-6 col-md-6">
             ...
             <li><span><i class="flaticon-093-phone-call"></i></span>
                <a href="tel:<?php echo $contactDetail['mobile'] ?>" target="_blank">+91-<?php echo $contactDetail['mobile'] ?></a></li>    
                    ...
                    <div class="container clearfix"> 
                        ...
                        <div class="nav-animation header-nav navbar-collapse collapse d-flex justify-content-end">
                            ...
                            <ul class=" nav navbar-nav">
                                ...
                                <li><a href="{site_url}our-partner">Become A Partner</a></li>
