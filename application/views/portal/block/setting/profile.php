...
<div class="card shadow ">
            ...
            <div class="card-body">
            <?php echo form_open_multipart('portal/setting/profileAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
              ...
              <div class="col-sm-3">
                <div class="form-group">
              <label><b>PMR Token</b></label>
              <input type="text" class="form-control" name="pmr_token" value="<?php echo $userData['pmr_token']; ?>" id="pmr_token" placeholder="PMR Token">
              <?php echo form_error('pmr_token', '<div class="error">', '</div>'); ?>  
              </div>
              </div>
