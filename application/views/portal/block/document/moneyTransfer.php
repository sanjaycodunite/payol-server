...
&#60;/response&#62;
                    ...
                    <div class="tab-pane fade show active" id="checkStatus" role="tabpanel" aria-labelledby="checkStatus-tab">
                      
                      <div class="col-sm-12">
                        <br />
                        <h1>Request API URL</h1>
                        <p style="font-size: 18px; font-weight: bold;">{site_url}portal/api/payoutCheckStatus</p>
                        <hr />
                        <p><b>Request Method - POST</b></p>
                      </div>
                      <div class="col-sm-12">
