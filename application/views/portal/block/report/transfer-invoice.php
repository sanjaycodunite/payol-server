    ...
    <tr>
      ...
      <tr>
        ...
        <td colspan="2">
          ...
          <h4><?php echo $rechargeData['ben_account_holder_name']; ?></h4>
          <h4><?php echo $rechargeData['ben_account_no']; ?></h4>
          <h4><?php echo $rechargeData['ben_bank_name']; ?> (<?php echo $rechargeData['ben_ifsc']; ?>)</h4>
          
          <h4><?php echo ($rechargeData['transaction_id']) ? $rechargeData['transaction_id'] : '&nbsp;'; ?></h4>
          <h4><?php echo ($rechargeData['rrn']) ? $rechargeData['rrn'] : '&nbsp;'; ?></h4>
          ...
          <?php } ?>
          <?php
          if($rechargeData['status']==4){
           ?>
          <h4>Failed</h4>
          <?php } ?>
          <h4>Rs: <?php echo number_format($rechargeData['transfer_amount'],2); ?></h4>
      ...
      <th colspan="2" style="text-align: left;">Rs. <?php echo number_format($rechargeData['transfer_amount'],2); ?></th>
      </tr>
    </thead>
