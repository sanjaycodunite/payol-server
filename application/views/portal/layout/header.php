...
<head>
  ...
  <?php
   if(isset($get_theme['theme_id']) && $get_theme['theme_id'] == 1){ 
  ?>

  <link href="{site_url}skin/admin/css/dark-black.css" rel="stylesheet">

  <?php } elseif(isset($get_theme['theme_id']) && $get_theme['theme_id'] == 2){ ?>

  <link href="{site_url}skin/admin/css/dark-blue.css" rel="stylesheet">
  
  <?php } elseif(isset($get_theme['theme_id']) && $get_theme['theme_id'] == 3){ ?>

  <link href="{site_url}skin/admin/css/dark-red.css" rel="stylesheet">

  <?php } elseif(isset($get_theme['theme_id']) && $get_theme['theme_id'] == 4){ ?>

  <link href="{site_url}skin/admin/css/gray.css" rel="stylesheet">

  <?php } elseif(isset($get_theme['theme_id']) && $get_theme['theme_id'] == 5){ ?>

  <link href="{site_url}skin/admin/css/red.css" rel="stylesheet">

  <?php } elseif(isset($get_theme['theme_id']) && $get_theme['theme_id'] == 6){ ?>
