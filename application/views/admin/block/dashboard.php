        ...
        <div class="container-fluid">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a
                                            href="{site_url}admin/member/mdMemberList">Total Master Distributor</a>
                                    </div>
                    ...
                    <div class="card border-left-info shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a
                                            href="{site_url}admin/member/distributorList">Total Distributor</a></div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1"><a
                                            href="{site_url}admin/member/retailerList">Total Retailer</a></div>
                    ...
                    <div class="card border-left-warning blw2 shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1"><a
                                            href="{site_url}admin/member/apiMemberList">Total User</a></div>
                    ...
                    <div class="card border-left-warning blw2 shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1"><a
                                            href="{site_url}admin/member/apiMemberList">Total API Member</a></div>
                    ...
                    <div class="card border-left-warning blw2 shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1"><a
                                            href="{site_url}admin/employe/employeList">Total Employe</a></div>
            ...
            <div class="card_tab_header">
                <div class="card_tabs_list nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="nav-balance-tab" data-toggle="tab" data-target="#nav-balance"
                        type="button" role="tab" aria-controls="nav-balance" aria-selected="true">Balance
                        Summary</button>
                    <button class="nav-link" id="nav-commission-tab" data-toggle="tab" data-target="#nav-commission"
                        type="button" role="tab" aria-controls="nav-commission" aria-selected="false">Commission
                        Summary</button>
                    <button class="nav-link" id="nav-api-tab" data-toggle="tab" data-target="#nav-api" type="button"
                        role="tab" aria-controls="nav-api" aria-selected="false">API Summary</button>
                </div>
            </div>
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-balance" role="tabpanel"
                                    ...
                                    <table class="table table-bordered table-striped" id="example1" width="100%"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>₹
                                                    <?php echo number_format($master_distributor_total_wallet_balance, 2); ?>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td>Distributor</td>
                                                <td>₹ <?php echo number_format($distributor_total_wallet_balance, 2); ?>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td>Retailer</td>
                                                <td>₹ <?php echo number_format($retailer_total_wallet_balance, 2); ?>
                                                </td>
                                            </tr>
                                            <?php if ($accountData['is_disable_api_role'] == 0) { ?>
                                            <tr>
                                                <td>API User</td>
                                                <td>₹ <?php echo number_format($api_user_total_wallet_balance, 2); ?>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                            <?php if ($accountData['is_disable_user_role'] == 0) { ?>
                                    ...
                                    <table class="table table-bordered table-striped" id="example" width="100%"
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td><b>Total</b></td>
                                                <td><b>₹
                                                        <?php echo number_format($total_distribute_commision, 2); ?></b>
                                                </td>
                                            </tr>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered table-striped" id="dashboardApiDataTable"
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="totalSuccessBlock">
                                                &#8377; 0.00 / 0</div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="totalPendingBlock">
                                                &#8377; 0.00 / 0</div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="totalFailedBlock">
                                                &#8377; 0.00 / 0</div>
                                        </div>
                            ...
                            <div class="Dispute-b card border-left-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a
                                                    href="#">Total Dispute</a></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="totalDisputeBlock">
                                                &#8377; 0.00 / 0</div>
                                        </div>
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a
                                                    href="#">Total Success</a></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"
                                                id="totalMoneySuccessBlock">&#8377; 0.00 / 0</div>
                                        </div>
                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a
                                                    href="#">Total Pending</a></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"
                                                id="totalMoneyPendingBlock">&#8377; 0.00 / 0</div>
                                        </div>
                            ...
                            <div class="card border-left-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a
                                                    href="#">Total Failed</a></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"
                                                id="totalMoneyFailedBlock">&#8377; 0.00 / 0</div>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a
                                                    href="#">Total Dispute</a></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"
                                                id="totalMoneyDisputeBlock">&#8377; 0.00 / 0</div>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a
                                                    href="#">Total Success</a></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"
                                                id="totalAepsSuccessBlock">&#8377; 0.00 / 0</div>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a
                                                    href="#">Total Failed</a></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"
                                                id="totalAepsFailedBlock">&#8377; 0.00 / 0</div>
                                        </div>
