<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <div class="row">
                <div class="col-sm-3">
                <h4><b>Collection Wallet History</b></h4>
                </div>
                ...
                <div class="col-sm-3">
                <button type="button" class="btn btn-success" id="eWalletSearchBtn">Search</button>
                <a href="{site_url}admin/ewallet/addWallet" class="btn btn-primary">+Add Wallet</a>
                </div>
               </div>  
              <?php echo form_close(); ?>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="eWalletDataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>MemberID</th>
