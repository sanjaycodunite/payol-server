...
<div class="card shadow ">
            ...
            <?php echo form_open_multipart('admin/member/updateMember', array('id' => 'admin_profile'),array('method'=>'post')); ?>
              ...
              <?php echo form_error('min_wallet_balance', '<div class="error">', '</div>'); ?>  
               ...
               <div class="col-sm-3">
                <div class="form-group">
              <label><b>Minimum UPI Wallet</b></label>
              <input type="text" class="form-control" name="min_upi_wallet_balance" id="min_upi_wallet_balance" value="<?php echo $memberList['min_upi_wallet_balance']; ?>" placeholder="Minimum UPI Wallet">
              <?php echo form_error('min_upi_wallet_balance', '<div class="error">', '</div>'); ?>  
              </div>
              </div>
               ...
               <div class="col-sm-3">
                <div class="form-group">
              <label><b>UPI Lean Amount(%)</b></label>
              <input type="text" class="form-control" name="upi_lean_amount" id="upi_lean_amount" value="<?php echo $memberList['upi_lean_amount']; ?>" placeholder="Minimum Wallet">
              <?php echo form_error('upi_lean_amount', '<div class="error">', '</div>'); ?>  
              </div>
              </div>
                ...
                <div class="col-sm-3">
                <div class="form-group">
              <label><b>Chargeback Charge(%)</b></label>
              <input type="text" class="form-control" name="chargeback_charge" id="chargeback_charge" value="<?php echo $memberList['chargeback_charge']; ?>" placeholder="Chargeback Charge">
              <?php echo form_error('chargeback_charge', '<div class="error">', '</div>'); ?>  
              </div>
              </div>
