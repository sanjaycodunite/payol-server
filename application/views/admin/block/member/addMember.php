...
<div class="card shadow ">
            ...
            <?php echo form_open_multipart('admin/member/saveMember', array('id' => 'admin_profile'),array('method'=>'post')); ?>
             ...
             <!--  <div class="col-sm-3">
              ...
              <input type="text" class="form-control" name="min_upi_wallet_balance" id="min_wallet_balance" value="0" placeholder="Minimum UPI Wallet">
              ...
              <input type="text" class="form-control" name="upi_lean_amount" id="upi_lean_amount" value="0" placeholder="UPI Lean Amount(%)">
              ...
              <input type="text" class="form-control" name="chargeback_charge" id="chargeback_charge" value="0" placeholder="Chargeback Charge(%)">
