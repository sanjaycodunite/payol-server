<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <div class="row">
                ...
                <a href="{site_url}admin/society" class="btn btn-secondary">Back</a>
                </div>
               </div>  
              <?php echo form_close(); ?>
            </div>
                        ...
                        <?php if($requestList){ ?>
                          <?php $i = 1; foreach($requestList as $list){ ?>
                            <tr>
                              ...
                              <td>
                                <?php if($list['status'] == 1){ ?>
                                <a href="{site_url}admin/society/requestAuth/<?php echo $list['id']; ?>/<?php echo $list['club_id']; ?>/1" class="btn btn-success btn-sm" onclick="return confirm('Are you sure want to approve this request?')"><i class="fa fa-check"></i></a>
                                <a href="{site_url}admin/society/requestAuth/<?php echo $list['id']; ?>/<?php echo $list['club_id']; ?>/2" class="btn btn-primary btn-sm" onclick="return confirm('Are you sure want to decline this request?')"><i class="fa fa-times"></i></a>
                                <?php } ?>
                                <a href="{site_url}admin/society/requestAuth/<?php echo $list['id']; ?>/<?php echo $list['club_id']; ?>/3" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure want to delete?')"><i class="fa fa-trash"></i></a></td>
                            </tr>
                          <?php $i++; } ?>
                        <?php } else { ?>
                          <tr>
                            ...
                            <tr>
                              ...
                              <td>&#8377; <?php echo $list['win_amount']; ?>
                                ...
                                <?php } elseif($list['winner_member_id'] != 1) { ?>
                                  <a href="{site_url}admin/society/payWinAmountAuth/<?php echo $list['id']; ?>/{id}" onclick="return confirm('Are you sure you want to pay?')">Pay Now</a>
                                <?php } ?>
                              </td>
                              <td>
                                <?php if($list['status'] == 1){ ?>
                                <a href="{site_url}admin/society/editClubRound/<?php echo $list['id']; ?>/<?php echo $list['club_id']; ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
