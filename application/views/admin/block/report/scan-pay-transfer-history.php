...
<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <div class="row">
                ...
                <a href="{site_url}admin/report/scanPayTransferHistory" class="btn btn-secondary">View All</a>
...
<div id="updateComplainModel" class="modal fade" role="dialog">
  ...
  <div class="modal-content">
    <?php echo form_open_multipart('admin/report/successScanPay',array('method'=>'post')); ?>
