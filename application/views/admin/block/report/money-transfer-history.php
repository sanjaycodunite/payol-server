        ...
        <div class="card-header py-3">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 mt-3 text-center">
                    ...
                    <a href="{site_url}admin/report/moneyTransferHistory" class="btn btn-secondary">View All</a>
...
<div id="updateComplainModel" class="modal fade" role="dialog">
    <div class="modal-dialog assign-modal">
        ...
        <div class="modal-content">
            <?php echo form_open_multipart('admin/report/successMoneyTransfer',array('method'=>'post')); ?>
