        ...
        <div class="card-header py-3">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 py-2">
                    ...
                    <a href="{site_url}admin/report/settlementMoneyTransferHistory" class="btn btn-secondary">View
                        All</a>
                </div>
            </div>
            <?php echo form_close(); ?>
...
<div id="updateComplainModel" class="modal fade" role="dialog">
    <div class="modal-dialog assign-modal">
        ...
        <div class="modal-content">
            <?php echo form_open_multipart('admin/report/successSettlementMoneyTransfer',array('method'=>'post')); ?>
