...
<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <select class="form-control" name="user" id="user">
               ...
               <div class="col-sm-3">
                ...
                <button type="button" class="btn btn-success" id="addFundSearchBtn">Search</button>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="addFundDataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>MemberID</th>
