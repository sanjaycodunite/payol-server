        ...
        <?php echo form_open('',array('id'=>'leadFilterForm')); ?>
          <div class="row">
            ...
            <div class="col-sm-3 text-center">
                <button type="button" class="btn btn-success btn-sm text-center" id="findPanSearchBtn">Search</button>
                <a href="{site_url}admin/report/findPanReport" class="btn btn-secondary btn-sm text-center">View All</a>
            </div>
        </div>
        <?php echo form_close(); ?>
    </div>
