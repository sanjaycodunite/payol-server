                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="#">Total
                                    Success</a></div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="totalSuccessIciciBlock">&#8377; 0.00
                                / 0</div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="#">Total
                                    Pending</a></div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="totalPendingIciciBlock">&#8377; 0.00
                                / 0</div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="#">Total
                                    Failed</a></div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="totalFailedIciciBlock">&#8377; 0.00
                                / 0</div>
                        </div>
            ...
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="#">Total
                                    Success Charge</a></div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="totalSuccessChargeBlock">&#8377;
                                0.00</div>
                        </div>
    ...
    <div class="card shadow mb-4">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <select class="form-control" id="type">
                        <option value="0">Txn Type</option>
                        <option value="IMPS" <?php if($status == 'IMPS'){ ?> selected="selected" <?php } ?>>Bank
                            Transfer
                        </option>
                        <option value="UPI" <?php if($status == 'UPI'){ ?> selected="selected" <?php } ?>>UPI Transfer
                        </option>
                    </select>
                </div>
                ...
                <div class="col-sm-3 py-3">
                    <button type="button" class="btn btn-success" id="openMoneyTransferHistorySearchBtn">Search</button>
                    <a href="{site_url}admin/report/openMoneyTransferHistory" class="btn btn-secondary">View All</a>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="openMoneyTransferHistoryDataTable" width="100%"
                    cellspacing="0">
                    <thead>
                        <tr>
                            <th>#</th>
...
<div id="updateComplainModel" class="modal fade" role="dialog">
    <div class="modal-dialog assign-modal">
        ...
        <div class="modal-content">
            <?php echo form_open_multipart('#',array('method'=>'post','id'=>'openMoneySuccessForm')); ?>
                ...
                <div class="modalform">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <button type="button" onclick="openPayoutSuccessBtn()" class="btn btn-primary">Submit</button>
                            </div>
                        </div>
