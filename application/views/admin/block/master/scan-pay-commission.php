<div class="card shadow mb-4">
              {system_message}               
              {system_info}
              <?php echo form_open_multipart('admin/master/saveScanPayCommission', array('id' => 'admin_profile'),array('method'=>'post')); ?>
...
<div id="updateDMRModel" class="modal fade" role="dialog">
  ...
  <div class="modal-content">
    <?php echo form_open_multipart('admin/master/updateScanPayCom',array('method'=>'post')); ?>
