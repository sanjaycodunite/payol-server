<div class="card shadow mb-4">
              {system_message}               
              {system_info}
              <?php echo form_open_multipart('admin/master/saveNewMoneyTransferCharge', array('id' => 'admin_profile'),array('method'=>'post')); ?>
...
<div id="updateDMRModel" class="modal fade" role="dialog">
  ...
  <div class="modal-content">
    <?php echo form_open_multipart('admin/master/updateNewMoneyTransferCharge',array('method'=>'post')); ?>
