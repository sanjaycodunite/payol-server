<div class="card shadow mb-4">
              {system_message}               
              {system_info}
              <?php echo form_open_multipart('admin/master/saveAddFundCommission', array('id' => 'admin_profile'),array('method'=>'post')); ?>
            <div class="card-header py-3">
              <div class="row">
                <div class="col-sm-8">
                <h4><b>Add Fund Commission</b></h4>
                </div>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-2">
                <button type="button" id="addFundComSearchBtn" class="btn btn-success">Search</button>
                </div>
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <div style="margin-top: 10px;">
                      ...
                      <input type="checkbox" name="is_rt" id="is_rt" value="1">
...
<div id="updateDMRModel" class="modal fade" role="dialog">
  ...
  <div class="modal-content">
    <?php echo form_open_multipart('admin/master/updateAddFundCom',array('method'=>'post')); ?>
