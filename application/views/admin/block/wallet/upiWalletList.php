...
<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <div class="row">
                ...
                <div class="col-sm-3">
                <button type="button" class="btn btn-success" id="upiWalletHistorySearchBtn">Search</button>
                 <a href="{site_url}admin/wallet/addUpiWallet" class="btn btn-primary">+Add Wallet</a>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="upiWalletHistoryDataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>MemberID</th>
