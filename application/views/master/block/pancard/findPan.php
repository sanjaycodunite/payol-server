...
<div class="card shadow ">
            ...
            <div class="card-header py-3">
              <div class="row">
                ...
                <h4><b>Find PAN</b></h4>
                 ...
                 <div class="col-sm-6">
                <h4><b>Find Pan Charge - <?php echo $com_amount = $this->User->get_find_pan_charge($loggedUser['id']);?></b></h4>
                </div>
            ...
            <div class="card-body">
            <?php echo form_open_multipart('master/pancard/findPanAuth', array('id' => 'pancard_active'),array('method'=>'post')); ?>
