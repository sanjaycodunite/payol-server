...
<div class="card shadow ">
            ...
            <div class="card-body">
            <?php echo form_open_multipart('master/pancard/purchaseCouponAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
...
<div class="card shadow ">
            ...
            <?php echo form_open_multipart('master/pancard/pancardActiveAuth', array('id' => 'pancard_active'),array('method'=>'post')); ?>
            <?php } ?>
              <input type="hidden" value="<?php echo $site_url;?>" id="siteUrl">
