                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="card text-center">
                                ...
                                <div class="card-body">
                                    <a href="{site_url}master/settlement/openPayout" class="btn btn-primary btn-sm text-center">Money Transfer 1</a>
                                    <a href="{site_url}master/settlement/openPayout" class="btn btn-primary btn-sm text-center">Money Transfer 2</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="card text-center">
                                ...
                                <div class="card-body">
                                    <a href="{site_url}/master/settlement"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="card text-center">
                                ...
                                <div class="card-body">
                                    <a href="{site_url}master/report/iciciAepsKyc"
                                        class="btn btn-primary btn-sm text-center">ICICI AEPS Kyc
                                    </a>
                                    <a href="{site_url}master/report/aepsKyc"
            ...
            <div class="master_list_card">
                <div class="master_card_body">
                    <div class="master_list_col">
                        <a href="{site_url}master/report/addFundReport">
                    ...
                    <div class="master_list_col">
                        <a href="{site+url}master/wallet/payolTransfer">
                    ...
                    <div class="master_list_col">
                        <a href="{site_url}master/pancard/findPanList">
                    ...
                    <div class="master_list_col moneyTransferdiv">
                        <a href="{site_url}master/transfer/openPayout">
                    ...
                    <div class="master_list_col settlementMoneyTransferdiv">
                        <a href="{site_url}master/transfer/settlement">
                    ...
                    <div class="master_list_col">
                        <a href="{site_url}master/recharge/mobileprepaid">
                    ...
                    <div class="master_list_col">
                        <a href="{site_url}master/recharge/dth">
                    ...
                    <div class="master_list_col">
                        <a href="{site_url}master/newaeps/cashDeposite">
                    ...
                    <div class="master_list_col">
                        <a href="{site_url}master/pancard/utiBalanceRequest">
