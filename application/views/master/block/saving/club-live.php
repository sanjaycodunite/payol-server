...
<div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row">
                ...
                <div class="col-sm-6 text-right">
                  <?php if($totalAmount){ ?>
                <a href="{site_url}master/saving/clearDuePayment/{club_id}/{requestID}" onclick="return confirm('Are you sure you want to clear due payment for this club?')"><button type="button" class="btn btn-danger">Pay <i class="fa fa-rupee-sign"></i> {totalAmount}</button></a>
                <?php } ?>
                <a href="{site_url}master/saving/clubList"><button type="button" class="btn btn-primary">Back</button></a>
                </div>
          ...
          <?php if($clubData['status'] == 2){ ?>
           ...
           <div class="bid_Section">
            ...
            <a href="{site_url}master/saving/clubChatLiveAuth/{club_id}/{requestID}"><i class="fa fa-comment"></i>Club Chat</a>
             </div> 
            </div>
          <?php } else { ?>
            <div class="col-lg-12 col-md-12">
           <div class="bid_Section">
            ...
            <a class="blink_me" href="{site_url}master/saving/clubChatLiveAuth/{club_id}/{requestID}"><i class="fa fa-comment"></i>View Live Bidding</a>
             </div> 
            </div>  
          <?php } else { ?>
            <div class="m-auto col-lg-8 col-md-12">
