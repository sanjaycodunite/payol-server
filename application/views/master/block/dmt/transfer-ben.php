...
<div class="card shadow ">
           ...
           <div class="row">
            <div class="col-lg-6 col-md-6">
              <div class="beneficiary_form_section">
                <?php echo form_open_multipart('master/dmt/beneficiaryAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
              ...
              <div class="col-lg-12">
                <p style="color:red;">Note : Account verify will be chargeable, please <a href="{site_url}master/master/myAccountVerifyCharge">click here</a> to check your account verify charge.</p>
              </div>
               <div class="col-lg-12">
              <div class="form-group">
          ...
          <div class="col-lg-12 col-md-12">
              <div class="beneficiary_form_section">
                <?php echo form_open_multipart('master/dmt/updateDetailAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
              <input type="hidden" value="<?php echo $site_url;?>" id="siteUrl">
              <input type="hidden" value="<?php echo $mobile;?>" name="accountMobile">
              <div class="row">
              <div class="col-lg-12">
            ...
            <div class="col-lg-6 col-md-6">
              ...
              <div class="beneficiary_right_history_section d-flex">
               ...
               <div class="beneficiary_colms-details_btns">
                 <a href="<?php echo base_url('master/dmt/moneyTransfer').'/'.$list['beneId']; ?>"><button class="btn-transfer" type="button">Transfer</button></a>
                 <a href="<?php echo base_url('master/dmt/deleteBen').'/'.$list['beneId'].'/'.$mobile; ?>" onclick="return confirm('Are you sure want to delete?')"><button class="btn btn-danger" style="padding: 13px 30px;" type="button">Delete</button></a>
               </div>
              </div>
              <?php } ?>
              <?php } else { ?>
