...
<img alt="Bank Transfer" src="{site_url}skin/front/img/bank.png">
 ...
 <button class="btn btn-primary btn-sm mt-2" type="button" id="settlement_add_bank_account">Add Bank Account</button>
...
<button class="btn btn-primary btn-sm mt-2" type="button" id="settlement_add_upi_account">Add UPI Account</button>  
</li>
</ul> 
</div>  
</div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12" style="display: none;" id="show_settlement_bank_account">
    <div class="alert alert-warning alert-dismissable">You Can Add Only 5 Beneficiary Account.</div>

    <?php 
      $check_beneficiary = $this->db->get_where('open_money_payout_user_benificary',array('account_id'=>$account_id,'user_id'=>$loggedAccountID))->num_rows();
    ...
    <div class="card">
      ...
      <?php echo form_open_multipart('master/settlement/saveBenificaryBankAccount', array('id' => 'account_verify_form'),array('method'=>'post')); ?>
      <input type="hidden" name="type" value="1">
      <input type="hidden" name="account_ben_id" id="account_ben_id">
      <div class="card-body">
      ...
      <div class="card-footer">
        <button type="button" id="settlementAccountVerifyBtn" class="btn btn-success" name="verify" value="verify">Verify & Add</button>
  ...
  <div class="col-sm-12" style="display: none;" id="show_settlement_upi_account">
    ...
    <div class="card">
      ...
      <?php echo form_open_multipart('master/settlement/saveBenificaryBankAccount', array('id' => 'upi_verify_form'),array('method'=>'post')); ?>
      <input type="hidden" name="type" value="2">
      <input type="hidden" name="upi_ben_id" id="upi_ben_id">
      <div class="card-body">
...
<div id="updateDMRModel" class="modal fade" role="dialog">
  ...
  <!-- Modal content-->
  <div class="modal-content">
    <?php echo form_open_multipart('master/transfer/updateBenificaryAuth',array('method'=>'post')); ?>
