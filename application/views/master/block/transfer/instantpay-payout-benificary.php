 <div class="row">
  ...
  <div class="col-sm-12">
    ...
    <div class="card">
      ...
      <?php echo form_open_multipart('master/transfer/newPayoutBenificaryAuth', array('id' => 'account_verify_form'),array('method'=>'post')); ?>
      <div class="card-body">
          ...
          <table class="table table-bordered" id="example">
            ...
            <tr>
              ...
              <td class="align-middle">
                <a href="{site_url}master/transfer/newPayoutFundTransfer/<?php echo $list['id']; ?>"><button class="btn btn-primary" type="button">Transfer</button></a>
              </td>
              </tr>
            <?php $i++; }}else{  ?>  
            <tr>
