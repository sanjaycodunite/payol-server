        ...
        <li class="nav-item">
            ...
            <div id="collapse88"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{site_url}master/transfer/benificaryAccountList"> New Account
                        Request</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseInstant"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{site_url}master/iciciaeps/transactionHistory">Transaction
                        History</a>
                    <?php } ?>
                </div>
            </div>
      ...
      <?php  } } ?> -->
        ...
        <li class="nav-item">
            ...
            <div id="collapse16"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{site_url}master/fingpayAeps/transactionHistory">Transaction
                        History</a>
                    <?php } ?>
                </div>
            </div>
        ...
        <li class="nav-item">
            ...
            <a class="collapse-item" href="{site_url}retailer/transfer/fundTransfer">Transfer Now</a>-->
                    ...
                    <a class="collapse-item" href="{site_url}master/settlement/settlementTransferReport">Transfer
                        Report</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapse10"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{site_url}master/report/moneyTransferHistory">money Transfer
                        Report</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapse13"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{site_url}master/setting/changeTranscationPassword">Change
