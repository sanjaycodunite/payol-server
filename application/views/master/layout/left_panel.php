  ...
  <div id="wrapper">
    ...
    <li class="nav-item">
        ...
        <div id="collapseinst" <?php if($content_block == 'transfer/newPayoutlist' || $content_block == 'transfer/transfer') { ?> class="collapse show" <?php } else { ?> class="collapse"<?php } ?> aria-labelledby="heading5" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{site_url}master/transfer/settlement">Settlement </a>
              ...
              <a class="collapse-item" href="{site_url}master/transfer/newPayoutReport">Settlement Report</a>
            </div>
        </div>
      </li>
      <?php   } ?>
      ...
      <li class="nav-item">
        ...
        <div id="collapsesettlement" <?php if($content_block == 'settlement/newPayoutlist' || $content_block == 'settlement/transfer') { ?> class="collapse show" <?php } else { ?> class="collapse"<?php } ?> aria-labelledby="heading5" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Settlement:</h6>
              
               <a class="collapse-item" href="{site_url}master/settlement">Settlement </a>

               <a class="collapse-item" href="{site_url}master/settlement/addBankAccount">Add Account</a>

              <a class="collapse-item" href="{site_url}master/settlement/newPayoutReport">Settlement Report</a>
    ...
    <li class="nav-item">
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">AEPS3 Service:</h6>
             <?php if(!$user_aeps3_status){ ?>
              ...
              <a class="collapse-item" href="{site_url}master/fingpayAeps/transactionHistory">Transaction History</a>
            <?php } ?>
          </div>
        </div>
      </li> 
      ...
      <hr class="sidebar-divider my-0">
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseMoney2" aria-expanded="true" aria-controls="collapseMoney2">
          <i class="fa fa-mobile"></i>
        ...
        <div id="collapseMoney2" class="collapse" aria-labelledby="heading5" data-parent="#accordionSidebar">
          ...
          <!--  <a class="collapse-item" href="{site_url}retailer/transfer/beneficiaryList">Beneficiary List</a>
            ...
            <a class="collapse-item" href="{site_url}master/settlement/openPayout">Money Transfer</a>
              <a class="collapse-item" href="{site_url}master/settlement/settlementTransferReport">Transfer Report</a>
            </div>
        </div>
      </li>
      <?php } ?>
