            ...
            <div id="collapse5"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item <?php if($content_block == 'recharge/mobile-prepaid'){ ?> active <?php } ?> "
                        href="{site_url}user/recharge/mobileprepaid">Mobile</a>

                    <a class="collapse-item <?php if($content_block == 'recharge/dth'){ ?> active <?php } ?> "
                        href="{site_url}user/recharge/dth">DTH</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapse88"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{site_url}user/transfer/benificaryAccountList"> New Account
                        Request</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapse111"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{site_url}user/master/myMoneyTransferCommision">Money Trans.
                        Commission</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapse8"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <?php if(in_array(5, $activeService)){
                         ?>
                    <a class="collapse-item" href="{site_url}user/wallet/dynamicQr">Add Fund</a>
                    <?php } ?>
         ...
         ?>
            ...
            <div class="container-fluid">
                ...
                <div class="alert alert-success alert-dismissable"><?php echo $nlist['msg']; ?> <a
                        href="{site_url}user/saving/clubList">Accept</a></div>
                <?php } else { ?>
