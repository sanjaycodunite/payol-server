<div class="card shadow mb-4">
              {system_message}               
              {system_info}
              <?php echo form_open_multipart('user/master/saveAEPSCommission', array('id' => 'admin_profile'),array('method'=>'post')); ?>
                ...
                <table class="table table-bordered table-striped"  width="100%" cellspacing="0">
                  ...
                  <tbody>
                   ...
                   <tr>
                    ...
                    <td><?php echo $list['user_commision']; ?></td>
                    <td>
                      <?php 
                        if($list['com_type'] == 1){
                          echo 'Account Withdrawal';
                        }
