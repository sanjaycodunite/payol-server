 ...
 <div class="login_section_mt">
  ...
  <div class="login_colm-frm help_u_forms">
    ...
    <?php echo form_open('forgot/transcationPasswordAuth'); ?>
  ...
  <h3>Update Transcation Password</h3> 
  </div>  
      <div class="form-group">
                      <input class="form-control" type="password" name="new_password" id="new_password" placeholder="New Transcation Password" maxlength="4">
                      <?php echo form_error('new_password', '<div class="error">', '</div>'); ?>  
                    </div>
                    <div class="form-group forget-block">
                      <input class="form-control" type="password" name="confirm_password" id="confirm_password" placeholder="Confirm Transcation Password" maxlength="4">
