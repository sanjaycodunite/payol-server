 <div class="row">
  ...
  <div class="col-sm-12">
    <div class="alert alert-warning alert-dismissable">You Can Add Only Three Beneficiary Account.</div>
    ...
    <div class="card">
      ...
      <?php echo form_open_multipart('retailer/transfer/newPayoutBenificaryAuth', array('id' => 'account_verify_form'),array('method'=>'post')); ?>
      <div class="card-body">
          ...
          <table class="table table-bordered" id="example">
            ...
            <tr>
              ...
              <td class="align-middle">
                <a href="{site_url}retailer/transfer/newPayoutFundTransfer/<?php echo $list['id']; ?>"><button class="btn btn-primary" type="button">Transfer</button></a>
                <a href="{site_url}retailer/transfer/deleteBeneficiaryAccount/<?php echo $list['id']; ?>"><button class="btn btn-danger" type="button">Delete</button></a>
              </td>
              </tr>
            <?php $i++; }}else{  ?>  
            <tr>
