...
<button class="btn btn-primary btn-sm mt-2" type="button" id="add_upi_account">Add UPI Account</button>  
    ...
    <div class="card">
      ...
      <?php echo form_open_multipart('retailer/transfer/saveBenificaryBankAccount', array('id' => 'account_verify_form'),array('method'=>'post')); ?>
  ...
  <div class="col-sm-12" style="display: none;" id="show_upi_account">
    ...
    <div class="card">
      ...
      <?php echo form_open_multipart('retailer/transfer/saveBenificaryBankAccount', array('id' => 'upi_verify_form'),array('method'=>'post')); ?>
