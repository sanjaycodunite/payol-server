...
<div class="card shadow ">
            ...
            <div class="card-body">
            <?php echo form_open_multipart('retailer/transfer/senderOtpAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
            ...
            <div class="row">
              ...
              <br />
              <a href="{site_url}retailer/transfer/resendSenderOtp/{encodeTxnId}">Resend OTP</a>
              </div>
              </div>
