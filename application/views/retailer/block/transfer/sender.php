 <div class="row">
  ...
  <div class="col-sm-12">
    ...
    <div class="card">
      ...
      <?php echo form_open_multipart('retailer/transfer/senderAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-bordered" id="example">
            ...
            <tr>
              ...
              <td class="align-middle"><?php echo ($list['status'] == 1) ? '<font color="green">Active</font>' : '<font color="red">Deactive</font><br /><a href="{site_url}retailer/transfer/activeSender/'.$list['encodeTxnId'].'">Active Sender</a>' ; ?></td>
              <td class="align-middle"><?php echo date('d-m-Y H:i:s',strtotime($list['created'])); ?></td>
              <td class="align-middle">
                <a href="{site_url}retailer/transfer/fundTransfer/0/<?php echo $list['id']; ?>"><button class="btn btn-primary" type="button">Transfer</button></a>
              </td>
              </tr>
            <?php $i++; }}else{  ?>  
            <tr>
