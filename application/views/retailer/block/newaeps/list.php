...
<div class="card shadow ">
            <div class="card-header py-3">
              <div class="row">
                ...
                <div class="col-sm-6  text-right">
                   ...
                   <a href="{site_url}retailer/iciciaeps/activeAeps" class="btn btn-dark">ICICI AEPS</a>
                 <?php } else {?>
                   <a href="{site_url}retailer/iciciaeps/index" class="btn btn-dark">ICICI AEPS</a>
                 <?php } ?>
                 <?php } ?>
            ...
            <div class="row">
              ...
              <input type="text" class="form-control" name="aadhar_no" id="aadhar_no" placeholder="Aadhar No" maxlength="12">
