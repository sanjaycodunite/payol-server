...
<div class="card-body">
<h5 class="card-title">Settlement 2</h5>
...
<img alt="Bank Transfer" src="{site_url}skin/front/img/bank.png">
 ...
 <button class="btn btn-primary btn-sm mt-2" type="button" id="settlement_to_bank">Transfer To Bank</button>
...
<button class="btn btn-primary btn-sm mt-2" type="button" id="settlement_to_upi">Transfer To UPI</button>  
</li>
</ul> 
</div>  
</div>
