                ...
                <form id="fingpayAeps_aeps3_form" enctype="multipart/form-data" name="aeps3_form">
                    <div class="card-body">
                        ...
                        <div class="row" id="aeps3FormDiv">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label><b>Pancard No.*</b></label> <input type="text"
                                        class="form-control only-alphabet-number-allowed" name="pancard_no"
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label><b>Street/Locality*</b></label> <input type="text"
                                        ...
                                        value="<?php echo set_value('street_locality'); ?>">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label><b>State*</b></label> <select class="form-control" name="selState"
                                        id="selState">
                                        <option value="">
                                            Select State
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label><b>City*</b></label> <select class="form-control" name="city_id"
                                        id="selCity">
                                        <option value="">
                                            Select City
                                        </option>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label><b>Shop/Business Name*</b></label> <input type="text"
                                        class="form-control alpha-single-space first-char-capitalize"
                                        id="shop_business_name" name="shop_business_name"
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label><b>Aadhar Front Photo*</b></label> <input type="file"
                                        name="aadharfront_photo" id="aadharfront_photo">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label><b>Shop Photograph (Optional)</b></label> <input type="file"
                                        name="shop_photo">
                                    <div class="error" id="shop_photo_error"></div>
                                </div>
                            </div>
                            <div class="card-header py-3 text-right">
                                <button class="btn btn-success fingpayAeps3btn">Submit</button> <button
