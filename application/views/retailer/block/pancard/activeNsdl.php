...
<div class="card shadow ">
            ...
            <div class="card-header py-3">
              <div class="row">
                <div class="col-sm-6">
                <h4><b>Active NSDL Pancard Service</b></h4>
                </div>

                <div class="col-sm-6">
                <h4><b>Active NSDL Pancard Charge - <?php echo $com_amount = $this->User->get_pan_activation_charge($loggedUser['id']);?> + 18% GST</b></h4>
                </div>
            ...
            <div class="card-body">
            <?php echo form_open_multipart('retailer/pancard/nsdlActiveAuth', array('id' => 'pancard_active'),array('method'=>'post')); ?>
