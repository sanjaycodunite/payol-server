                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title MoneyTransferModalLongTitle">Money Transfer</h5>
                        ...
                        <div class="modal-body">
                            <div class="card text-center">
                                ...
                                <div class="card-body">
                                    <a href="{site_url}retailer/settlement/openPayout" class="btn btn-primary btn-sm text-center">Money Transfer 1</a>
                                    <a href="{site_url}retailer/settlement/openPayout" class="btn btn-primary btn-sm text-center">Money Transfer 2</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="card text-center">
                                ...
                                <div class="card-body">
                                    <a href="{site_url}/retailer/settlement"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="card text-center">
                                ...
                                <div class="card-body">
                                    <a href="{site_url}retailer/report/iciciAepsKyc"
                                        class="btn btn-primary btn-sm text-center">ICICI AEPS Kyc
                                    </a>
                                    <a href="{site_url}retailer/report/aepsKyc"
            ...
            <div class="master_list_card">
                <div class="master_card_body">
                    <div class="master_list_col">
                        <a href="{site_url}retailer/report/addFundReport">
                    ...
                    <div class="master_list_col">
                        <a href="{site+url}retailer/wallet/payolTransfer">
                    ...
                    <div class="master_list_col">
                        <a href="{site_url}retailer/pancard/findPanList">
                    ...
                    <div class="master_list_col moneyTransferdiv">
                        <a href="{site_url}retailer/transfer/openPayout">
                    ...
                    <div class="master_list_col settlementMoneyTransferdiv">
                        <a href="{site_url}retailer/transfer/settlement">
                    ...
                    <div class="master_list_col">
                        <a href="{site_url}retailer/recharge/mobileprepaid">
                    ...
                    <div class="master_list_col">
                        <a href="{site_url}retailer/recharge/dth">
                    ...
                    <div class="master_list_col">
                        <a href="{site_url}retailer/newaeps/cashDeposite">
                    ...
                    <div class="master_list_col">
                        <a href="{site_url}retailer/pancard/utiBalanceRequest">
