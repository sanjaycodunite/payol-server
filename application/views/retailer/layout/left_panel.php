...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item">
            <a class="nav-link" href="{site_url}retailer/home">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{site_url}retailer/bbps">
                <i class="fas fa-tv" style="color: #f3baba !important;"></i>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseDmt"
                ...
                <i class="fas fa-random" style="color: #f3baba !important;"></i>
                <span>DMT</span>
            </a>
            ...
            <div id="collapseinst"
              ...
              <a class="collapse-item" href="{site_url}retailer/transfer/newPayoutFundTransfer">Transfer Now</a>
               -->
                    ...
                    <a class="collapse-item" href="{site_url}retailer/transfer/newPayoutReport">Settlement Report</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapsesettlement"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{site_url}retailer/settlement">Settlement </a>

                    <a class="collapse-item" href="{site_url}retailer/settlement/addBankAccount">Add Account</a>

                    <a class="collapse-item" href="{site_url}retailer/settlement/newPayoutReport">Settlement Report</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapse16"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{site_url}retailer/fingpayAeps/activeAeps">Active AEPS 3</a>
                    <?php } else { ?>
      ...
      <?php  } } ?> -->
        ...
        <li class="nav-item">
            ...
            <div id="collapseMoney2" class="collapse" aria-labelledby="heading5" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <!--  <a class="collapse-item" href="{site_url}retailer/transfer/beneficiaryList">Beneficiary List</a>
            <a class="collapse-item" href="{site_url}retailer/transfer/fundTransfer">Transfer Now</a>-->
                    <a class="collapse-item" href="{site_url}retailer/settlement/openPayout">Money Transfer</a>
                    <a class="collapse-item" href="{site_url}retailer/settlement/settlementTransferReport">Transfer
                        Report</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUpi" <?php if($content_block == '') { ?> class="collapse show" <?php } else { ?>
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{site_url}retailer/wallet/dynamicQr">UPI Collection</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapse10"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <?php if(in_array(5, $activeService)){ ?>
                    <a class="collapse-item" href="{site_url}retailer/report/upiQrHistory">Qr History</a>
                    <?php } ?>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse8" aria-expanded="true"
                ...
                <i class="fa fa-wallet" style="color: #f3baba !important;"></i>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseDeposit"
                ...
                <i class="fas fa-user-circle" style="color: #f3baba !important;"></i>
                <span>Accounts </span>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseDeposit"
                aria-expanded="true" aria-controls="collapseDeposit">
                <i class="fa fa-money-bill-alt" style="color: #f3baba !important;"></i>
            ...
            <div id="collapseDeposit" <?php if($content_block == '') { ?> class="collapse show" <?php } else { ?>
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{site_url}retailer/newaeps/cashDeposite">Cash Deposite</a>
