<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <div class="row">
                ...
                <div class="col-sm-3">
                <button type="button" class="btn btn-success" id="virtualCreditSearchBtn">Search</button>
                <a href="{site_url}superadmin/vanwallet/addWallet" class="btn btn-primary">+Add Fund</a>
                </div>
               </div>  
              <?php echo form_close(); ?>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="virtualCreditDataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>MemberID</th>
