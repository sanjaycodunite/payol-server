<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <div class="row">
                ...
                <div class="col-sm-2">
                <button type="button" class="btn btn-success" id="upiCommisionSearchBtn">Search</button>
                <a href="{site_url}superadmin/report/upiCommision" class="btn btn-secondary">View All</a>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="upiCommisionDataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Account</th>
