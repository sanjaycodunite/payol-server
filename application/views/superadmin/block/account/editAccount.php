                    ...
                    <div class="form-group">
                      ...
                      <select name="web_theme" class="form-control">
                        ...
                        <option value="4" <?php if($List['web_theme'] == 4){ ?> selected="selected" <?php } ?>>Payol Theme</option>
                         ...
                         <option value="5" <?php if($List['web_theme'] == 5){ ?> selected="selected" <?php } ?>>Morningpay Theme</option>
                         
                           <option value="5" <?php if($List['web_theme'] == 6){ ?> selected="selected" <?php } ?>>Payrise Theme</option>
