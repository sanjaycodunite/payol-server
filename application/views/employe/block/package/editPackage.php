...
<div class="card shadow ">
            ...
            <div class="card-body">
            <?php echo form_open_multipart('employe/package/updatePackage', array('id' => 'admin_profile'),array('method'=>'post')); ?>
              ...
              <div class="row">
               ...
               <div class="col-sm-12"> 
                <div class="form-group">
                  <input type="checkbox" <?php if($packageData['is_default'] == 1){ ?> checked="checked" <?php } ?> name="is_default" value="1" id="is_default">
                  <label for="is_default"><b>Is Default ?</b></label>
