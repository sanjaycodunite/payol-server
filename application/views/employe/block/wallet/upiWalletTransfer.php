...
<div class="card shadow ">
            ...
            <div class="card-body">
            <?php echo form_open_multipart('employe/wallet/upiWalletTransferAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
              ...
              <select class="selectpicker form-control" name="member" id="selUpiWalletMember" data-live-search="true">
