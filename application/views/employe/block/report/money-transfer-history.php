<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4><b>Money Transfer Report</b></h4>
                </div>
                ...
                <div class="col-sm-12 mt-3 text-center">
                    <button type="button" class="btn btn-success" id="moneyTransferHistorySearchBtn">Search</button>
                    <a href="{site_url}employe/report/moneyTransferHistory" class="btn btn-secondary">View All</a>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="moneyTransferHistoryDataTable" width="100%"
                    cellspacing="0">
                    <thead>
                        <tr>
                            <th>#</th>
...
<div id="updateComplainModel" class="modal fade" role="dialog">
    <div class="modal-dialog assign-modal">
        ...
        <div class="modal-content">
            <?php echo form_open_multipart('employe/report/successMoneyTransfer',array('method'=>'post')); ?>
