...
<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <div class="row">
                <div class="col-sm-12">
                <h4><b>Scan & Pay Transfer Report</b></h4>
                </div>
                ...
                <div class="col-sm-2">
                <button type="button" class="btn btn-success" id="scanPayTransferHistorySearchBtn">Search</button>
                <a href="{site_url}employe/report/scanPayTransferHistory" class="btn btn-secondary">View All</a>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="scanPayTransferHistoryDataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>MemberID</th>  
...
<div id="updateComplainModel" class="modal fade" role="dialog">
  ...
  <div class="modal-content">
    <?php echo form_open_multipart('employe/report/successScanPay',array('method'=>'post')); ?>
