<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4><b> Money Transfer 2 Report</b></h4>
                </div>
                ...
                <div class="col-sm-12 py-2">
                    <button type="button" class="btn btn-success"
                        id="settlementMoneyTransferHistorySearchBtn">Search</button>
                    <a href="{site_url}employe/report/settlementMoneyTransferHistory" class="btn btn-secondary">View
                        All</a>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="settlementMoneyTransferHistoryDataTable"
...
<div id="updateComplainModel" class="modal fade" role="dialog">
    <div class="modal-dialog assign-modal">
        ...
        <div class="modal-content">
            <?php echo form_open_multipart('employe/report/successSettlementMoneyTransfer',array('method'=>'post')); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input type="text" name="optxid" class="form-control">
                            </div> -->
