        ...
        <div class="card-header py-3">
            ...
            <div class="row">
                ...
                <div class="col-sm-3 py-3">
                    ...
                    <a href="{site_url}employe/report/openMoneyTransferHistory" class="btn btn-secondary">View All</a>
...
<div id="updateComplainModel" class="modal fade" role="dialog">
    <div class="modal-dialog assign-modal">
        ...
        <div class="modal-content">
            <?php echo form_open_multipart('employe/report/successNewPayout',array('method'=>'post')); ?>
