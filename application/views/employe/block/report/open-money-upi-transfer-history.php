...
<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <div class="row">
                ...
                <div class="col-sm-2">
                <button type="button" class="btn btn-success" id="openMoneyUpiTransferHistorySearchBtn">Search</button>
                <a href="{site_url}employe/report/openMoneyUpiTransferHistory" class="btn btn-secondary">View All</a>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="openMoneyUpiTransferHistoryDataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>MemberID</th>
