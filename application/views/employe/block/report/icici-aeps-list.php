<div class="container-fluid">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a
                                    href="{site_url}admin/report/iciciAepsHistory/2">Total Success</a></div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="totalSuccessAepsBlock">&#8377; 0.00
                                / 0</div>
                        </div>
            ...
            <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a
                                    href="{site_url}admin/report/iciciAepsHistory/3">Total Failed</a></div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="totalFailedAepsBlock">&#8377; 0.00 /
                                0</div>
                        </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4><b>ICICI AEPS Transaction History</b></h4>
                </div>
                ...
                <div class="col-sm-2">
                    <select class="form-control" id="service">
                        ...
                        <option value="balinfo" <?php if($service == 'balinfo'){ ?> selected="selected" <?php } ?>>
                            Balance Enquiry</option>
                        <option value="ministatement" <?php if($service == 'ministatement'){ ?> selected="selected"
                            <?php } ?>>Mini Statment</option>
                        <option value="balwithdraw" <?php if($service == 'balwithdraw'){ ?> selected="selected"
                            <?php } ?>>Cash Withdrawal</option>
                        <option value="aadharpay" <?php if($service == 'aadharpay'){ ?> selected="selected" <?php } ?>>
                            Aadhar Pay</option>
                    </select>
                </div>
                ...
                <div class="col-sm-12 mt-3 text-center">
                    <button type="button" class="btn btn-success" id="iciciAepsHistorySearchBtn">Search</button>
                    <a href="{site_url}employe/report/iciciAepsHistory" class="btn btn-secondary">View All</a>
                </div>
            </div>
            <?php echo form_close(); ?>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="iciciAepsHistoryDataTable" width="100%"
                    cellspacing="0">
                    <thead>
                        <tr>
                            <th>#</th>
