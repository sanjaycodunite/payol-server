                  ...
                  <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="#">Total GST Charge Amount</a></div>
                          <div class="h5 mb-0 font-weight-bold text-gray-800" id="totalSuccessGstBlock">&#8377; 0.00</div>
                        </div>
...
<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <div class="row">
                ...
                <button type="button" class="btn btn-success" id="gstSearchBtn">Search</button>
                <a href="{site_url}employe/report/gstReport" class="btn btn-secondary">View All</a>
                </div>
               </div>  
              <?php echo form_close(); ?>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="gstDataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Member ID</th>
