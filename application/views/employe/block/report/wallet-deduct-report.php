<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="row">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control datepick" placeholder="Date" autocomplete="off" name="date"
                    id="date" />
            </div>


            <div class="col-sm-2">
                <button type="button" class="btn btn-success btn-sm" id="walletDeductSearchBtn"
                    style="height: 38px;">Search</button>
                <a href="{site_url}employe/report/walletDeductReport" class="btn btn-secondary btn-sm"
                    style="height: 38px; padding-top: 8px;">View All</a>
            </div>
        </div>
        <?php echo form_close(); ?>
    </div>
