...
<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <div class="row">
                <div class="col-sm-12">
                <h4><b>Settlement(instantpay/yes bank) Report</b></h4>
                </div>
                ...
                <select class="form-control" id="type">
                  ...
                  <option value="IMPS" <?php if($status == 'IMPS'){ ?> selected="selected" <?php } ?>>IMPS</option>
                  <option value="UPI" <?php if($status == 'UPI'){ ?> selected="selected" <?php } ?>>UPI</option>
                </select>
                </div>
                ...
                <button type="button" class="btn btn-success" id="newMoneyTransferHistorySearchBtn">Search</button>
                <a href="{site_url}employe/report/newMoneyTransferHistory" class="btn btn-secondary">View All</a>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="newMoneyTransferHistoryDataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>MemberID</th>
