...
<div class="card shadow ">
            ...
            <div class="card-body">
            <?php echo form_open_multipart('distributor/settlement/upiOpenPayoutTransferAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
              ...
              <input type="text" class="form-control" value="<?php echo set_value('account_no') ? set_value('account_no') : $account_no; ?>" readonly="" name="account_no" placeholder="UPI ID">
              <?php echo form_error('account_no', '<div class="error">', '</div>'); ?>  
              </div>
              </div>
              <div class="col-sm-3">
              <div class="form-group">
              <label><b>Confirm UPI ID.*</b></label>
              <input type="text" class="form-control" value="<?php echo set_value('confirm_account_no') ? set_value('confirm_account_no') : $account_no; ?>" readonly="" name="confirm_account_no" placeholder="Confirm UPI ID.">
