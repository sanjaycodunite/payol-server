...
<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                <button type="button" class="btn btn-success" id="settlementMoneySearchBtn">Search</button>
                <a href="{site_url}distributor/settlement/settlementTransferReport" class="btn btn-secondary">View All</a>
                </div>
               </div>  
              <?php echo form_close(); ?>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="settlementMoneyTransferDataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>MemberID</th>
