 <div class="row">
  ...
  <div class="col-sm-12">
    ...
    <div class="card">
      ...
      <?php echo form_open_multipart('distributor/settlement/upiOpenPayoutBenificaryAuth', array('id' => 'upi_verify_form'),array('method'=>'post')); ?>
      <div class="card-body">
          ...
          <table class="table table-bordered" id="example">
            ...
            <tr>
              ...
              <td class="align-middle">
                <a href="{site_url}distributor/settlement/upiOpenPayoutFundTransfer/<?php echo $list['ben_id']; ?>"><button class="btn btn-primary" type="button">Transfer</button></a>
              </td>
              </tr>
            <?php $i++; }}else{  ?>  
            <tr>
