...
<ul>
<li><a href="{site_url}distributor/bbps/prepaidRecharge"><span class="recharge_icons"><i class="flaticon-mobile-phone"></i></span>Mobile Prepaid</a></li>
            ...
            <div class="modal-body">
               <div class="recharge_form">
                ...
                <div class="form-group" id="boradband-postpaid-fetch-block" style="display: none;">
                  <a href="#" onclick="fetchMasterBill(8); return false;">Fetch & View Bill</a>
                </div>
                <div class="form-group">
                    <label>Amount*</label>
                ...
                <div class="form-group" style="display: none;" id="boradband-postpaid-submit-btn">
                    <button class="procced-btn btn-primary" onclick="payMasterBill(8); return false;" type="button" id="bbps-boradband-postpaid-btn"> Proceed Recharge</button>
                </div>
