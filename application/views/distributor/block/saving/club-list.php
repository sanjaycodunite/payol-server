              ...
              <div class="row">
                <?php if($clubList){ ?>
                  ...
                  <div class="col-sm-6 club-block">
                    <?php echo form_open_multipart('distributor/saving/clubRequestAuth'); ?>
                    ...
                    <table class="table table-bordered table-striped">
                      ...
                      <?php } elseif($list['member_action'] == 1 && $list['member_status'] == 2){ ?>
                        <tr>
                          <td colspan="4" align="center">
                            <a href="{site_url}distributor/saving/clubLiveAuth/<?php echo $list['id']; ?>/<?php echo $list['requestID']; ?>"><button type="button" class="btn btn-success">View LIVE</button></a>
                          </td>
                        </tr>
