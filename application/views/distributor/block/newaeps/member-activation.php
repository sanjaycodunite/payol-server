...
<div class="card shadow ">
            <div class="card-header py-3">
              <div class="row">
                <div class="col-sm-8">
                <h4><b>Activate  <?php echo $this->User->getAepsTitle(); ?> AEPS</b></h4>
                </div>
            ...
            <div class="card-body">
            <?php echo form_open_multipart('distributor/newaeps/activeAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
            ...
            <div class="row">
              ...
              <div class="col-sm-6 text-right">
                ...
                ?>
                <h5><b>KYC Charge - INR <?=$kyc_charge?></b></h5>
              </div>
