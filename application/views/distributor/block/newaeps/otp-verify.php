...
<div class="card shadow ">
            ...
            <div class="card-body">
            <?php echo form_open_multipart('member/iciciaeps/otpAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
            ...
            <div class="row">
              ...
              <br />
              <a href="{site_url}member/aeps/resendOtp/{encodeFPTxnId}">Resend OTP</a>
              </div>
              </div>
