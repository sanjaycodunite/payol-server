...
<div class="card shadow ">
            <div class="card-header py-3">
              <div class="row">
                <div class="col-sm-6">
                <h4><b><?php echo $this->User->getAepsTitle(); ?> AEPS</b></h4>
                </div>
                ...
                <div class="col-sm-6  text-right">
                   ...
                   <a href="{site_url}distributor/iciciaeps/activeAeps" class="btn btn-dark">ICICI AEPS</a>
                 <?php } else {?>
                   <a href="{site_url}distributor/iciciaeps/index" class="btn btn-dark">ICICI AEPS</a>
                 <?php } ?>
                 <?php } ?>
            ...
            <div class="card-body">
            <?php echo form_open_multipart('distributor/transfer/transferAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
              <input type="hidden" value="<?php echo $site_url;?>" id="siteUrl">
               <input type="hidden" value="0" id="memberAuthNew">
              <div class="row">
              <div class="col-sm-12">
                <h5>Service Type</h5>
                <hr />
             ...
             <div class="row">
              ...
              <div class="col-sm-3">
                <div class="form-group">
                  <input type="radio" name="deviceType" id="deviceType2" value="MORPHO_PROTOBUF" <?php if($account_id == 3) {?> checked="" <?php } ?>>
            ...
            <div class="row">
              ...
              <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Mobile No." maxlength="10">
              ...
              <input type="text" class="form-control" name="aadhar_no" id="aadhar_no" placeholder="Aadhar No">
			         ...
			         <div class="col-sm-3" id="aepsAmountBlock">
              <div class="form-group">
              ...
              <select class="form-control selectpicker" name="bankID" id="bankID" data-live-search="true">
                ...
                <?php if($bankList){ ?>
                  <?php foreach($bankList as $list){ ?>
                    <option value="<?php echo $list['iinno']; ?>"><?php echo $list['bankName']; ?></option>
                  <?php } ?>
                <?php } ?>
              </select>
