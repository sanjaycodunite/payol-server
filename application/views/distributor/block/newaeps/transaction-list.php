                  ...
                  <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="{site_url}distributor/report/newAepsHistory/2">Total Success</a></div>
                ...
                <div class="col-xl-4 col-md-6 mb-2 mt-2">
                  <div class="card border-left-danger shadow h-100 py-2">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="{site_url}distributor/report/newAepsHistory/3">Total Failed</a></div>
...
<div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <div class="row">
                ...
                <a href="{site_url}distributor/newaeps/transactionHistory" class="btn btn-secondary">View All</a>
                </div>
