...
<div class="card shadow ">
            <div class="card-header py-3">
              <div class="row">
                <div class="col-sm-6">
                <h4><b>Update Transcation Password</b></h4>
                </div>
            ...
            <div class="card-body">
            <?php echo form_open_multipart('distributor/setting/transcationPasswordAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
