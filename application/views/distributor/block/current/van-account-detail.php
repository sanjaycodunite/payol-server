            ...
            <div class="card-header py-3">
              <div class="row">
                ...
                <div class="col-sm-4 text-right">
                  <a href="{site_url}distributor/current/upgradeAccountAuth" onclick="return confirm('Are you sure you want to regenerate Virtual Account Detail?')"><button type="button" class="btn btn-primary">Regenerate Account</button></a>
                </div>
