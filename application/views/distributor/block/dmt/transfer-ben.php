...
<div class="card shadow ">
           ...
           <div class="row">
            <div class="col-lg-6 col-md-6">
              ...
              <div class="col-lg-12">
                <p style="color:red;">Note : Account verify will be chargeable, please <a href="{site_url}distributor/master/myAccountVerifyCharge">click here</a> to check your account verify charge.</p>
              </div>
               <div class="col-lg-12">
              <div class="form-group">
          ...
          <div class="col-lg-12 col-md-12">
              <div class="beneficiary_form_section">
                <?php echo form_open_multipart('distributor/dmt/updateDetailAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
              <input type="hidden" value="<?php echo $site_url;?>" id="siteUrl">
              <input type="hidden" value="<?php echo $mobile;?>" name="accountMobile">
              <div class="row">
              <div class="col-lg-12">
