 <div class="row">
  ...
  <div class="row">
    <?php 
    $already_request_pending = $this->db->get_where('payout_user_request',array('account_id'=>$account_id,'user_id'=>$loggedAccountID,'status'=>1))->num_rows();
  ...
  <div class="col-sm-12">
    ...
    <div class="card">
      ...
      <?php echo form_open_multipart('distributor/transfer/benificaryAccountAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
      <div class="card-body">
