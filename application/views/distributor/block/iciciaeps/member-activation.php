...
<div class="card shadow ">
            ...
            <div class="card-body">
            <?php echo form_open_multipart('distributor/iciciaeps/activeAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
            ...
            <div class="row">
             ...
             <input type="text" class="form-control" id="bank_ifsc" name="bank_ifsc" placeholder="Bank Ifsc">
             <?php echo form_error('bank_ifsc', '<div class="error">', '</div>'); ?>  
