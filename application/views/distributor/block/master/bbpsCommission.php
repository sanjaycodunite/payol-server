<div class="card shadow mb-4">
              {system_message}               
              {system_info}
              <?php echo form_open_multipart('distributor/master/saveBBPSCommission', array('id' => 'admin_profile'),array('method'=>'post')); ?>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-2">
                <button type="button" id="bbpsComSearchBtn" class="btn btn-success">Search</button>
                </div>
