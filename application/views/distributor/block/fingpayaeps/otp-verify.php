...
<div class="card shadow ">
            ...
            <div class="card-body">
            <?php echo form_open_multipart('distributor/fingpayAeps/otpAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
            ...
            <div class="row">
              ...
              <br />
              <a href="{site_url}distributor/fingpayAeps/resendOtp/{encodeFPTxnId}">Resend OTP</a>
              </div>
              </div>
