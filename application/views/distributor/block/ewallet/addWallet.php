...
<div class="card shadow ">
            <div class="card-header py-3">
              <div class="row">
                <div class="col-sm-6">
                <h4><b>Add Collection Wallet Balance</b></h4>
                </div>
            ...
            <div class="card-body">
            <?php echo form_open_multipart('distributor/ewallet/saveWallet', array('id' => 'admin_profile'),array('method'=>'post')); ?>
              ...
              <select class="selectpicker form-control" name="member" id="selEwalletMember" data-live-search="true">
