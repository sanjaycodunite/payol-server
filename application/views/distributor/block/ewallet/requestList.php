<?php echo form_open_multipart('distributor/token/requestTokenAuth', array('id' => 'admin_profile'),array('method'=>'post')); ?>
...
{system_message}               
            ...
            <div class="card-header py-3">
              <div class="row">
                ...
                <a href="{site_url}distributor/ewallet/requestList" class="btn btn-secondary">View All</a>
                </div>                  
              </div>  
