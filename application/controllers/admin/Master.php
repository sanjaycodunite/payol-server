...
class Master extends CI_Controller {    
    ...
    public function __construct() 
    {
        ...
        $this->lang->load('admin/master', 'english');
	...
	public function myDmtCharge(){
		...
		$recordList = $this->db->get_where('dmt_commision',array('package_id'=>$account_package_id))->result_array();
	...
	public function saveCommission(){
		...
		$account_id = $this->User->get_domain_account();
	 	$loggedUser = $this->User->getAdminLoggedUser(ADMIN_SESSION_ID);
 	 	...
 	 	if($memberID == 0)
	 	{
	 		$this->Az->redirect('admin/master/commission', 'system_message_error',lang('MEMBER_ERROR'));
	 	}
	 	...
	 	$this->Az->redirect('admin/master/commission', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
	...
	public function saveBBPSCommission(){
		...
		$account_package_id = $this->User->get_account_package_id($account_id);	
 	 	...
 	 	if($memberID == 0)
	 	{
	 		$this->Az->redirect('admin/master/bbpsCommission', 'system_message_error',lang('MEMBER_ERROR'));
	 	}
	 	...
	 	$this->Az->redirect('admin/master/bbpsCommission', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
	...
	public function saveDMRCommission(){
		...
		{	
	 	 	...
	 	 	if($memberID == 0)
		 	{
		 		$this->Az->redirect('admin/master/transferCommision', 'system_message_error',lang('PACKAGE_ERROR'));
		 	}
			...
			$data = array(
		 	...
		 	$this->Az->redirect('admin/master/transferCommision', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	...
	public function updateDMRCom(){
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/master/transferCommision', 'system_message_error',lang('FORM_ERROR'));
		}
		else
		{	
	...
	public function deleteDMRCom($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('dmr_commision',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		...
 		$this->Az->redirect('admin/master/transferCommision', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	...
	public function savePayoutCommission(){
		...
		{	
	 	 	...
	 	 	if($memberID == 0)
		 	{
		 		$this->Az->redirect('admin/master/payoutCommission', 'system_message_error',lang('PACKAGE_ERROR'));
		 	}
		 	...
		 	{
		 		$this->Az->redirect('admin/master/payoutCommission', 'system_message_error',lang('MEMBER_SURCHARGE_ERROR'));
		 	}
			...
			$data = array(
		 	...
		 	$this->Az->redirect('admin/master/payoutCommission', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	...
	public function updatePayoutCom(){
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/master/payoutCommission', 'system_message_error',lang('FORM_ERROR'));
		}
		else
		{	
	 		...
	 		if(!$chk_member)
	 		{
	 			$this->Az->redirect('admin/master/payoutCommission', 'system_message_error',lang('MEMBER_ERROR'));
	...
	public function deletePayoutCom($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('payout_commision',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		...
 		$this->Az->redirect('admin/master/payoutCommission', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	...
	public function saveAEPSCommission(){
		...
		{	
	 	 	...
	 	 	if($memberID == 0)
		 	{
		 		$this->Az->redirect('admin/master/aepsCommision', 'system_message_error',lang('MEMBER_ERROR'));
		 	}
			...
			$data = array(
		 	...
		 	$this->Az->redirect('admin/master/aepsCommision', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	...
	public function updateAEPSCom(){
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/master/aepsCommision', 'system_message_error',lang('FORM_ERROR'));
		}
		else
		{	
	...
	public function deleteAEPSCom($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('aeps_commision',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		...
 		$this->Az->redirect('admin/master/aepsCommision', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	...
	public function saveServiceAuth(){
		...
		$account_id = $this->User->get_domain_account();
	 	$loggedUser = $this->User->getAdminLoggedUser(ADMIN_SESSION_ID);
 	 	...
 	 	if($memberID == 0)
	 	{
	 		$this->Az->redirect('admin/master/service', 'system_message_error',lang('MEMBER_ERROR'));
	 	}
 	 	if($memberID > 0)
	 	{
	 	...
	 	$this->Az->redirect('admin/master/service', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
	...
	public function saveBBPSLiveCommission(){
		...
		$account_package_id = $this->User->get_account_package_id($account_id);	
 	 	...
 	 	if($memberID == 0)
	 	{
	 		$this->Az->redirect('admin/master/bbpsLiveCommission', 'system_message_error',lang('MEMBER_ERROR'));
	 	}
	 	...
	 	$this->Az->redirect('admin/master/bbpsLiveCommission', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
	...
	public function saveMoneyTransferCommission(){
		...
		{	
	 	 	...
	 	 	if($memberID == 0)
		 	{
		 		$this->Az->redirect('admin/master/moneyTransferCommision', 'system_message_error',lang('PACKAGE_ERROR'));
		 	}
			...
			$data = array(
		 	...
		 	$this->Az->redirect('admin/master/moneyTransferCommision', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	...
	public function updateMoneyTransferCom(){
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/master/moneyTransferCommision', 'system_message_error',lang('FORM_ERROR'));
		}
		else
		{	
	...
	public function deleteMoneyTransferCom($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('money_transfer_commision',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		...
 		$this->Az->redirect('admin/master/moneyTransferCommision', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	 	...
	 	else
	 	{
			...
			if($recordList){
                ...
                foreach($recordList as $key=>$list){
                	...
                	$str.='<td><a title="edit" class="btn btn-primary btn-sm" href="#" onclick="updateUpiQrModel('.$list['id'].'); return false;"><i class="fa fa-edit" aria-hidden="true"></i></a> <a title="delete" class="btn btn-danger btn-sm" href="'.base_url().'admin/master/deleteUpiQrCom/'.$list['id'].'" onclick="return confirm(\'Are you sure you want to delete?\')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>';
	...
	public function deleteUpiQrCom($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('upi_commision',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		if(!$chk_member)
 		{
 			$this->Az->redirect('admin/master/upiCommision', 'system_message_error',lang('MEMBER_ERROR'));
 		...
 		$this->Az->redirect('admin/master/upiCommision', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	...
	public function deleteRefferalCom($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('referral_commision',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		if(!$chk_member)
 		{
 			$this->Az->redirect('admin/master/referralCommision', 'system_message_error',lang('MEMBER_ERROR'));
 			
 		}

 		$this->db->where('id',$recordID);
 		$this->db->delete('referral_commision');
 		$this->Az->redirect('admin/master/referralCommision', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	...
	public function updateUpiQrCom(){
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/master/upiCommision', 'system_message_error',lang('FORM_ERROR'));
		}
		else
		{	
			...
			$this->db->where('account_id',$account_id);
		 	...
		 	$this->Az->redirect('admin/master/upiCommision', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	...
	public function saveUpiCashCommission(){
		...
		$account_id = $this->User->get_domain_account();
	 	$loggedUser = $this->User->getAdminLoggedUser(ADMIN_SESSION_ID);
 	 	...
 	 	if($memberID == 0)
	 	{
	 		$this->Az->redirect('admin/master/upiCashCommision', 'system_message_error',lang('MEMBER_ERROR'));
	 	}
	 	...
	 	$this->Az->redirect('admin/master/upiCashCommision', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
	...
	public function saveGatewayCharge(){
		...
		{	
	 	 	...
	 	 	if($memberID == 0)
		 	{
		 		$this->Az->redirect('admin/master/gatewayCharge', 'system_message_error',lang('MEMBER_ERROR'));
		 	}
			...
			$data = array(
		 	...
		 	$this->Az->redirect('admin/master/gatewayCharge', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	 	...
	 	else
	 	{
			...
			if($recordList){
                ...
                foreach($recordList as $key=>$list){
                	...
                	$str.='<td><a title="edit" class="btn btn-primary btn-sm" href="#" onclick="updateGatewayModel('.$list['id'].'); return false;"><i class="fa fa-edit" aria-hidden="true"></i></a> <a title="delete" class="btn btn-danger btn-sm" href="'.base_url().'admin/master/deleteGatewayCharge/'.$list['id'].'" onclick="return confirm(\'Are you sure you want to delete?\')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>';
	...
	public function updateGatewayCharge(){
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/master/gatewayCharge', 'system_message_error',lang('FORM_ERROR'));
		}
		else
		{	
	...
	public function deleteGatewayCharge($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('gateway_charge',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		...
 		$this->Az->redirect('admin/master/gatewayCharge', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	...
	public function saveDmtCharge(){
		...
		{	
	 	 	...
	 	 	if($memberID == 0)
		 	{
		 		$this->Az->redirect('admin/master/dmtCharge', 'system_message_error',lang('PACKAGE_ERROR'));
		 	}
			...
			$data = array(
		 	...
		 	$this->Az->redirect('admin/master/dmtCharge', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	 	...
	 	else
	 	{
			...
			if($recordList){
                ...
                foreach($recordList as $key=>$list){
                	...
                	$str.='<td><a title="edit" class="btn btn-primary btn-sm" href="#" onclick="updateDmtChargeModel('.$list['id'].'); return false;"><i class="fa fa-edit" aria-hidden="true"></i></a> <a title="delete" class="btn btn-danger btn-sm" href="'.base_url().'admin/master/deleteDmtCharge/'.$list['id'].'" onclick="return confirm(\'Are you sure you want to delete?\')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>';
	...
	public function updateDmtCharge(){
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/master/dmtCharge', 'system_message_error',lang('FORM_ERROR'));
		}
		else
		{	
	...
	public function deleteDmtCharge($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('dmt_commision',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		...
 		$this->Az->redirect('admin/master/dmtCharge', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	...
	public function saveUtiCommission(){
		...
		$account_id = $this->User->get_domain_account();
	 	$loggedUser = $this->User->getAdminLoggedUser(ADMIN_SESSION_ID);
 	 	...
 	 	if($memberID == 0)
	 	{
	 		$this->Az->redirect('admin/master/utiCommision', 'system_message_error',lang('MEMBER_ERROR'));
	 	}
	 	...
	 	$this->Az->redirect('admin/master/utiCommision', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
	...
	public function moveMemberAuth()
	{
		$account_id = $this->User->get_domain_account();
	 	...
	 	{
	 		$this->Az->redirect('admin/master/moveMember', 'system_message_error',lang('MOVE_MEMBER_TYPE_ERROR'));
	 	}
	 	...
	 	if(!$chk_member)
	 	{
	 		$this->Az->redirect('admin/master/moveMember', 'system_message_error',lang('MOVE_MEMBER_ID_ERROR'));
	 	}

	 	if($memberType == 4 && $sponserType != 3)
	 	{
	 		$this->Az->redirect('admin/master/moveMember', 'system_message_error',lang('MOVE_MEMBER_SPONSER_TYPE_ERROR'));
	 	}
	 	...
	 	if(!$chk_sponser)
	 	{
	 		$this->Az->redirect('admin/master/moveMember', 'system_message_error',lang('MOVE_MEMBER_SPONSER_ID_ERROR'));
	 	}
	 	...
	 	{
	 		$this->Az->redirect('admin/master/moveMember', 'system_message_error',lang('MOVE_MEMBER_SAME_SPONSER_ERROR'));
	 	}
	 	...
	 	$this->Az->redirect('admin/master/moveMember', 'system_message_error',lang('MOVE_MEMBER_SUCCESS'));
	}
	...
	public function saveAccountVerifyCharge(){
		...
		{	
	 	 	...
	 	 	if($memberID == 0)
		 	{
		 		$this->Az->redirect('admin/master/accountVerifyCharge', 'system_message_error',lang('PACKAGE_ERROR'));
		 	}
			...
			$data = array(
		 	...
		 	$this->Az->redirect('admin/master/accountVerifyCharge', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	 	...
	 	else
	 	{
			...
			if($recordList){
                ...
                foreach($recordList as $key=>$list){
                	...
                	$str.='<td><a title="edit" class="btn btn-primary btn-sm" href="#" onclick="updateAccountVerifyChargeModel('.$list['id'].'); return false;"><i class="fa fa-edit" aria-hidden="true"></i></a> <a title="delete" class="btn btn-danger btn-sm" href="'.base_url().'admin/master/deleteAccountVerifyCharge/'.$list['id'].'" onclick="return confirm(\'Are you sure you want to delete?\')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>';
	...
	public function updateAccountVerifyCharge(){
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/master/accountVerifyCharge', 'system_message_error',lang('FORM_ERROR'));
		}
		else
		{	
	 		...
	 		if(!$chk_member)
	 		{
	 			$this->Az->redirect('admin/master/accountVerifyCharge', 'system_message_error',lang('MEMBER_ERROR'));
	...
	public function deleteAccountVerifyCharge($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('dmr_account_verify_charge',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		...
 		$this->Az->redirect('admin/master/accountVerifyCharge', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	...
	public function saveNsdlPancardCharge(){
		...
		{	
	 	 	...
	 	 	if($memberID == 0)
		 	{
		 		$this->Az->redirect('admin/master/nsdlPancardCharge', 'system_message_error',lang('PACKAGE_ERROR'));
		 	}
			...
			$data = array(
		 	...
		 	$this->Az->redirect('admin/master/nsdlPancardCharge', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	...
	public function updateNsdlPancardCharge(){
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/master/nsdlPancardCharge', 'system_message_error',lang('FORM_ERROR'));
		}
		else
		{	
	 		...
	 		if(!$chk_member)
	 		{
	 			$this->Az->redirect('admin/master/nsdlPancardCharge', 'system_message_error',lang('MEMBER_ERROR'));
	...
	public function deleteNsdlPancardCharge($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('nsdl_pancard_charge',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		...
 		$this->Az->redirect('admin/master/nsdlPancardCharge', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	...
	public function payoutSaveOtp()
	{
		...
		$this->Az->redirect('admin/master/payoutOtpSetting', 'system_message_error',lang('WALLET_SETTING_SUCCESS'));
	...
	public function savePanActivationCharge(){
		...
		$account_id = $this->User->get_domain_account();
	 	$loggedUser = $this->User->getAdminLoggedUser(ADMIN_SESSION_ID);
 	 	...
 	 	if($memberID == 0)
	 	{
	 		$this->Az->redirect('admin/master/panActivationCharge', 'system_message_error',lang('MEMBER_ERROR'));
	 	}
	 	...
	 	$this->Az->redirect('admin/master/panActivationCharge', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
	...
	public function saveFindPanCharge(){
		...
		$account_id = $this->User->get_domain_account();
	 	$loggedUser = $this->User->getAdminLoggedUser(ADMIN_SESSION_ID);
 	 	...
 	 	if($memberID == 0)
	 	{
	 		$this->Az->redirect('admin/master/findPanCharge', 'system_message_error',lang('MEMBER_ERROR'));
	 	}
	...
	public function savePanCharge(){
		...
		$account_id = $this->User->get_domain_account();
	 	$loggedUser = $this->User->getAdminLoggedUser(ADMIN_SESSION_ID);
 	 	...
 	 	if($memberID == 0)
	 	{
	 		$this->Az->redirect('admin/master/panCharge', 'system_message_error',lang('MEMBER_ERROR'));
	 	}
	 	...
	 	$this->Az->redirect('admin/master/panCharge', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
	...
	public function saveXpressPayoutCharge(){
		...
		{	
			...
			$data = array(
		 	...
		 	$this->Az->redirect('admin/master/xpressPayoutCharge', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	 	...
	 	else
	 	{
			...
			if($recordList){
                ...
                foreach($recordList as $key=>$list){
                	...
                	$str.='<td><a title="edit" class="btn btn-primary btn-sm" href="#" onclick="updateXpressPayoutChargeModel('.$list['id'].'); return false;"><i class="fa fa-edit" aria-hidden="true"></i></a> <a title="delete" class="btn btn-danger btn-sm" href="'.base_url().'admin/master/deleteXpressPayoutCharge/'.$list['id'].'" onclick="return confirm(\'Are you sure you want to delete?\')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>';
	...
	public function updateXpressPayoutCharge(){
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/master/xpressPayoutCharge', 'system_message_error',lang('FORM_ERROR'));
		}
		else
		{	
	 		...
	 		if(!$chk_member)
	 		{
	 			$this->Az->redirect('admin/master/xpressPayoutCharge', 'system_message_error',lang('MEMBER_ERROR'));
	...
	public function deleteXpressPayoutCharge($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('xpress_payout_charge',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		...
 		$this->Az->redirect('admin/master/xpressPayoutCharge', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	...
	public function referralCommision(){
		...
		if($recordList){
            ...
            foreach($recordList as $key=>$list){
            	...
            	$str.='<td><a title="delete" class="btn btn-danger btn-sm" href="'.base_url().'admin/master/deleteRefferalCom/'.$list['id'].'" onclick="return confirm(\'Are you sure you want to delete?\')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>';
	...
	public function saveReferralCommission(){
		...
		else
		{
		 	...
		 	$this->Az->redirect('admin/master/referralCommision', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	...
	public function saveIpAuth(){
		...
		$account_id = $this->User->get_domain_account();
	 	$loggedUser = $this->User->getAdminLoggedUser(ADMIN_SESSION_ID);
 	 	...
 	 	if(!$ipaddress)
	 	{
	 		$this->Az->redirect('admin/master/ipsetting', 'system_message_error',lang('MEMBER_ERROR'));
	 	}
	 	...
	 	$this->Az->redirect('admin/master/ipsetting', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));

	}
	


	//uti balance request charges

	public function utiBalanceCharge(){
        ...
        $data = array(
            ...
            'meta_keywords' => lang('SITE_NAME'),
            'meta_description' => lang('SITE_NAME'),
            'content_block' => 'master/uti-balance-charge',
            'packageList' => $packageList,
            'manager_description' => lang('SITE_NAME'),
          	'system_message' => $this->Az->getSystemMessageError(),
            'system_info' => $this->Az->getSystemMessageInfo(),
	...
	public function getUtiBalanceCommData($member_id = 0){
		...
		$accountData = $this->User->get_account_data($account_id);
	 	...
	 	{
	 		// get commission
			$get_com_data = $this->db->get_where('uti_balance_charge',array('account_id'=>$account_id,'package_id'=>$member_id))->row_array();
	...
	public function saveUtiBalanceCharge(){
		...
		$account_id = $this->User->get_domain_account();
	 	$loggedUser = $this->User->getAdminLoggedUser(ADMIN_SESSION_ID);
 	 	...
 	 	if($memberID == 0)
	 	{
	 		$this->Az->redirect('admin/master/utiBalanceCharge', 'system_message_error',lang('MEMBER_ERROR'));
	 	}



 		// check commision saved or not
 		$chk_data = $this->db->get_where('uti_balance_charge',array('account_id'=>$account_id,'package_id'=>$memberID))->num_rows();
 		if($chk_data)
 		{
 			$data = array(
	 	  	 'md_commision' => isset($post['md_commision']) ? $post['md_commision'] : 0,	
	 	  	...
	 	  	$this->db->where('account_id',$account_id);
	 	  	$this->db->where('package_id',$memberID);
	 	  	$this->db->update('uti_balance_charge',$data);
 		}
 		else
 		{
		  	$data = array(
	 	  	...
	 	  	$this->db->insert('uti_balance_charge',$data);
 	  	}
				
		 	

	 	$this->Az->redirect('admin/master/utiBalanceCharge', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
	...
	public function saveUpiApiAuth(){
		...
		$account_id = $this->User->get_domain_account();
	 	$loggedUser = $this->User->getAdminLoggedUser(ADMIN_SESSION_ID);
 	 	...
 	 	if($memberID == 0)
	 	{
	 		$this->Az->redirect('admin/master/upiApiSwitch', 'system_message_error',lang('MEMBER_ERROR'));
	 	}
 	 	if($memberID > 0)
	 	{
	 	...
	 	$this->Az->redirect('admin/master/upiApiSwitch', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
	 	...
	 	else
	 	{
			...
			if($recordList){
                ...
                foreach($recordList as $key=>$list){
                	...
                	$str.='<td><a title="edit" class="btn btn-primary btn-sm" href="#" onclick="updateScanPayModel('.$list['id'].'); return false;"><i class="fa fa-edit" aria-hidden="true"></i></a> <a title="delete" class="btn btn-danger btn-sm" href="'.base_url().'admin/master/deleteScanPayCom/'.$list['id'].'" onclick="return confirm(\'Are you sure you want to delete?\')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>';
	...
	public function saveScanPayCommission(){
		...
		else
		{
	 	 	...
	 	 	if($memberID == 0)
		 	{
		 		$this->Az->redirect('admin/master/scanPayCommision', 'system_message_error',lang('MEMBER_ERROR'));
		 	}
		 	...
		 	$this->Az->redirect('admin/master/scanPayCommision', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	...
	public function updateScanPayCom(){
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/master/scanPayCommision', 'system_message_error',lang('FORM_ERROR'));
		}
		else
		{	
	...
	public function deleteScanPayCom($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('scan_pay_commision',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		...
 		$this->Az->redirect('admin/master/scanPayCommision', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	...
	public function saveOpenMoneyPayoutCharge(){
		...
		{	
	 	 	...
	 	 	if($memberID == 0)
		 	{
		 		$this->Az->redirect('admin/master/openMoneyPayoutCharge', 'system_message_error',lang('PACKAGE_ERROR'));
		 	}
			...
			$data = array(
		 	...
		 	$this->Az->redirect('admin/master/openMoneyPayoutCharge', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	 	...
	 	else
	 	{
			...
			if($recordList){
                ...
                foreach($recordList as $key=>$list){
                	...
                	$str.='<td><a title="edit" class="btn btn-primary btn-sm" href="#" onclick="updateOpenMoneyPayout('.$list['id'].'); return false;"><i class="fa fa-edit" aria-hidden="true"></i></a> <a title="delete" class="btn btn-danger btn-sm" href="'.base_url().'admin/master/deleteOpenMoneyPayoutCharge/'.$list['id'].'" onclick="return confirm(\'Are you sure you want to delete?\')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>';
	...
	public function updateOpenMoneyPayoutCharge(){
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/master/openMoneyPayoutCharge', 'system_message_error',lang('FORM_ERROR'));
		}
		else
		{	
	 		...
	 		if(!$chk_member)
	 		{
	 			$this->Az->redirect('admin/master/openMoneyPayoutCharge', 'system_message_error',lang('MEMBER_ERROR'));
	...
	public function deleteOpenMoneyPayoutCharge($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('open_money_payout_commision',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		...
 		$this->Az->redirect('admin/master/openMoneyPayoutCharge', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	...
	public function saveNewMoneyTransferCharge(){
		...
		{	
	 	 	...
	 	 	if($memberID == 0)
		 	{
		 		$this->Az->redirect('admin/master/newMoneyTransferCharge', 'system_message_error',lang('PACKAGE_ERROR'));
		 	}
			...
			$data = array(
		 	...
		 	$this->Az->redirect('admin/master/newMoneyTransferCharge', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	 	...
	 	else
	 	{
			...
			if($recordList){
                ...
                foreach($recordList as $key=>$list){
                	...
                	$str.='<td><a title="edit" class="btn btn-primary btn-sm" href="#" onclick="updateNewMoneyTransferCharge('.$list['id'].'); return false;"><i class="fa fa-edit" aria-hidden="true"></i></a> <a title="delete" class="btn btn-danger btn-sm" href="'.base_url().'admin/master/deleteNewMoneyTransferCharge/'.$list['id'].'" onclick="return confirm(\'Are you sure you want to delete?\')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>';
	...
	public function updateNewMoneyTransferCharge(){
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/master/newMoneyTransferCharge', 'system_message_error',lang('FORM_ERROR'));
		}
		else
		{	
	 		...
	 		if(!$chk_member)
	 		{
	 			$this->Az->redirect('admin/master/newMoneyTransferCharge', 'system_message_error',lang('MEMBER_ERROR'));
	...
	public function deleteNewMoneyTransferCharge($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('new_money_transfer_charge',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		...
 		$this->Az->redirect('admin/master/newMoneyTransferCharge', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	 	...
	 	else
	 	{
			...
			if($recordList){
                ...
                foreach($recordList as $key=>$list){
                	...
                	$str.='<td><a title="edit" class="btn btn-primary btn-sm" href="#" onclick="updateAddFundModel('.$list['id'].'); return false;"><i class="fa fa-edit" aria-hidden="true"></i></a> <a title="delete" class="btn btn-danger btn-sm" href="'.base_url().'admin/master/deleteAddFundCom/'.$list['id'].'" onclick="return confirm(\'Are you sure you want to delete?\')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>';
	...
	public function deleteAddFundCom($recordID = 0)
	{
		...
		$chk_member = $this->db->get_where('add_fund_commision',array('id'=>$recordID,'account_id'=>$account_id))->num_rows();
 		if(!$chk_member)
 		{
 			$this->Az->redirect('admin/master/addFundCommision', 'system_message_error',lang('MEMBER_ERROR'));
 		...
 		$this->Az->redirect('admin/master/addFundCommision', 'system_message_error',lang('DMR_COM_DELETE_SUCCESS'));
	}
	...
	public function updateAddFundCom(){
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/master/addFundCommision', 'system_message_error',lang('FORM_ERROR'));
		}
		else
		{	
			...
			$this->db->where('account_id',$account_id);
		 	...
		 	$this->Az->redirect('admin/master/addFundCommision', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
		 }
	...
	public function saveAepsTranscationCharge(){
		...
		$account_id = $this->User->get_domain_account();
	 	...
	 	$this->Az->redirect('admin/master/aepsTranscationCharge', 'system_message_error',lang('COMMISSION_SAVE_SUCCESS'));
