...
class Link extends CI_Controller {   
	...
	public function save()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->Az->redirect('admin/link', 'system_message_error',lang('LINK_SAVE_SUCCESS'));
	...
	public function edit($id = 0)
	{
		...
		if(!$chkMember)
		{
			$this->Az->redirect('admin/link', 'system_message_error',lang('MEMBER_ERROR'));
		}
	...
	public function deleteLink($id)
	{
		...
		$this->Az->redirect('admin/link', 'system_message_error',lang('LINK_DELETE_SUCCESS'));
	}
