...
class Setting extends CI_Controller{
    ...
    public function __construct() {
        ...
        $this->lang->load('admin/setting', 'english');
    ...
    public function profileAuth() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if($_FILES['profile']['name'])
            {
                ...
                if($uploadError){
                    $this->Az->redirect('admin/setting/profile', 'system_message_error',$uploadError);
                }
                else
                {
            ...
            $this->Az->redirect('admin/setting/profile', 'system_message_error',lang('PROFILE_UPDATE_SUCCESSFULLY'));
	...
	public function passwordAuth() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if(!$chk_old_pwd)
            {
                $this->Az->redirect('admin/setting/changePassword', 'system_message_error',lang('OLD_PASSWORD_FAILED'));   
            }

            $this->Setting_model->updateAdminPassword($post);
            
            $this->Az->redirect('admin/setting/changePassword', 'system_message_error',lang('PASSWORD_UPDATE_SUCCESSFULLY'));
    ...
    public function updateTheme($id) {
        ...
        $this->Az->redirect('admin/setting/changeTheme', 'system_message_error',lang('THEME_UPDATE_SUCCESS'));
    ...
    public function transcationPasswordAuth() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if(!$chk_old_pwd)
            {
                $this->Az->redirect('admin/setting/changeTranscationPassword', 'system_message_error',lang('OLD_PASSWORD_FAILED'));   
            }

            $this->Setting_model->updateAdminTranscationPassword($post);
            
            $this->Az->redirect('admin/setting/changeTranscationPassword', 'system_message_error',lang('PASSWORD_UPDATE_SUCCESSFULLY'));
