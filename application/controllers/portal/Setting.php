...
class Setting extends CI_Controller{
    ...
    public function __construct() {
		...
		$this->load->model('portal/Setting_model');
        $this->lang->load('portal/setting', 'english');
    ...
    public function profileAuth() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Az->redirect('portal/setting/profile', 'system_message_error',lang('PROFILE_UPDATE_SUCCESSFULLY'));
	...
	public function passwordAuth() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if(!$chk_old_pwd)
            {
                $this->Az->redirect('portal/setting/changePassword', 'system_message_error',lang('OLD_PASSWORD_FAILED'));   
            }

            $this->Setting_model->updateAdminPassword($post);
            
            $this->Az->redirect('portal/setting/changePassword', 'system_message_error',lang('PASSWORD_UPDATE_SUCCESSFULLY'));
