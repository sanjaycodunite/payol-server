...
class Master extends CI_Controller {    
    ...
    public function __construct() 
    {
        ...
        $this->lang->load('retailer/master', 'english');
	...
	public function myPayoutCommission(){
		...
		$recordList = $this->db->get_where('payout_commision',array('account_id'=>$account_id,'package_id'=>$member_package_id,'is_md'=>1))->result_array();
	...
	public function myUtiPancardCommission(){
		...
		$commision = isset($get_com_data['rt_commision']) ? $get_com_data['rt_commision'] : 0 ;
