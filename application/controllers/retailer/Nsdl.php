...
class Nsdl extends CI_Controller {    
    ...
    public function __construct() 
    {
        ...
        //$this->lang->load('retailer/nsdl', 'english');
    ...
    public function nsdlActiveAuth()
    {
...

        {
            ...
            if($user_before_balance < $charge){
                ...
                $this->Az->redirect('retailer/nsdl', 'system_message_error',lang('WALLET_BALANCE_ERROR'));
       ...
       $this->Az->redirect('retailer/nsdl/redirect/'.$record_id, 'system_message_error',lang('PAN_SUCCESS'));
            
        }
        else
        {
           if(!in_array(22, $activeService)){
                $this->Az->redirect('retailer/nsdl', 'system_message_error',lang('MEMBER_ERROR'));
            }
        }
