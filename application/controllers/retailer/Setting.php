...
class Setting extends CI_Controller{
    ...
    public function __construct() {
		...
		$this->load->model('retailer/Setting_model');
        $this->lang->load('retailer/setting', 'english');
    ...
    public function profileAuth() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Az->redirect('retailer/setting/profile', 'system_message_error',lang('PROFILE_UPDATE_SUCCESSFULLY'));
	...
	public function passwordAuth() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if(!$chk_old_pwd)
            {
                $this->Az->redirect('retailer/setting/changePassword', 'system_message_error',lang('OLD_PASSWORD_FAILED'));   
            }

            $this->Setting_model->updateAdminPassword($post);
            
            $this->Az->redirect('retailer/setting/changePassword', 'system_message_error',lang('PASSWORD_UPDATE_SUCCESSFULLY'));
    ...
    public function transcationPasswordAuth() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if(!$chk_old_pwd)
            {
                $this->Az->redirect('retailer/setting/changeTranscationPassword', 'system_message_error',lang('OLD_PASSWORD_FAILED'));   
            }

            $this->Setting_model->updateAdminTranscationPassword($post);
            
            $this->Az->redirect('retailer/setting/changeTranscationPassword', 'system_message_error',lang('PASSWORD_UPDATE_SUCCESSFULLY'));
