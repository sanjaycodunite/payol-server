...
class Complain extends CI_Controller {    
	...
	{	
		...
		// datatable column index  => database column name
			...
			$sql = "SELECT a.*, b.recharge_display_id, b.mobile, b.amount, c.title as status_title FROM tbl_complain as a INNER JOIN tbl_recharge_history as b ON b.id = a.record_id INNER JOIN tbl_complain_status as c ON c.id = a.status  where a.account_id = '$account_id' AND a.member_id = '$loggedAccountID'";
