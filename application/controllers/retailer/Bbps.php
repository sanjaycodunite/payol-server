...
class Bbps extends CI_Controller{
    ...
    public function __construct() {
        ...
        $this->load->model('retailer/Bbps_model');      
        $this->lang->load('retailer/bbps', 'english');
    ...
    //         // save system log
    //         $log_msg = '['.date('d-m-Y H:i:s').' - R('.$loggedUser['user_code'].') - Mobile Prepaid Post Data - '.json_encode($post).']'.PHP_EOL;
    //         $this->User->generateBBPSLog($log_msg);
    //         $this->load->library('form_validation');
    //         $this->form_validation->set_rules('billerID', 'Biller', 'required');
    ...
    //         $this->form_validation->set_rules('circleID', 'Operator', 'required');
    ...
    {   
        ...
        else
        {
            ...
            // save system log
            $log_msg = '['.date('d-m-Y H:i:s').' - R('.$loggedUser['user_code'].') - Electricity Post Data - '.json_encode($post).']'.PHP_EOL;
            $this->User->generateBBPSLog($log_msg);
    ...
    {   
        ...
        else
        {
            ...
            // save system log
            $log_msg = '['.date('d-m-Y H:i:s').' - R('.$loggedUser['user_code'].') - DTH Post Data - '.json_encode($post).']'.PHP_EOL;
            $this->User->generateBBPSLog($log_msg);
    ...
    {   
        ...
        else
        {
            ...
            // save system log
            $log_msg = '['.date('d-m-Y H:i:s').' - R('.$loggedUser['user_code'].') - Master Post Data - '.json_encode($post).']'.PHP_EOL;
            $this->User->generateBBPSLog($log_msg);
