  ...
  public function nsdlActiveAuth()
    {
...

        {
            ...
            if($user_before_balance < $charge){
                ...
                $this->Az->redirect('master/nsdl', 'system_message_error',lang('WALLET_BALANCE_ERROR'));
       ...
       $this->Az->redirect('master/nsdl/redirect/'.$record_id, 'system_message_error',lang('PAN_SUCCESS'));
            
        }
        else
        {
           if(!in_array(22, $activeService)){
                $this->Az->redirect('master/nsdl', 'system_message_error',lang('MEMBER_ERROR'));
            }
        }
