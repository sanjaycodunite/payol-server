...
class Package extends CI_Controller {    
	...
	public function savePackage()
	{
		...
		{	
			...
			if($status == true)
			{
				$this->Az->redirect('master/package', 'system_message_error',lang('SAVE_SUCCESS'));
			}
			else
			{
				$this->Az->redirect('master/package', 'system_message_error',lang('DB_ERROR'));
			}
	...
	public function updatePackage()
	{
		...
		{	
			...
			if($status == true)
			{
				$this->Az->redirect('master/package', 'system_message_error',lang('UPDATE_SUCCESS'));
			}
			else
			{
				$this->Az->redirect('master/package', 'system_message_error',lang('DB_ERROR'));
	...
	{	
		...
		$this->Az->redirect('master/package', 'system_message_error',lang('DELETE_SUCCESS'));
	}
