...
class Report extends CI_Controller
{
    ...
    public function getRechargeList()
    {
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                $nestedData[] = "<a href=" . base_url('employe/report/rechargeInvoice/') . $list['recharge_display_id'] . " style='text-decoration:none;' target='_blank'>Receipt</a>";
                ...
                if ($list['status'] == 1) {
                    ...
                    if ($is_cogent_instantpay_api) {
                        ...
                        if ($list['force_status'] == 1) {
                            ...
                            $nestedData[] =
                                '<a href="' . base_url('employe/report/refundRecharge') . '/' . $list['id'] . '" onclick="return confirm(\'Are you sure you want to refund this recharge?\')" class="btn btn-sm btn-primary">Refund</a>';
                        }
                    }
    ...
    public function getPaymentList()
    {
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                if ($list['status'] == 2) {
                    /*$nestedData[] = '<a href="'.base_url('employe/report/refundPayout').'/'.$list['id'].'" onclick="return confirm(\'Are you sure you want to refund this transaction?\')" class="btn btn-sm btn-primary">Refund</a> <a href="#" onclick="successPayout('.$list['id'].'); return false;" class="btn btn-sm btn-success">Success</a>';*/
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                if ($list['status'] == 2) {
                    $nestedData[] =
                        '<a href="' .
                        base_url('employe/report/refundMoneyTransfer') .
                        '/' .
                        $list['id'] .
                        '" onclick="return confirm(\'Are you sure you want to refund this transaction?\')" class="btn btn-sm btn-primary">Refund</a> <a href="#" onclick="successMoneyTranfer(' .
                        $list['id'] .
    ...
    public function refundMoneyTransfer($recharge_id = 0)
    {
        ...
        if (!$chkMember) {
            $this->Az->redirect(
                'employe/report/moneyTransferHistory',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
            );
        }
        ...
        $wallet_data = [
            ...
            'wallet_type' => 1,
            'created' => date('Y-m-d H:i:s'),
            'description' => 'Fund Transfer #' . $transaction_id . ' Amount Refund Manually By EMP -' . $loggedUser['user_code'],
        ];
    ...
    public function getBbpsHistoryList()
    {
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                $nestedData[] = "<a href=" . base_url('employe/report/bbpsLiveInvoice/') . $list['recharge_display_id'] . " style='text-decoration:none;' target='_blank'>Receipt</a>";
                ...
                if ($list['status'] == 1) {
                    ...
                    if ($is_cogent_instantpay_api) {
                        ...
                        $nestedData[] =
                            '<a href="' .
                            base_url('employe/report/refundBbps') .
                            '/' .
                            $list['id'] .
                            '" onclick="return confirm(\'Are you sure you want to refund this recharge?\')" class="btn btn-sm btn-primary">Refund</a> <a href="' .
                            base_url('employe/report/successBbps') .
                            '/' .
                            $list['id'] .
                            '" onclick="return confirm(\'Are you sure you want to success this recharge?\')" class="btn btn-sm btn-primary">Success</a>';
                    }
                    ...
                    if ($is_cogent_instantpay_api) {
                        ...
                        if ($list['force_status'] == 1) {
                            ...
                            $nestedData[] =
                                '<a href="' . base_url('employe/report/refundBbps') . '/' . $list['id'] . '" onclick="return confirm(\'Are you sure you want to refund this recharge?\')" class="btn btn-sm btn-primary">Refund</a>';
                        }
                    }
                } elseif ($list['status'] == 3) {
                    $nestedData[] = '<font color="red">Failed</font>';
    ...
    public function upiCollectionReport()
    {
        ...
        if (!$this->User->admin_menu_permission(3, 1) || !$this->User->admin_menu_permission(83, 2)) {
            $this->Az->redirect(
                'employe/dashboard',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
    ...
    public function getUpiCollectionList()
    {
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                if ($list['status'] == 1) {
                    $nestedData[] = '<a href="' . base_url('employe/report/checkUpiColStatus') . '/' . $list['id'] . '" class="btn btn-sm btn-primary">Check Status</a>';
                } elseif ($list['status'] == 2) {
    ...
    public function checkUpiColStatus($recharge_id = 0)
    {
        ...
        if (!$chkMember) {
            $this->Az->redirect(
                'employe/report/upiCollectionReport',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
            );
        }
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                if ($list['status'] == 1) {
                    $nestedData[] =
                        '<a href="' .
                        base_url('employe/report/approveRequest/' . $list['user_id']) .
                        '/' .
                        $list['id'] .
                    ...
                    <a href="' .
                        base_url('employe/report/rejectRequest/' . $list['user_id']) .
                        '/' .
                        $list['id'] .
    ...
    public function getUpiCashList()
    {
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                $nestedData[] = !empty($list['vpa_id']) ? $list['vpa_id'] : 'Not Available';
                $nestedData[] = !empty($list['description']) ? $list['description'] : 'Not Available';
                $nestedData[] = "<a href=" . base_url('employe/report/upiCashTxnInvoice/') . $list['id'] . " style='text-decoration:none;' target='_blank'>Invoice</a>";
                $nestedData[] = date('d-M-Y H:i:s', strtotime($list['created']));
            ...
            foreach ($get_filter_data as $list) {
                ...
                if ($list['status'] == 1) {
                    ...
                    $nestedData[] =
                        ...
                        base_url('employe/report/deleteKyc') .
                        '/' .
                        $list['id'] .
    ...
    public function newMoneyTransferHistory()
    {
        ...
        if (!$this->User->admin_menu_permission(3, 1) || !$this->User->admin_menu_permission(109, 2)) {
            $this->Az->redirect(
                'employe/dashboard',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
    ...
    public function getNewMoneyTransferList()
    {
        ...
        $sql = "SELECT a.* FROM tbl_user_new_fund_transfer as a INNER JOIN tbl_users as b ON b.id = a.user_id where a.account_id = '$account_id'";
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                if ($list['invoice_no']) {
                    $nestedData[] = '<a href="' . base_url('employe/report/newTransferInvoice/' . $list['id'] . '') . '" target="_blank">' . $list['invoice_no'] . '</a>';
                } else {
                    $nestedData[] = 'Not Available';
                }
                $nestedData[] = date('d-M-Y H:i:s', strtotime($list['created']));
                ...
                if ($list['status'] == 2) {
                    $nestedData[] =
                        '<a href="' .
                        base_url('employe/report/refundNewPayout') .
                        '/' .
                        $list['id'] .
                    ...
                    $nestedData[] =
                        '<a href="' . base_url('employe/report/refundNewPayout') . '/' . $list['id'] . '" onclick="return confirm(\'Are you sure you want to refund this transaction?\')" class="btn btn-sm btn-primary">Refund</a>';
                } elseif ($list['status'] == 4) {
                    $nestedData[] = 'Not Allowed';
                }
    ...
    public function getIciciAepsHistoryList()
    {
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                $nestedData[] = "<a href=" . base_url('employe/report/iciciAepsInvoice/') . $list['id'] . " style='text-decoration:none;' target='_blank'>Receipt</a>";
    ...
    public function successIciciAepsTxn($recharge_id = 0)
    {
        ...
        if (!$chkMember) {
            $this->Az->redirect(
                'employe/report/iciciAepsHistory',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
            );
        }
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                if ($list['status'] == 1) {
                    $nestedData[] =
                        '<a href="' .
                        base_url('employe/report/approveIciciAccountRequest/' . $list['user_id']) .
                        '/' .
                        $list['id'] .
                        '" onclick="return confirm(\'Are you sure you want to approve request?\')" title="Approve Request" class="btn btn-success btn-sm"><i class="fa fa-check" aria-hidden="true"></i></a>
                    <a href="' .
                        base_url('employe/report/rejectIciciAccountRequest/' . $list['user_id']) .
                        '/' .
                        $list['id'] .
                        '" title="Reject Request" onclick="return confirm(\'Are you sure you want to reject request?\')" class="btn btn-danger btn-sm"><i class="fa fa-times" aria-hidden="true"></i></a>';
                } else {
    ...
    public function refundNewPayout($recharge_id = 0)
    {
        ...
        if (!$chkMember) {
            $this->Az->redirect(
                'employe/report/newMoneyTransferHistory',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
            );
        }
        ...
        $wallet_data = [
            ...
            'wallet_type' => 1,
            'created' => date('Y-m-d H:i:s'),
            'description' => 'Payout Transfer #' . $transaction_id . ' Amount Refund Manually By EMP - ' . $loggedUser['user_code'],
        ];
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                if ($list['status'] == 2) {
                    $nestedData[] =
                        '<a href="' .
                        base_url('employe/report/refundUpiPayout') .
                        '/' .
                        $list['id'] .
    ...
    public function refundUpiPayout($recharge_id = 0)
    {
        ...
        if (!$chkMember) {
            $this->Az->redirect(
                'employe/report/upiTransferHistory',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
            );
        }
        ...
        $wallet_data = [
            ...
            'wallet_type' => 1,
            'created' => date('Y-m-d H:i:s'),
            'description' => 'Upi Transfer #' . $transaction_id . ' Amount Refund By EMP -' . $loggedUser['user_code'],
        ];
    ...
    public function getUpiQrList()
    {
        ...
        if ($fromDate && $toDate) {
            $sql_summery .= " OR DATE(a.created) >= '" . date('Y-m-d', strtotime($fromDate)) . "' OR DATE(a.created) <= '" . date('Y-m-d', strtotime($toDate)) . "'";
        }
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                if (empty($list['api_response']) || $list['api_response'] == "" || $list['api_response'] == null) {
                    $nestedData[] =
                        '<a href="' .
                        base_url('employe/report/failedFingpayAeps3Txn') .
                        '/' .
                        $list['id'] .
                        '" onclick="return confirm(\'Are you sure you want to failed this transaction?\')" class="btn btn-sm btn-primary">Failed</a> <a href="' .
                        base_url('employe/report/successIciciAeps3Txn') .
                        '/' .
                        $list['id'] .
                        '" onclick="return confirm(\'Are you sure you want to success this transaction?\')" class="btn btn-sm btn-success">Success</a>';
                } else {
            ...
            foreach ($get_filter_data as $list) {
                ...
                if ($list['status'] == 1) {
                    $nestedData[] =
                        ...
                        base_url('employe/report/updateUtiBalanceAuth') .
                        '/' .
                        $list['id'] .
    ...
    public function upiChargeBackAuth($recordID = 0)
    {
        ...
        if (!$chkMember) {
            ...
            $wallet_data = [
                ...
                'force_chargeback' => 1,
                'created' => date('Y-m-d H:i:s'),
                'description' => 'QR Scan UTR #' . $bank_rrno . ' Txn #' . $txnid . ' Chargeback Debited By EMP -' . $loggedUser['user_code'],
            ];
    ...
    public function openMoneyTransferHistory()
    {
        ...
        if (!$this->User->admin_menu_permission(3, 30) || !$this->User->admin_menu_permission(112, 2)) {
            $this->Az->redirect(
                'employe/dashboard',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                if ($list['status'] == 2) {
                    $nestedData[] =
                        '<a href="' .
                        base_url('employe/report/refundOpenMoneyPayout') .
                        '/' .
                        $list['id'] .
                    ...
                    $nestedData[] =
                        '<a href="' . base_url('employe/report/refundOpenMoneyPayout') . '/' . $list['id'] . '" onclick="return confirm(\'Are you sure you want to refund this transaction?\')" class="btn btn-sm btn-primary">Refund</a>';
                    //$nestedData[] = 'Not Allowed';
                } elseif ($list['status'] == 4) {
                    $nestedData[] = 'Not Allowed';
                }
    ...
    //open money beneficiary list

    public function openBeneficiaryList()
    {
        //get logged user info
        $loggedUser = $this->User->getAdminLoggedUser(ADMIN_EMPLOYE_SESSION_ID);
        ...
        $data = [
            ...
            'system_info' => $this->Az->getsystemMessageInfo(),
            'system_warning' => $this->Az->getSystemMessageWarning(),
            'content_block' => 'report/open-money-beneficiary-list',
        ];
        $this->parser->parse('employe/layout/column-1', $data);
    }

    public function getOpenBeneficiaryList()
    {
        $account_id = $this->User->get_domain_account();
        $requestData = $this->input->get();
        $extra_search = $requestData['extra_search'];
        ...
        // getting total number records without any search
        $sql = "SELECT a.*,b.name,b.user_code FROM tbl_open_money_payout_user_benificary as a INNER JOIN tbl_users as b ON b.id = a.user_id where  a.account_id = '$account_id'";
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                $nestedData[] = $list['account_no'];
                $nestedData[] = $list['ifsc'];
                $nestedData[] = $list['ben_id'];
                if ($list['status'] == 1) {
                    $nestedData[] = '<font color="success">Active</font>';
                } else {
                    $nestedData[] = '<font color="red">Deactive</font>';
                }
                $nestedData[] = date('d-M-Y H:i:s', strtotime($list['created']));
    ...
    public function settlementMoneyTransferHistory()
    {
        ...
        if (!$this->User->admin_menu_permission(3, 30) || !$this->User->admin_menu_permission(131, 2)) {
            $this->Az->redirect(
                'employe/dashboard',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                if ($list['status'] == 2) {
                    $nestedData[] =
                        '<a href="' .
                        base_url('employe/report/refundSettlementMoneyTransfer') .
                        '/' .
                        $list['id'] .
    ...
    public function refundOpenMoneyPayout($recharge_id = 0)
    {
        ...
        if (!$chkMember) {
            $this->Az->redirect(
                'employe/report/openMoneyTransferHistory',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
            );
        }
        ...
        $this->db->where('user_id', $loggedAccountID);
        $this->db->where('transaction_id', $transaction_id);
        $this->db->update('open_money_payout', ['status' => 4, 'force_status' => 1, 'updated_by' => $loggedUser['id'], 'updated' => date('Y-m-d H:i:s')]);
    ...
    public function successOpenMoneyPayout()
    {
        ...
        $this->db->where('user_id', $loggedAccountID);
        $this->db->where('transaction_id', $transaction_id);
        $this->db->update('open_money_payout', ['op_txn_id' => $optxid, 'rrn' => $bank_rrn, 'status' => 3, 'force_status' => 1, 'updated_by' => $loggedUser['id'], 'updated' => date('Y-m-d H:i:s')]);
    ...
    public function scanPayTransferHistory()
    {
        ...
        if (!$this->User->admin_menu_permission(3, 30) || !$this->User->admin_menu_permission(133, 2)) {
            $this->Az->redirect(
                'employe/dashboard',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
        ...
        if ($get_filter_data) {
            ...
            foreach ($get_filter_data as $list) {
                ...
                if ($list['status'] == 2) {
                    $nestedData[] =
                        '<a href="' .
                        base_url('employe/report/refundScanPay') .
                        '/' .
                        $list['id'] .
    ...
    public function refundSettlementMoneyTransfer($recharge_id = 0)
    {
        ...
        if (!$chkMember) {
            $this->Az->redirect(
                'employe/report/settlementMoneyTransferHistory',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
            );
        }
        ...
        $this->db->where('user_id', $loggedAccountID);
        $this->db->where('transaction_id', $transaction_id);
        $this->db->update('settlement_open_money_payout', ['status' => 4, 'force_status' => 1, 'updated_by' => $loggedUser['id'], 'updated' => date('Y-m-d H:i:s')]);
    ...
    public function successSettlementMoneyTransfer()
    {
        ...
        $this->db->where('user_id', $loggedAccountID);
        $this->db->where('transaction_id', $transaction_id);
        $this->db->update('settlement_open_money_payout', ['rrn' => $bank_rrn, 'status' => 3, 'force_status' => 1, 'updated_by' => $loggedUser['id'], 'updated' => date('Y-m-d H:i:s')]);
    ...
    // scan and pay refund success button
    ...
    public function refundScanPay($recharge_id = 0)
    {
        ...
        if (!$chkMember) {
            $this->Az->redirect(
                'employe/report/scanPayTransferHistory',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
            );
        }
        ...
        $this->db->where('user_id', $loggedAccountID);
        $this->db->where('transaction_id', $transaction_id);
        $this->db->update('user_scan_pay_transfer', ['status' => 4, 'force_status' => 1, 'updated_by' => $loggedUser['id'], 'updated' => date('Y-m-d H:i:s')]);
        ...
        $wallet_data = [
            ...
            'wallet_type' => 1,
            'created' => date('Y-m-d H:i:s'),
            'description' => 'Scan And Pay #' . $transaction_id . ' Amount Refund Manually By EMP - ' . $loggedUser['user_code'],
        ];
    ...
    public function successScanPay()
    {
        ...
        $this->db->where('user_id', $loggedAccountID);
        $this->db->where('transaction_id', $transaction_id);
        $this->db->update('user_scan_pay_transfer', ['op_txn_id' => $transaction_id, 'rrn' => $bank_rrn, 'status' => 3, 'force_status' => 1, 'updated_by' => $loggedUser['id'], 'updated' => date('Y-m-d H:i:s')]);
    ...
    public function openMoneyUpiTransferHistory()
    {
        ...
        if (!$this->User->admin_menu_permission(3, 30) || !$this->User->admin_menu_permission(136, 2)) {
            $this->Az->redirect(
                'employe/dashboard',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
    ...
    public function fingpayRecon($status = 0)
    {
        ...
        if (!$this->User->admin_menu_permission(3, 30) || !$this->User->admin_menu_permission(137, 2)) {
            $this->Az->redirect(
                'employe/dashboard',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
    ...
    public function getNewMoneyTransferListOld()
    {
        ...
        $sql = "SELECT a.* FROM tbl_user_new_fund_transfer_till_oct_2023 as a INNER JOIN tbl_users as b ON b.id = a.user_id where a.account_id = '$account_id' AND a.txnType!= 'UPI'";
    ...
    public function addFundReport()
    {
        ...
        if (!$this->User->admin_menu_permission(3, 1) || !$this->User->admin_menu_permission(140, 2)) {
            $this->Az->redirect(
                'employe/dashboard',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
    ...
    public function failedFingpayAeps3Txn($recharge_id = 0)
    {
        ...
        if (!$chkMember) {
            $this->Az->redirect(
                'employe/report/fingpayAepsHistory',
                'system_message_error',
                '<div class="alert alert-danger alert-dismissable">  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Sorry ! You are not authorized to access this page.</div>'
            );
        }
