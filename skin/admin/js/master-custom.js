$(document).ready(function () {
  ...
  $("#mobilePostpaidOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 3,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        if (data["is_fetch"] == 1) {
  ...
  $("#bbpsElectricityOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 4,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#electricity-loader").html("");
  ...
  $("#bbpsDTHOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 1,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#dth-loader").html("");
  ...
  $("#bbpsBroadbandPostpaidOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 8,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#boradband-postpaid-loader").html("");
  ...
  $("#bbpsLandlinePostpaidOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 2,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#landline-postpaid-loader").html("");
  ...
  $("#bbpsWaterOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 7,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#water-loader").html("");
  ...
  $("#bbpsGasOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 6,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#gas-loader").html("");
  ...
  $("#bbpsLPGGasOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 11,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#lpg-gas-loader").html("");
  ...
  $("#bbpsLoanOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 17,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#loan-loader").html("");
  ...
  $("#bbpsInsuranceOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 5,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#insurance-loader").html("");
  ...
  $("#bbpsEmiPaymentOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 10,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#emi-loader").html("");
  ...
  $("#bbpsFastagOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 12,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#fastag-loader").html("");
  ...
  $("#bbpsCableOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 9,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#cable-loader").html("");
  ...
  $("#bbpsMunicipalTaxesOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 18,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#municipal-taxes-loader").html("");
  ...
  $("#bbpsMunicipalServicesOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 13,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#municipal-services-loader").html("");
  ...
  $("#bbpsSubscriptionOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 20,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#subscription-loader").html("");
  ...
  $("#bbpsHospitalOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 19,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#hospital-loader").html("");
  ...
  $("#bbpsCreditCardOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 22,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#credit-card-loader").html("");
  ...
  $("#bbpsTravelOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 21,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#travel-loader").html("");
  ...
  $("#bbpsClubOperator").change(function () {
    ...
    $.ajax({
      type: "POST",
      url:
        siteUrl + "master/bbps/checkOperatorFetchOption/" + billerID + "/" + 24,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        $("#club-loader").html("");
...
$("#accountVerifyBtn").click(function () {
 ...
 $('#addBeneficiaryBtn').click(function (e) {
    ...
    if (dbTableName === "user_benificary") {
         actionUrl = siteUrl + "master/transfer/beneficiaryAuth";
    } else {
        actionUrl = siteUrl + "master/Settlement/beneficiaryAuth";
    }
...
$("#settlement_to_bank").click(function () {
  ...
  $.ajax({
    url: siteUrl + "master/settlement/getBankBeneficiary",
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $(".recharge-comm-loader").html("");
...
$("#settlement_to_upi").click(function () {
  ...
  $.ajax({
    url: siteUrl + "master/settlement/getUpiBankBeneficiary",
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $(".recharge-comm-loader").html("");
...
$("#settlementAccountVerifyBtn").click(function () {
  ...
  $.ajax({
    type: "POST",
    url: siteUrl + "master/bank/openVerifyAuth",
    data: str,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
...
$("#settlementUpiVerifyBtn").click(function () {
  ...
  $.ajax({
    type: "POST",
    url: siteUrl + "master/bank/openUpiVerifyAuth",
    data: str,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
...
$(document).ready(function () {
  ...
  $('#saveMT1BeneficiaryBtn').click(function (e) {
    ...
    $.ajax({
      url: siteUrl + "master/transfer/beneficiaryAuth",
      type: "POST",
      data: formData,
      dataType: "json",
      success: function (response) {
  ...
  $('#confirmDeletem1').click(function () {
    var benDeleteUrl = siteUrl + `master/transfer/deleteBeneficiary/${delBeneficiaryId}`;
    $.ajax({
      url: benDeleteUrl,
      type: "POST",
      dataType: "json",
  ...
  $('#saveBenM1Changes').click(function (e) {
    ...
    $.ajax({
      url: siteUrl + "master/transfer/updateBenificaryAuth",
      type: "POST",
      data: formData,
      dataType: "json",
      success: function (obj) {
  ...
  $('#saveBeneficiaryBtn').click(function (e) {
    ...
    $.ajax({
      url: siteUrl + "master/settlement/beneficiaryAuth",
      type: "POST",
      data: formData,
      dataType: "json",
      success: function (response) {
  ...
  $('#confirmDelete').click(function () {
    var benDeleteUrl = siteUrl + `master/settlement/deleteBeneficiary/${delBeneficiaryId}`;
    $.ajax({
      url: benDeleteUrl,
      type: "POST",
      dataType: "json",
  ...
  $('#saveBenM2Changes').click(function (e) {
    ...
    $.ajax({
      url: siteUrl + "master/settlement/updateBenificaryAuth",
      type: "POST",
      data: formData,
      dataType: "json",
      success: function (obj) {
...
function updateBenModel2(id) {
  var siteUrl = $("#siteUrl").val();
  $.ajax({
    url: siteUrl + "master/settlement/getBenData/" + id,
    success: function (response) {
      var data = JSON.parse($.trim(response));
      if (data["status"] == 1) {
        $("#recordID").val(id);
