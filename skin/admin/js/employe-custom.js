$(document).ready(function () {
  ...
  $("#accountVerifyChargeSearchBtn").click(function () {
    ...
    $.ajax({
      url:
        siteUrl + "employe/master/getMemberAccountVerifyChargeData/" + memberID,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        if (data["status"] == 1) {
          $(".recharge-comm-loader").html("");
  ...
  $("#nsdlPancardChargeSearchBtn").click(function () {
    ...
    $.ajax({
      url:
        siteUrl + "employe/master/getMemberNsdlPancardChargeData/" + memberID,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        if (data["status"] == 1) {
          $(".recharge-comm-loader").html("");
  ...
  $("#moneyTransferComSearchBtn").click(function () {
    ...
    $.ajax({
      url:
        siteUrl + "employe/master/getMemberMoneyTransferCommData/" + memberID,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        if (data["status"] == 1) {
          $(".recharge-comm-loader").html("");
  ...
  $("#xpressPayoutChargeSearchBtn").click(function () {
    ...
    $.ajax({
      url:
        siteUrl + "employe/master/getMemberXpressPayoutChargeData/" + memberID,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        if (data["status"] == 1) {
          $(".recharge-comm-loader").html("");
...
function clubChatModal(round_no, club_id) {
  ...
  $.ajax({
    url:
      siteUrl + "employe/society/getClubChatList/" + round_no + "/" + club_id,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
...
$("#selUpiWalletMember").change(function () {
  ...
  if (memberID) {
    $.ajax({
      url: siteUrl + "employe/wallet/getMemberUpiWalletBalance/" + memberID,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        if (data["status"] == 1) {
          $("#balance").val(data["balance"]);
...
$("#user_type").change(function () {
  ...
  if (userType) {
    $.ajax({
      url: siteUrl + "employe/report/getUserList/" + userType,
      success: function (r) {
        var data = JSON.parse($.trim(r));
        if (data["status"] == 1) {
          $("#user").html(data["str"]);
...
function successOpenMoneyPayout(id) {
  var siteUrl = $("#siteUrl").val();
  $.ajax({
    url: siteUrl + "employe/report/getOpenMoneyPayoutData/" + id,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $("#recordID").val(id);
...
$("#newMoneyTransferBtn").click(function () {
  ...
  $.ajax({
    url:
      siteUrl + "employe/master/getMemberNewMoneyTransferCommData/" + memberID,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $(".recharge-comm-loader").html("");
...
function updateNewMoneyTransferCharge(id) {
  var siteUrl = $("#siteUrl").val();
  $.ajax({
    url: siteUrl + "employe/master/getNewMoneyTransferCommData/" + id,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $("#recordID").val(id);
...
function successSettlementMoneyTransfer(id) {
  var siteUrl = $("#siteUrl").val();
  $.ajax({
    url: siteUrl + "employe/report/getSettlementMoneyTransferData/" + id,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $("#recordID").val(id);
...
function successScanPay(id) {
  var siteUrl = $("#siteUrl").val();
  $.ajax({
    url: siteUrl + "employe/report/getScanPayData/" + id,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $("#recordID").val(id);
...
$("#upiSwitchSearchBtn").click(function () {
  ...
  $.ajax({
    url: siteUrl + "employe/master/getUpiApiData/" + memberID,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $(".recharge-comm-loader").html("");
...
function updateScanPayModel(id) {
  var siteUrl = $("#siteUrl").val();
  $.ajax({
    url: siteUrl + "employe/master/getUpiScanPayCommData/" + id,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $("#recordID").val(id);
...
$("#scanPaySearchBtn").click(function () {
  ...
  $.ajax({
    url: siteUrl + "employe/master/getScanPayCommData/" + memberID,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $(".recharge-comm-loader").html("");
...
$("#openMoneyPayoutBtn").click(function () {
  ...
  $.ajax({
    url: siteUrl + "employe/master/getMemberOpenMoneyCommData/" + memberID,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $(".recharge-comm-loader").html("");
...
function updateOpenMoneyPayout(id) {
  var siteUrl = $("#siteUrl").val();
  $.ajax({
    url: siteUrl + "employe/master/getOpenMoneyPayoutCommData/" + id,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $("#recordID").val(id);
...
$("#addFundComSearchBtn").click(function () {
  ...
  $.ajax({
    url: siteUrl + "employe/master/getAddFundCommData/" + memberID,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $(".recharge-comm-loader").html("");
...
function updateAddFundModel(id) {
  var siteUrl = $("#siteUrl").val();
  $.ajax({
    url: siteUrl + "employe/master/getAddFundMemberCommData/" + id,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $("#recordID").val(id);
...
function showUtrModal(id) {
  var siteUrl = $("#siteUrl").val();
  $.ajax({
    url: siteUrl + "employe/report/getUtrData/" + id,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $("#updateDMRModel").modal("show");
...
$("#aepsTranscationSearchBtn").click(function () {
  ...
  $.ajax({
    url: siteUrl + "employe/master/getAepsTranscationCommData/" + memberID,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $(".recharge-comm-loader").html("");
...
$(document).ready(function () {
  $("#user_type").on("change", function (e) {
    e.preventDefault();
    var userType = $(this).val();
    $("#emp_memberWise #user").empty();

    $.ajax({
      type: "POST",
      url: siteUrl + "employe/report/getUserByType",
      data: { userType: userType },
      success: function (response) {
        $("#emp_memberWise #user").empty();
        var results = JSON.parse($.trim(response));
        if (results.status == 1) {
          $("#emp_memberWise #user").html(results.data);
        } else {
          $("#emp_memberWise #user").html(results.defaultUsers);
        }

        if ($("#emp_memberWise #user").hasClass("selectpicker")) {
          $("#emp_memberWise #user").selectpicker("refresh");
          $("#emp_memberWise #user").selectpicker("refresh");
        }
      }
    });
