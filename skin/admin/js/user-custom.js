$(document).ready(function() {	
	...
	$("#rechargeComSearchBtn").click(function(){
		...
		{
			$.ajax({                
				url:siteUrl+'user/master/getRechargeCommData/'+memberID,                        
				success:function(r){
	...
	$("#upi-topup-btn").click(function(){
		...
		$(".upi_loader").show();
			...
			$.ajax({
				type:'POST',                
				url:siteUrl+'user/wallet/upiRequestAuth',
				data:str,                        
				success:function(r){
	...
	function getUpiCallback(txnid = ''){
	    var siteUrl = $("#siteUrl").val();
	    $.ajax({                
	      url:siteUrl+'user/wallet/getUpiCallbackResponse/'+txnid,                        
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	          window.location.href = siteUrl+'user/wallet/sendRequest';
	        }
	        else
	        {
	...
	$("#qr-topup-btn").click(function(){
		...
		$(".upi_loader").show();
			...
			$.ajax({
				type:'POST',                
				url:siteUrl+'user/upi/qrGenerateAuth',
				data:str,                        
				success:function(r){
	...
	$("#bbpsComSearchBtn").click(function(){
		...
		{
			$.ajax({                
				url:siteUrl+'user/master/getBBPSCommData/'+memberID,                        
				success:function(r){
	...
	$("#dmrComSearchBtn").click(function(){
		...
		{
			$.ajax({                
				url:siteUrl+'user/master/getMemberDMRCommData/'+memberID,                        
				success:function(r){
	...
	$("#aepsComSearchBtn").click(function(){
		...
		$(".recharge-comm-loader").html("<img src='"+siteUrl+"skin/images/loading2.gif' alt='loading' />");
		$.ajax({                
			url:siteUrl+'user/master/getMemberAEPSCommData/'+memberID,                        
			success:function(r){
	...
	$("#serviceSearchBtn").click(function(){
		...
		$(".recharge-comm-loader").html("<img src='"+siteUrl+"skin/images/loading2.gif' alt='loading' />");
		$.ajax({                
			url:siteUrl+'user/master/getServiceData/'+memberID,                        
			success:function(r){
	...
	$("#selState").change(function(){
		...
		if(stateID){
			$.ajax({                
				url:siteUrl+'user/aeps/getCityList/'+stateID,                        
				success:function(r){
	...
	$("#electricityOperator").change(function(){
      ...
      else
      {
        ...
        $.ajax({               
          type:'POST', 
          url:siteUrl+'user/recharge/fetchBiller/'+operator_id,                        
          success:function(r){
            var data = JSON.parse($.trim(r));
            if(data["status"] == 1){
              $(".ajax-loader").html('');
    ...
    $("#account_number").blur(function(){
      ...
      else
      {
        ...
        $.ajax({               
          type:'POST', 
          url:siteUrl+'user/recharge/fetchBillerDetail/'+operator_id,                        
          data:str,
          success:function(r){
            var data = JSON.parse($.trim(r));
            if(data["status"] == 1){
    ...
    $("#payolmobile").blur(function(){
      ...
      if(mobile != '')
      {
	        ...
	        $.ajax({               
	          type:'POST', 
	          url:siteUrl+'user/wallet/getMemberName/'+mobile,                        
	          success:function(r){
	            var data = JSON.parse($.trim(r));
	...
	$("#selMember").change(function(){
		...
		if(memberID){
			$.ajax({                
				url:siteUrl+'user/wallet/getMemberWalletBalance/'+memberID,                        
				success:function(r){
	...
	$("#viewPlanSearchBtn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/recharge/getOperatorPlanList',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#dthViewPlanSearchBtn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/recharge/getDTHOperatorPlanList',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#offermobile").blur(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/recharge/getOperatorType/'+$(this).val(),
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#rofferSearchBtn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/recharge/getRofferList',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#dthRofferSearchBtn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/recharge/getDTHRofferList',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
    ...
    $("#cardNumber").blur(function(){
		...
		if(cardNumber != '' && operator != '')
		{
		    ...
		    $.ajax({               
		      type:'POST', 
		      url:siteUrl+'user/recharge/getDTHCustomerInfo',
		      data:str,
		      success:function(r){
		        var data = JSON.parse($.trim(r));
		        if(data["status"] == 1){
	...
	$("#bbps-mobile-prepaid-btn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/mobilePrepaidAuth',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#mobilePostpaidOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+3,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	        if(data['is_fetch'] == 1){
	...
	$("#bbps-mobile-postpaid-btn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/mobilePostpaidAuth',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#bbpsElectricityOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+4,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbps-electricity-btn").click(function(){
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/electricityAuth',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
	...
	$("#bbpsDTHOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+1,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#dth-loader").html('');
	...
	$("#bbpsBroadbandPostpaidOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+19,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbpsLandlinePostpaidOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+2,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbpsWaterOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+7,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#water-loader").html('');
	...
	$("#bbpsGasOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+6,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#gas-loader").html('');
	...
	$("#bbpsLPGGasOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+11,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#lpg-gas-loader").html('');
	...
	$("#bbpsLoanOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+17,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#loan-loader").html('');
	...
	$("#bbpsEmiPaymentOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+10,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#emi-loader").html('');
	...
	$("#bbpsFastagOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+12,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#fastag-loader").html('');
	...
	$("#bbpsCableOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+9,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#cable-loader").html('');
	...
	$("#bbpsMunicipalTaxesOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+18,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbpsMunicipalServicesOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+13,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbpsSubscriptionOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+20,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbpsCreditCardOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+22,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	...
	$("#bbpsTravelOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+21,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#travel-loader").html('');
	...
	$("#bbpsClubOperator").change(function(){
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/checkOperatorFetchOption/'+billerID+'/'+24,
	      success:function(r){
	      	var data = JSON.parse($.trim(r));
	      	$("#club-loader").html('');
...
function fetchMobilePostpaidBill()
{
	...
	else
	{
	    ...
	    $.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/bbps/fetchMobilePostpaidBill',
	      data:str,
	      success:function(r){
	        var data = JSON.parse($.trim(r));
	        if(data["status"] == 1){
...
function fetchElectricityBill()
{
    ...
    $.ajax({               
      type:'POST', 
      url:siteUrl+'user/bbps/fetchElectricityBill',
      data:str,
      success:function(r){
        var data = JSON.parse($.trim(r));
        if(data["status"] == 1){
...
function fetchDTHBill()
{
    ...
    $.ajax({               
      type:'POST', 
      url:siteUrl+'user/bbps/fetchDTHBill',
      data:str,
      success:function(r){
        var data = JSON.parse($.trim(r));
        if(data["status"] == 1){
...
function fetchMasterBill(service_id)
{
    ...
    $.ajax({               
      type:'POST', 
      url:siteUrl+'user/bbps/fetchMasterBill/'+service_id,
      data:str,
      success:function(r){
        var data = JSON.parse($.trim(r));
        if(data["status"] == 1){
...
function payMasterBill(service_id)
{
    ...
    $.ajax({               
      type:'POST', 
      url:siteUrl+'user/bbps/payMasterBillAuth/'+service_id,
      data:str,
      success:function(r){
        var data = JSON.parse($.trim(r));
        if(data["status"] == 1){
...
function updatedmrModel(id)
{
	var siteUrl = $("#siteUrl").val();
	$.ajax({                
		url:siteUrl+'user/master/getDMRCommData/'+id,                        
		success:function(r){
...
function updateaepsModel(id)
{
	var siteUrl = $("#siteUrl").val();
	$.ajax({                
		url:siteUrl+'user/master/getAEPSCommData/'+id,                        
		success:function(r){
...
function showComplainBox(id)
{
	var siteUrl = $("#siteUrl").val();
	$.ajax({                
		url:siteUrl+'user/recharge/getRechargeData/'+id,                        
		success:function(r){
...
function showBBPSComplainBox(id)
{
	var siteUrl = $("#siteUrl").val();
	$.ajax({                
		url:siteUrl+'user/recharge/getBBPSData/'+id,                        
		success:function(r){
...
function updateBenModel(id)
{
	var siteUrl = $("#siteUrl").val();
	$.ajax({                
		url:siteUrl+'user/transfer/getBenData/'+id,                        
		success:function(r){
...
function closeClubNoti(recordID = 0)
	{
		...
		$.ajax({               
	      type:'POST', 
	      url:siteUrl+'user/saving/closeClubNotification/'+recordID,
	      success:function(r){
    ...
    $.ajax({               
      ...
      success:function(r){
        ...
        if(data["status"] == 1){
             ...
             setTimeout(function() {
                              window.location.replace(siteUrl+'user/bbps');
                            }, 10000);
        }
        else
        {
