$(document).ready(function() {
     ...
     function manualMoneyTransferDataTable(keyword = '',date='')
      ...
      function upiChargebackDataTable(keyword = '',fromDate = '',toDate = '')
      { 
      ...
      $('#upiChargebackSearchBtn').on('click', function() {
        ...
        var fromDate = $("#from_date").val();
        var toDate = $("#to_date").val();
        upiChargebackDataTable(keyword,fromDate,toDate);
      });
      
      
    function newPayoutTransferDataTable(keyword = '',fromDate='', toDate = '' , status = 0)
      { 
        ...
        var newPayoutTransferDataTable = $('#newPayoutTransferDataTable').DataTable({
          ...
          deferRender: true,
          "ajax": {
            //"url": "getNewPayoutList",
             url: siteUrl + "portal/report/getNewPayoutList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate+'|'+status;
            }
          },
      ...
      $('#newPayoutSearchBtn').on('click', function() {
        $('#newPayoutTransferDataTable').DataTable().destroy();
        var keyword = $("#keyword").val();
        var fromDate = $("#from_date").val();
        var toDate = $("#to_date").val();
        var status = $("#status").val();
        newPayoutTransferDataTable(keyword,fromDate,toDate,status);
      });
