...
function upiChargeBackBtn(recordID) {
  ...
  var siteUrl = $("#siteUrl").val();
  $.ajax({
    url: siteUrl + "employe/report/upiChargeBackAuth/" + recordID,
    success: function (r) {
...
function upiBalanceReportDataTable(keyword = "", user_type = "") {
  ...
  var upiBalanceReportDataTable = $("#upiBalanceReportDataTable").DataTable({
    ...
    deferRender: true,
    ajax: {
      url: siteUrl + "employe/report/getUpiBalanceReport",
      data: function (d) {
        d.extra_search = keyword + "|" + user_type;
      }
    },
...
function openBeneficiaryDataTable(keyword = "", date = "") {
  var siteUrl = $("#siteUrl").val();
  var openBeneficiaryDataTable = $("#openBeneficiaryDataTable").DataTable({
    dom: "Bfrtip",
    buttons: ["csv", "excel"],
    pageLength: 50,
    lengthMenu: [10, 25, 50, 75, 100],
...
$("#openMemberSearchBtn").on("click", function () {
  $("#openBeneficiaryDataTable").DataTable().destroy();
  var keyword = $("#keyword").val();
  var date = $("#date").val();
  openBeneficiaryDataTable(keyword, date);
});
