...
function CallApi(ServiceType, BiometricData) {
    ...
    jQuery.ajax({
        type: "POST",
        url: siteUrl+"distributor/newaeps/apiAuth",
...
function CallVerifyApiLoginNewAuthTransaction(ServiceType, BiometricData) {
    ...
    jQuery.ajax({
        type: "POST",
        url: siteUrl+"distributor/newaeps/merchantAuthenticity",
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify(jsonData),
        dataType: "json",
        success: function (Result) {
            if(Result.status == true)
            {
                ...
                setTimeout(function() {
                  window.location.replace(siteUrl+'distributor/newaeps');
                });
            }
            else
            {
...
function CallKYCVerifyApi(BiometricData) {
    ...
    jQuery.ajax({
        type: "POST",
        url: siteUrl+"distributor/newaeps/kycBioAuth",
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify(jsonData),
        dataType: "json",
        success: function (Result) {
...
function CallKYCVerifyApiLogin(BiometricData) {
    ...
    jQuery.ajax({
        type: "POST",
        url: siteUrl+"distributor/newaeps/kycBioAuthNew",
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify(jsonData),
        dataType: "json",
        success: function (Result) {
