...
function CallApi(ServiceType, BiometricData) {
    ...
    jQuery.ajax({
        type: "POST",
        url: siteUrl+"master/fingpayAeps/apiAuth",
...
function Call2FaApi(BiometricData) {
   ...
   // var IIN = $("#bankID").val();
    ...
    jQuery.ajax({
        type: "POST",
        url: siteUrl+"master/fingpayAeps/api2FaAuth",
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify(jsonData),
        dataType: "json",
        success: function (Result) {
            ...
            setTimeout(function() {
                              window.location.replace(siteUrl+'master/fingpayAeps');
                            });
   ...
   // var IIN = $("#bankID").val();
    ...
    jQuery.ajax({
        type: "POST",
        url: siteUrl+"master/fingpayAeps/api2FaAuthNew",
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify(jsonData),
        dataType: "json",
        success: function (Result) {
...
function CallKYCVerifyApi(BiometricData) {
    ...
    jQuery.ajax({
        type: "POST",
        url: siteUrl+"master/fingpayAeps/kycBioAuth",
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify(jsonData),
        dataType: "json",
        success: function (Result) {
            if(Result.status == 1)
            {
                ...
                window.location.href=siteUrl+"master/fingpayAeps";
