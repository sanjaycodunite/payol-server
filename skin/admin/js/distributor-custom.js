$(document).ready(function () {
  ...
  $("#mobilePostpaidOperator").change(function () {
    ...
    $.ajax({
      ...
      url:
        siteUrl +
        "distributor/bbps/checkOperatorFetchOption/" +
        billerID +
        "/" +
        3,
      success: function (r) {
...
$('#addBeneficiaryBtn').click(function (e) {
  ...
  if (dbTableName === "user_benificary") {
    actionUrl = siteUrl + "distributor/transfer/beneficiaryAuth";
  } else {
    actionUrl = siteUrl + "distributor/Settlement/beneficiaryAuth";
  }
...
$("#settlement_to_bank").click(function () {
  ...
  $.ajax({
    url: siteUrl + "distributor/settlement/getBankBeneficiary",
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $(".recharge-comm-loader").html("");
...
$("#settlement_to_upi").click(function () {
  ...
  $.ajax({
    url: siteUrl + "distributor/settlement/getUpiBankBeneficiary",
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
        $(".recharge-comm-loader").html("");
...
$("#settlementAccountVerifyBtn").click(function () {
  ...
  $.ajax({
    type: "POST",
    url: siteUrl + "distributor/bank/openVerifyAuth",
    data: str,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
...
$("#settlementUpiVerifyBtn").click(function () {
  ...
  $.ajax({
    type: "POST",
    url: siteUrl + "distributor/bank/openUpiVerifyAuth",
    data: str,
    success: function (r) {
      var data = JSON.parse($.trim(r));
      if (data["status"] == 1) {
...
$(document).ready(function () {
  ...
  $('#saveMT1BeneficiaryBtn').click(function (e) {
    ...
    $.ajax({
      url: siteUrl + "distributor/transfer/beneficiaryAuth",
      type: "POST",
      data: formData,
      dataType: "json",
      success: function (response) {
  ...
  $('#saveBenM1Changes').click(function (e) {
    ...
    $.ajax({
      url: siteUrl + "distributor/transfer/updateBenificaryAuth",
      type: "POST",
      data: formData,
      dataType: "json",
      success: function (obj) {
  ...
  $('#saveBeneficiaryBtn').click(function (e) {
    ...
    $.ajax({
      url: siteUrl + "distributor/settlement/beneficiaryAuth",
      type: "POST",
      data: formData,
      dataType: "json",
      success: function (response) {
  ...
  $('#confirmDelete').click(function () {
    var benDeleteUrl = siteUrl + `distributor/settlement/deleteBeneficiary/${delBeneficiaryId}`;
    $.ajax({
      url: benDeleteUrl,
      type: "POST",
      dataType: "json",
  ...
  $('#saveBenM2Changes').click(function (e) {
    ...
    $.ajax({
      url: siteUrl + "distributor/settlement/updateBenificaryAuth",
      type: "POST",
      data: formData,
      dataType: "json",
      success: function (obj) {
...
function updateBenModel2(id) {
  var siteUrl = $("#siteUrl").val();
  $.ajax({
    url: siteUrl + "distributor/settlement/getBenData/" + id,
    success: function (response) {
      var data = JSON.parse($.trim(response));
      if (data["status"] == 1) {
        $("#recordID").val(id);
