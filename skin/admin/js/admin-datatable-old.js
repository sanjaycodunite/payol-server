      ...
      function newPayoutTransferDataTable(keyword = '',fromDate='', toDate = '' ,status = 0, user = '')
      { 
        ...
        var newPayoutTransferDataTable = $('#newPayoutTransferDataTable').DataTable({
          ...
          "ajax": {
            "url": "getNewPayoutTransferList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate+'|'+status+'|'+user;
            }
          },
      ...
      { 
        ...
        var retailerQrDataTable = $('#retailerQrDataTable').DataTable({
          ...
          "lengthMenu": [ 10, 25, 50, 75, 100 ],
          "searching": false,
          "columnDefs": [ {"targets": 0,"orderable": false},{"targets": 1,"orderable": false},{"targets": 2,"orderable": false},{"targets": 3,"orderable": false}],
          "processing": false ,
          "serverSide": true,
          "order": [[ 0, "desc" ]],
          deferRender: true,
      ...
      { 
        ...
        var employeDataTable = $('#employeDataTable').DataTable({
          ...
          "lengthMenu": [ 10, 25, 50, 75, 100 ],
          "searching": false,
          "columnDefs": [ {"targets": 2,"orderable": false},{"targets": 3,"orderable": false},{"targets": 4,"orderable": false},{"targets": 6,"orderable": false},{"targets": 7,"orderable": false},{"targets": 8,"orderable": false},{"targets": 9,"orderable": false},{"targets": 10,"orderable": false}],
          "processing": false ,
          "serverSide": true,
          "order": [[ 5, "desc" ]],
          deferRender: true,
     ...
     function iciciAepsKycDataTable(keyword = '',fromDate='', toDate = '')
      { 
     ...
     $('#iciciAepsKycSearchBtn').on('click', function() {
      ...
      var fromDate = $("#from_date").val();
      var toDate = $("#to_date").val();
      iciciAepsKycDataTable(keyword,fromDate,toDate);
     });
     ...
     function aepsHistoryDataTable(keyword = '',fromDate='', toDate = '' , status = 0, user = '', service = '')
      { 
        if(fromDate == '')
        {
          var fromDate = $("#from_date").val();
        ...
        var aepsHistoryDataTable = $('#aepsHistoryDataTable').DataTable({
          ...
          "ajax": {
            "url": "getFingpayAepsHistoryList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate+'|'+status+'|'+user+'|'+service;
            }
          },
          "initComplete": function( settings, json ) {
     ...
     $('#aepsHistorySearchBtn').on('click', function() {
      ...
      function aepsReconDataTable(keyword = '',fromDate='', toDate = '' , status = 0, user = '', service = '')
      { 
        if(fromDate == '')
        {
          var fromDate = $("#from_date").val();
     ...
     function iciciAepsHistoryDataTable(keyword = '',fromDate='', toDate = '' , status = 0, user = '', service = '')
      { 
        if(fromDate == '')
        {
          var fromDate = $("#from_date").val();
     ...
     $('#gatewayHistorySearchBtn').on('click', function() {
      ...
      { 
        ...
        var retailerMemberDataTable = $('#retailerMemberDataTable').DataTable({
          ...
          "lengthMenu": [ 10, 25, 50, 75, 100 ],
          "searching": false,
          "columnDefs": [ {"targets": 2,"orderable": false},{"targets": 3,"orderable": false},{"targets": 4,"orderable": false},{"targets": 6,"orderable": false},{"targets": 7,"orderable": false},{"targets": 8,"orderable": false}],
          "processing": false ,
          "serverSide": true,
          "order": [[ 5, "desc" ]],
          deferRender: true,
      ...
      function walletDataTable(keyword = '',member_id='',fromDate='',toDate = '')
      { 
        if(fromDate == '' && toDate == '')
        {
          var fromDate = $("#from_date").val();
        ...
        var walletDataTable = $('#walletDataTable').DataTable({
          ...
          "ajax": {
            "url": "getwalletList",
              "data": function ( d ) {
              d.extra_search = keyword+"|"+member_id+'|'+fromDate+'|'+toDate;
            }
          },
          "initComplete": function( settings, json ) {
            $("#totalSuccessIciciBlock").html(json.totalCreditAmount+' / '+json.totalCreditRecord);
            $("#totalPendingIciciBlock").html(json.totalDebitAmount+' / '+json.totalDebitRecord);
          }
      ...
      function upiWalletHistoryDataTable(keyword = '',member_id='',fromDate='',toDate = '')
      { 
        if(fromDate == '' && toDate == '')
        {
          var fromDate = $("#from_date").val();
      ...
      function oldWalletDataTable(status = 0 ,keyword = '',member_id='',fromDate='',toDate = '')
      { 
        if(fromDate == '' && toDate == '')
        {
          var fromDate = $("#from_date").val();
      ...
      function vanWalletDataTable(keyword = '',date='')
      { 
      ...
      $('#vanWalletSearchBtn').on('click', function() {
        ...
        var keyword = $("#keyword").val();
        var date = $("#date").val();
        vanWalletDataTable(keyword,date);
      });
      ...
      function creditDataTable(keyword = '',member_id='',fromDate='',toDate='')
      { 
        if(fromDate == '' && toDate == '')
        {
          var fromDate = $("#from_date").val();
     ...
     function debitDataTable(keyword = '',member_id='',fromDate='',toDate='')
      { 
        if(fromDate == '' && toDate == '')
        {
          var fromDate = $("#from_date").val();
     ...
     function releaseUpiBalanceReportDataTable(keyword = '',user_type = '')
      { 
        ...
        var siteUrl = $("#siteUrl").val();
        var releaseUpiBalanceReportDataTable = $('#releaseUpiBalanceReportDataTable').DataTable({
          dom: 'Bfrtip',
          buttons: [
              'csv', 'excel'
          ],
     ...
     function upiDataTable(keyword = '',fromDate='',toDate = '', user = '',type =0, api_type=0)
      { 
        ...
        var upiDataTable = $('#upiDataTable').DataTable({
          ...
          "ajax": {
            "url": "getUpiCollectionList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate+'|'+user+'|'+type+'|'+api_type;
            }
          },
          "initComplete": function( settings, json ) {
     ...
     function manualMoneyTransferDataTable(keyword = '',date='')
      ...
      { 
       ...
       function moneyTransferDataTable(keyword = '',fromDate = '',toDate = '',status = 0)
      { 
    ...
    function moneyTransferHistoryDataTable(keyword = '',fromDate='', toDate = '' ,status = 0, user = '',type=0)
      { 
        ...
        var moneyTransferHistoryDataTable = $('#moneyTransferHistoryDataTable').DataTable({
          ...
          "ajax": {
            "url": "getMoneyTransferList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate+'|'+status+'|'+user+'|'+type;
            }
          },
          "initComplete": function( settings, json ) {
             $("#totalSuccessIciciBlock").html(json.successAmount+' / '+json.successRecord);
            $("#totalPendingIciciBlock").html(json.pendingAmount+' / '+json.pendingRecord);
            $("#totalFailedIciciBlock").html(json.failedAmount+' / '+json.failedRecord);
            $("#totalSuccessChargeBlock").html(json.successCharge+' / '+json.successRecord);
          }
       ...
       function newMoneyTransferHistoryDataTable(keyword = '',fromDate='', toDate = '' ,status = 0, user = '',type=0)
      { 
        ...
        var newMoneyTransferHistoryDataTable = $('#newMoneyTransferHistoryDataTable').DataTable({
          dom: 'Bfrtip',
          buttons: [
              'csv', 'excel'
          ],
       ...
       $('#newMoneyTransferHistorySearchBtn').on('click', function() {
        ...
        var user = $("#user").val();
         var type = $("#type").val();
        newMoneyTransferHistoryDataTable(keyword,fromDate,toDate,status,user,type);
      });
       ...
       function upiTransferHistoryDataTable(keyword = '',fromDate='', toDate = '',status=0, user='')
      { 
...
function newAepsKycDataTable(keyword = '',date='')
      { 
     ...
     $('#newAepsKycSearchBtn').on('click', function() {
      ...
      var keyword = $("#keyword").val();
      var date = $("#date").val();
      newAepsKycDataTable(keyword,date);
     });

     function newAepsHistoryDataTable(keyword = '',fromDate='', toDate = '' , status = 0, user = '', service = '')
      { 
    ...
    function nsdlPanCardListDataTable(keyword = '',fromDate='', toDate = '')
      { 
        if(fromDate == '')
        {
          var fromDate = $("#from_date").val();
      ...
      $('#nsdlPanCardListSearchBtn').on('click', function() {
        ...
        var fromDate = $("#from_date").val();
        var toDate = $("#to_date").val();
        nsdlPanCardListDataTable(keyword,fromDate,toDate);
      }); 
    ...
    function nsdlActivationDataTable(keyword = '',fromDate='', toDate = '')
      { 
        ...
        var nsdlActivationDataTable = $('#nsdlActivationDataTable').DataTable({
          ...
          "lengthMenu": [ 10, 25, 50, 75, 100 ],
          "searching": false,
          "columnDefs": [{"targets": 0,"orderable": false},{"targets": 1,"orderable": false}, {"targets": 2,"orderable": false},{"targets": 3,"orderable": false},{"targets": 4,"orderable": false},{"targets": 5,"orderable": false},{"targets": 7,"orderable": false},{"targets": 8,"orderable": false},{"targets": 9,"orderable": false},{"targets": 10,"orderable": false},{"targets": 11,"orderable": false},{"targets": 12,"orderable": false},{"targets": 13,"orderable": false},{"targets": 14,"orderable": false},{"targets": 15,"orderable": false}],
          "processing": false ,
          "serverSide": true,
          "order": [[ 0, "desc" ]],
          deferRender: true,
     ...
     function findPanDataTable(keyword = '',fromDate='', toDate = '')
      { 
        if(fromDate == '')
        {
          var fromDate = $("#from_date").val();
        ...
        var findPanDataTable = $('#findPanDataTable').DataTable({
          ...
          "lengthMenu": [ 10, 25, 50, 75, 100 ],
          "searching": false,
          "columnDefs": [{"targets": 0,"orderable": false},{"targets": 1,"orderable": false}, {"targets": 2,"orderable": false},{"targets": 3,"orderable": false},{"targets": 4,"orderable": false},{"targets": 5,"orderable": false},{"targets": 7,"orderable": false},{"targets": 8,"orderable": false}],
          "processing": false ,
          "serverSide": true,
          "order": [[ 0, "desc" ]],
          deferRender: true,
      ...
      $('#findPanSearchBtn').on('click', function() {
        ...
        var fromDate = $("#from_date").val();
        var toDate = $("#to_date").val();
        findPanDataTable(keyword,fromDate,toDate);
      }); 
     ...
     $('#searchApiRequestBtn').on('click', function() {
      ...
      function scanPayTransferHistoryDataTable(keyword = '',fromDate='', toDate = '' ,status = 0, user = '')
      { 
        ...
        var scanPayTransferHistoryDataTable = $('#scanPayTransferHistoryDataTable').DataTable({
          dom: 'Bfrtip',
          buttons: [
              'csv', 'excel'
          ],
      ...
      function upiChargebackDataTable(keyword = '',fromDate='',toDate = '', user = '', api_type=0)
      { 
        ...
        var upiChargebackDataTable = $('#upiChargebackDataTable').DataTable({
          ...
          "ajax": {
            "url": "getUpiChargebackList",
              "data": function ( d ) {
              d.extra_search = keyword+'|'+fromDate+'|'+toDate+'|'+user+'|'+api_type;
            }
          },
          "initComplete": function( settings, json ) {
            //$("#totalSuccessRechargeBlock").html(json.totalSuccess);
     ...
     $('#upiChargebackSearchBtn').on('click', function() {
      ...
      function openMoneyTransferHistoryDataTable(keyword = '',fromDate='', toDate = '' ,status = 0, user = '')
      { 
        ...
        var openMoneyTransferHistoryDataTable = $('#openMoneyTransferHistoryDataTable').DataTable({
          dom: 'Bfrtip',
          buttons: [
              'csv', 'excel'
          ],
       ...
       $('#openMoneyTransferHistorySearchBtn').on('click', function() {
        ...
        var status = $("#status").val();
        var user = $("#user").val();
        openMoneyTransferHistoryDataTable(keyword,fromDate,toDate,status,user);
      });
      
      
      function openMoneyUpiTransferHistoryDataTable(keyword = '',fromDate='', toDate = '' ,status = 0, user = '')
      { 
        ...
        var openMoneyUpiTransferHistoryDataTable = $('#openMoneyUpiTransferHistoryDataTable').DataTable({
          dom: 'Bfrtip',
          buttons: [
              'csv', 'excel'
          ],
      ...
      function settlementMoneyTransferHistoryDataTable(keyword = '',fromDate='', toDate = '' ,status = 0, user = '')
      { 
        ...
        var settlementMoneyTransferHistoryDataTable = $('#settlementMoneyTransferHistoryDataTable').DataTable({
          dom: 'Bfrtip',
          buttons: [
              'csv', 'excel'
          ],
       ...
       $('#settlementMoneyTransferHistorySearchBtn').on('click', function() {
        ...
        var status = $("#status").val();
        var user = $("#user").val();
        settlementMoneyTransferHistoryDataTable(keyword,fromDate,toDate,status,user);
      });



       function addFundDataTable(keyword = '',fromDate='',toDate = '', user = '',type =0, api_type=0)
      { 
     ...
     function newMoneyTransferHistoryOldDataTable(keyword = '',fromDate='', toDate = '' ,status = 0, user = '')
      { 
        ...
        var newMoneyTransferHistoryOldDataTable = $('#newMoneyTransferHistoryOldDataTable').DataTable({
          dom: 'Bfrtip',
          buttons: [
              'csv', 'excel'
          ],
